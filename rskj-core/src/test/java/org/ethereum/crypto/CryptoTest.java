...
public class CryptoTest {
    ...
    public void test3() {
        BigInteger privKey =
                new BigInteger(
                        "cd244b3015703ddf545595da06ada5516628c5feadbf49dc66049c4b370cc5d8", 16);
    ...
    public void test4() {
        ...
        assertEquals(
                "CD2A3D9F938E13CD947EC05ABC7FE734DF8DD826", Hex.toHexString(addr).toUpperCase());
    }
    ...
    public void test5() {
        ...
        assertEquals(
                "13978AEE95F38490E9769C39B2773ED763D9CD5F", Hex.toHexString(addr).toUpperCase());
    }
    ...
    public void test9() {
        ...
        // TODO:
        // https://github.com/bcgit/bc-java/blob/master/core/src/main/java/org/bouncycastle/crypto/signers/ECDSASigner.java
    ...
    public void test10() {
        BigInteger privKey =
                new BigInteger(
                        "74ef8a796480dda87b4bc550b94c408ad386af0f65926a392136286784d63858", 16);
        byte[] addr = ECKey.fromPrivate(privKey).getAddress();
    ...
    public void test12() throws Throwable {
        ...
        byte[] keyBytes =
                Hex.decode("a4627abc2a3c25315bff732cb22bc128f203912dd2a840f31e66efb27a47d2b1");
        byte[] ivBytes = new byte[16];
        byte[] payload =
                Hex.decode(
        ...
        while (i < in.length) {
            ...
            if (in.length - i < engine.getBlockSize()) break;
        }
    ...
    public void test13() throws Throwable {
        ...
        ECKey key =
                ECKey.fromPrivate(
                        Hex.decode(
                                "a4627abc2a3c25315bff732cb22bc128f203912dd2a840f31e66efb27a47d2b1"));

        String address = Hex.toHexString(key.getAddress());
        String pubkey =
                Hex.toHexString(key.getPubKeyPoint().getXCoord().getEncoded())
                        + // X cord
    ...
    public void test14() throws Throwable {
        ...
        KeyGenerationParameters gParam =
                new ECKeyGenerationParameters(ECKey.CURVE, new SecureRandom());
    ...
    public void test15() throws Throwable {
        ...
        ECPrivateKeyParameters ecPrivKey =
                new ECPrivateKeyParameters(ecKey.getPrivKey(), ECKey.CURVE);
        ECPublicKeyParameters ecPubKey =
                new ECPublicKeyParameters(ecKey.getPubKeyPoint(), ECKey.CURVE);
        ...
        EphemeralKeyPairGenerator kGen =
        ...
        decryptorIES_Engine.init(
                myKey.getPrivate(), parametersWithIV, new ECIESPublicKeyParser(ECKey.CURVE));
