...
public class EIP8HandshakeTest {
    ...
    private ECKey keyA =
            fromPrivate(decode("49a7b37aa6f6645917e7b807e9d1c00d4fa71f18343b0d4122a4d2df64dd6fee"));
    private ECKey keyB =
            fromPrivate(decode("b71c71a67e1177ad4e901695e1b4b9ee17ae16c6668d313eac2f96dbcda3f291"));
    private ECKey ephemeralKeyA =
            fromPrivate(decode("869d6ecf5211f1cc60418a13b9d870b22959d0c16f02bec714c960dd2298a32d"));
    private ECKey ephemeralKeyB =
            fromPrivate(decode("e238eb8e04fee6511ab04c6dd3c89ce097b11f25d584863ac2b6d5b35b1847e4"));
    private byte[] nonceA =
            decode("7e968bba13b6c50e2c4cd7f241cc0d64d1ac25c7f5952df231ac6a2bda8ee5d6");
    private byte[] nonceB =
            decode("559aead08264d5795d3909718cdd05abd49572e84fe55590eef31a88a08fdffd");
    private ECKey.ECDSASignature signatureA =
    ...
    public void test3() throws InvalidCipherTextException {
        ...
        assertArrayEquals(
                keyA.getPubKeyPoint().getEncoded(false),
                handshakerB.getRemotePublicKey().getEncoded(false));
        handshakerB.agreeSecret(authInitiateData, authResponseData);

        assertArrayEquals(
                decode("80e8632c05fed6fc2a13b0f8d31a3cf645366239170ea067065aba8e28bac487"),
                handshakerB.getSecrets().aes);
        assertArrayEquals(
                decode("2ea74ec5dae199227dff1af715362700e989d889d7a493cb0639691efb8e5f98"),
                handshakerB.getSecrets().mac);
        ...
        assertArrayEquals(
                decode("0c7ec6340062cc46f5e9f1e3cf86f8c8c403c5a0964f5df0ebd34a75ddc86db5"),
                fooHash);
        ...
        assertArrayEquals(
                ephemeralKeyB.getPubKeyPoint().getEncoded(false),
                msg2.ephemeralPublicKey.getEncoded(false));
        ...
        assertArrayEquals(
                ephemeralKeyB.getPubKeyPoint().getEncoded(false),
                msg3.ephemeralPublicKey.getEncoded(false));
    }
