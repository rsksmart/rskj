...
class StatsTest {
    ...
    void TestSnapshotMessageTypes() {
        ...
        double v1 = stats.score(MessageType.SNAP_STATUS_RESPONSE_MESSAGE);
        double v2 = stats.score(MessageType.SNAP_STATUS_REQUEST_MESSAGE);
        double v3 = stats.score(MessageType.SNAP_BLOCKS_RESPONSE_MESSAGE);
        double v4 = stats.score(MessageType.SNAP_BLOCKS_REQUEST_MESSAGE);
