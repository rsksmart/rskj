...
public class LevelDbDataSourceReadonlyTest {

    @Mock
    private static DB dbMock;

    private LevelDbReadonlyStub dataSource;
    ...
    public void setUp() throws Exception {
        ...
        dataSource = LevelDbReadonlyStub.create(dbName, dbPath);
        dataSource.init();
    }
    ...
    private static class LevelDbReadonlyStub extends LevelDbDataSourceReadonly {

        private Boolean optionCreateIfMissing;

        public static LevelDbReadonlyStub create(String name, String databaseDir) {
            return new LevelDbReadonlyStub(name, databaseDir);
        }

        protected LevelDbReadonlyStub(String name, String databaseDir) {
            super(name, databaseDir);
        }

        @Override
        protected DB openDB(Options options, Path dbPath) {
            return dbMock;
        }
