...
class GitHubVMTest {
    ...
    @Test
    void runSingle() throws ParseException {
    ...
    @Test
    void testArithmeticFromGitHub() throws ParseException {
    ...
    void testBitwiseLogicOperationFromGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test // testing full suite
    void testBlockInfoFromGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test // testing full suite
    void testEnvironmentalInfoFromGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
        String json = JSONReader.loadJSONFromCommit("VMTests/vmEnvironmentalInfoTest.json", shacommit);
        GitHubJSONTestSuite.runGitHubJsonVMTest(json, excluded);
    }
    ...
    @Test // testing full suite
    void testIOandFlowOperationsFromGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test
    void testvmInputLimitsTest1FromGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test
    void testvmInputLimitsTest2FromGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test
    void testvmInputLimitsLightTestFromGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test // testing full suite
    void testVMLogGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test // testing full suite
    void testPerformanceFromGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test // testing full suite
    void testPushDupSwapFromGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test // testing full suite
    void testShaFromGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test // testing full suite
    void testvmSystemOperationsTestGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test // testing full suite
    void testVMGitHub() throws ParseException {
        Set<String> excluded = new HashSet<>();
    ...
    @Test // testing full suite
    void testRandomVMGitHub() throws ParseException {
