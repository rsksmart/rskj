...
public class TestRunner {
    ...
    public List<String> runTestCase(BlockTestingCase testCase) {
        ...
        TransactionPoolImpl transactionPool = new TransactionPoolImpl(config, repositoryLocator, null, blockFactory, listener, transactionExecutorFactory, new ReceivedTxSignatureCache(), 10, 100, Mockito.mock(TxQuotaCheckerImpl.class), Mockito.mock(GasPriceTracker.class));
