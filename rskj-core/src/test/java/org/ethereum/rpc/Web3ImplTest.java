...
public class Web3ImplTest {
    ...
    public void web3_clientVersion() throws Exception {
        ...
        Assert.assertTrue(
                "client version is not including rsk!",
                clientVersion.toLowerCase().contains("rsk"));
    }
    ...
    public void net_version() throws Exception {
        ...
        Assert.assertTrue(
                "RSK net version different than expected",
                netVersion.compareTo(Byte.toString(config.getNetworkConstants().getChainId()))
                        == 0);
    }
    ...
    public void net_peerCount() throws Exception {
        ...
        Assert.assertEquals("Different number of peers than expected", "0x0", peerCount);
    }
    ...
    public void eth_syncing_returnSyncingResultWhenSyncing() {
        ...
        Assert.assertTrue(
                "Node is syncing, must return sync manager", result instanceof Web3.SyncingResult);
        Assert.assertTrue(
                "Highest block is 5",
                ((Web3.SyncingResult) result).highestBlock.compareTo("0x5") == 0);
        Assert.assertTrue(
                "Simple blockchain starts from genesis block",
                ((Web3.SyncingResult) result).currentBlock.compareTo("0x0") == 0);
    }
    ...
    public void getBalanceWithAccount() throws Exception {
        ...
        org.junit.Assert.assertEquals(
                "0x" + Hex.toHexString(BigInteger.valueOf(10000).toByteArray()),
                web3.eth_getBalance(Hex.toHexString(acc1.getAddress().getBytes())));
    }
    ...
    public void getBalanceWithAccountAndLatestBlock() throws Exception {
        ...
        org.junit.Assert.assertEquals(
                "0x" + Hex.toHexString(BigInteger.valueOf(10000).toByteArray()),
                web3.eth_getBalance(Hex.toHexString(acc1.getAddress().getBytes()), "latest"));
    }
    ...
    public void getBalanceWithAccountAndBlockWithTransaction() throws Exception {
        ...
        TransactionExecutorFactory transactionExecutorFactory =
                buildTransactionExecutorFactory(blockChain);
        TransactionPool transactionPool =
                new TransactionPoolImpl(
                        ...
                        100);
        Account acc1 =
                new AccountBuilder(world).name("acc1").balance(Coin.valueOf(10000000)).build();
        ...
        org.junit.Assert.assertEquals(balanceString, web3.eth_getBalance(accountAddress, "0x1"));
        org.junit.Assert.assertEquals(
                balanceString, web3.eth_getBalance(accountAddress, "pending"));
    }
    ...
    public void getGasPrice() {
        ...
        expectedValue =
                "0x" + (expectedValue.startsWith("0") ? expectedValue.substring(1) : expectedValue);
    ...
    public void getTransactionReceipt() throws Exception {
        ...
        Account acc1 =
                new AccountBuilder(world).name("acc1").balance(Coin.valueOf(2000000)).build();
        Account acc2 = new AccountBuilder().name("acc2").build();
        Transaction tx =
                new TransactionBuilder()
                        .sender(acc1)
        ...
        Block block1 = new BlockBuilder(world).parent(genesis).transactions(txs).build();
        org.junit.Assert.assertEquals(
                ImportResult.IMPORTED_BEST, world.getBlockChain().tryToConnect(block1));
    ...
    public void getTransactionReceiptNotInMainBlockchain() throws Exception {
        ...
        Block genesis = world.getBlockChain().getBestBlock();
        Block block1 =
                new BlockBuilder(world).parent(genesis).difficulty(3l).transactions(txs).build();
        org.junit.Assert.assertEquals(
                ImportResult.IMPORTED_BEST, world.getBlockChain().tryToConnect(block1));
        Block block1b =
                new BlockBuilder(world)
                        .parent(genesis)
                        .difficulty(block1.getDifficulty().asBigInteger().longValue() - 1)
                        .build();
        ...
        org.junit.Assert.assertEquals(
                ImportResult.IMPORTED_BEST, world.getBlockChain().tryToConnect(block2b));
    ...
    public void getTransactionByHash() throws Exception {
        ...
        org.junit.Assert.assertEquals(
                "0x" + Hex.toHexString(tx.getReceiveAddress().getBytes()), tr.to);

        Assert.assertArrayEquals(
                new byte[] {tx.getSignature().v}, TypeConverter.stringHexToByteArray(tr.v));
    ...
    public void getTransactionByHashNotInMainBlockchain() throws Exception {
        ...
        Block genesis = world.getBlockChain().getBestBlock();
        Block block1 =
                new BlockBuilder(world).difficulty(10).parent(genesis).transactions(txs).build();
        org.junit.Assert.assertEquals(
                ImportResult.IMPORTED_BEST, world.getBlockChain().tryToConnect(block1));
        Block block1b =
                new BlockBuilder(world)
    ...
    public void getTransactionByBlockHashAndIndex() throws Exception {
        ...
        TransactionResultDTO tr =
                web3.eth_getTransactionByBlockHashAndIndex(blockHashString, "0x0");
    ...
    public void getTransactionCount() throws Exception {
        ...
        Account acc1 =
                new AccountBuilder(world).name("acc1").balance(Coin.valueOf(100000000)).build();
        Account acc2 = new AccountBuilder().name("acc2").build();
        Transaction tx =
                new TransactionBuilder()
                        .sender(acc1)
    ...
    public void getBlockByHashWithFullTransactionsAsResult() throws Exception {
        ...
        org.junit.Assert.assertEquals(
                block1HashString, ((TransactionResultDTO) bresult.transactions[0]).blockHash);
        org.junit.Assert.assertEquals(0, bresult.uncles.length);
    }
    ...
    public void getBlockByHashBlockDoesNotExists() throws Exception {
        ...
        Web3.BlockResult blockResult =
                web3.eth_getBlockByHash(
    ...
    public void callFromDefaultAddressInWallet() throws Exception {
        World world = new World();
        Account acc1 =
                new AccountBuilder(world).name("default").balance(Coin.valueOf(10000000)).build();
        ...
        argsForCall.data =
                TypeConverter.toJsonHex(greeter.functions.get("greet").encodeSignature());

        String result = web3.eth_call(argsForCall, "latest");

        org.junit.Assert.assertEquals(
                "0x0000000000000000000000000000000000000000000000000000000064617665", result);
    }
    ...
    public void callFromAddressInWallet() throws Exception {
        ...
        argsForCall.to = TypeConverter.toJsonHex(tx.getContractAddress().getBytes());
        argsForCall.data =
                "0xead710c40000000000000000000000000000000000000000000000000000000064617665";
    ...
    public void eth_accounts() {
        ...
        Assert.assertEquals(
                "Not all accounts are being retrieved", originalAccounts + 2, accounts.size());
    ...
    public void eth_sign() {
        ...
        Assert.assertThat(
                signature,
                is(
                        "0xc8be87722c6452172a02a62fdea70c8b25cfc9613d28647bf2aeb3c7d1faa1a91b861fccc05bb61e25ff4300502812750706ca8df189a0b8163540b9bccabc9f1b"));
    }
    ...
    public void createNewAccount() {
        ...
        org.junit.Assert.assertEquals(
                addr, "0x" + Hex.toHexString(account.getAddress().getBytes()));
    }
    ...
    public void listAccounts() {
        ...
        Set<String> addresses =
                Arrays.stream(web3.personal_listAccounts()).collect(Collectors.toSet());
    ...
    public void importAccountUsingRawKey() {
        ...
        String address =
                web3.personal_importRawKey(Hex.toHexString(eckey.getPrivKeyBytes()), "passphrase1");
        ...
        org.junit.Assert.assertNotNull(account);
        org.junit.Assert.assertEquals(
                address, "0x" + Hex.toHexString(account.getAddress().getBytes()));
        org.junit.Assert.assertArrayEquals(
                eckey.getPrivKeyBytes(), account.getEcKey().getPrivKeyBytes());
    }
    ...
    public void sendPersonalTransaction() {
        ...
        Assert.assertTrue(
                "Method is not creating the expected transaction",
                expectedHash.compareTo(txHash) == 0);
    }
    ...
    private Web3Impl createWeb3() {
        return createWeb3(
                Web3Mocks.getMockEthereum(),
                Web3Mocks.getMockBlockchain(),
                Web3Mocks.getMockRepositoryLocator(),
                Web3Mocks.getMockTransactionPool(),
                Web3Mocks.getMockBlockStore(),
                null,
                null,
                null);
    }
    ...
    private Web3Impl createWeb3(
            World world, TransactionPool transactionPool, ReceiptStore receiptStore) {
    ...
    private Web3Impl createWeb3(SimpleEthereum eth, PeerServer peerServer) {
        ...
        MiningMainchainView mainchainView =
                new MiningMainchainViewImpl(blockchain.getBlockStore(), 449);
        TransactionPool transactionPool = Web3Mocks.getMockTransactionPool();
        PersonalModuleWalletEnabled personalModule =
                new PersonalModuleWalletEnabled(config, eth, wallet, null);
        EthModule ethModule =
                new EthModule(
    ...
    private Web3Impl createWeb3(
            Ethereum eth, World world, TransactionPool transactionPool, ReceiptStore receiptStore) {
        RepositoryLocator repositoryLocator =
                new RepositoryLocator(world.getRepository(), world.getStateRootHandler());
        return createWeb3(
                eth,
                world.getBlockChain(),
                repositoryLocator,
    ...
    private Web3Impl createWeb3(
            World world, BlockProcessor blockProcessor, ReceiptStore receiptStore) {
        BlockChainImpl blockChain = world.getBlockChain();
        TransactionExecutorFactory transactionExecutorFactory =
                buildTransactionExecutorFactory(blockChain);
        TransactionPool transactionPool =
    ...
    private Web3Impl createWeb3(
        ...
        res.setHReturn(
                TypeConverter.stringHexToByteArray(
                        "0x0000000000000000000000000000000000000000000000000000000064617665"));
        when(executor.executeTransaction(any(), any(), any(), any(), any(), any(), any(), any()))
                .thenReturn(res);
        EthModule ethModule =
                new EthModule(
                        config.getNetworkConstants().getBridgeConstants(),
                        ...
                        new ExecutionBlockRetriever(
                                miningMainchainViewMock, blockchain, null, null),
                        repositoryLocator,
                        new EthModuleSolidityDisabled(),
                        new EthModuleWalletEnabled(wallet),
                        new EthModuleTransactionBase(
                                config.getNetworkConstants(), wallet, transactionPool),
                        null);
    ...
    public void eth_compileSolidity() throws Exception {
        ...
        EthModule ethModule =
                new EthModule(
                        ...
                        null,
                        null,
                        new ExecutionBlockRetriever(null, null, null, null),
                        null,
        ...
        Web3Impl web3 =
                new Web3RskImpl(
                        ...
                        null);
        String contract =
                "pragma solidity ^0.4.1; contract rsk { function multiply(uint a) returns(uint d) {   return a * 7;   } }";
        ...
        if (dto == null) dto = result.get("<stdin>:rsk");
    ...
    private TransactionExecutorFactory buildTransactionExecutorFactory(BlockChainImpl blockChain) {
        return new TransactionExecutorFactory(
                config, blockChain.getBlockStore(), null, blockFactory, null, null);
    }
}
