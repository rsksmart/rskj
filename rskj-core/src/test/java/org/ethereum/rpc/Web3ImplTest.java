...
public class Web3ImplTest {
    ...
    public void getTransactionByHash() throws Exception {
        ...
        Assert.assertArrayEquals(new byte[] {tx.getSingleSignature().v}, TypeConverter.stringHexToByteArray(tr.v));
        Assert.assertThat(TypeConverter.stringHexToBigInteger(tr.s), is(tx.getSingleSignature().s));
        Assert.assertThat(TypeConverter.stringHexToBigInteger(tr.r), is(tx.getSingleSignature().r));
    }
