...
public class RLPTest {
     ...
     *
     * <p>Using assertEquals(String, String) instead of assertArrayEquals to see the actual content
     * when the test fails.
     */
    ...
    public void testEncodeRepOfTwoListOfList() {
        ...
        assertTrue(
                ((RLPList) ((RLPList) ((RLPList) (decodeResult.get(2))).get(1)).get(0)).size()
                        == 0);
    }
    ...
    public void testRlpDecode() {
        ...
        assertTrue(
                Arrays.equals(
                        (byte[]) ((Object[]) expected16[1])[0],
                        ((RLPList) testObject3.get(1)).get(0).getRLPData()));
    ...
    public void unsupportedLength() {
        ...
        // length > 2^64
        // TODO: Fix this test - when casting double to int, information gets lost since 'int' is
        // max (2^31)-1
    ...
    public void shortStringRightBoundTest() {
        String testString =
                "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"; // String of length 55
