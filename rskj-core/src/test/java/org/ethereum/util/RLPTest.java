...
*/
    ...
    void testEncodeInt() {
        ...
        assertArrayEquals(expected, data);
        assertEquals(0, RLPTestUtil.decodeInt(data, 0));

        byte[] expected2 = {(byte) 0x78};
        data = encodeInt(120);
        assertArrayEquals(expected2, data);
        assertEquals(120, RLPTestUtil.decodeInt(data, 0));

        byte[] expected3 = {(byte) 0x7F};
        data = encodeInt(127);
        assertArrayEquals(expected3, data);
        assertEquals(127, RLPTestUtil.decodeInt(data, 0));

        assertEquals(256, RLPTestUtil.decodeInt(RLP.encodeInt(256), 0));
        assertEquals(255, RLPTestUtil.decodeInt(RLP.encodeInt(255), 0));
        assertEquals(127, RLPTestUtil.decodeInt(RLP.encodeInt(127), 0));
        assertEquals(128, RLPTestUtil.decodeInt(RLP.encodeInt(128), 0));

        data = RLP.encodeInt(1024);
        assertEquals(1024, RLPTestUtil.decodeInt(data, 0));

        byte[] expected4 = {(byte) 0x82, (byte) 0x76, (byte) 0x5F};
        data = encodeInt(30303);
        assertArrayEquals(expected4, data);
        assertEquals(30303, RLPTestUtil.decodeInt(data, 0));

        byte[] expected5 = {(byte) 0x82, (byte) 0x4E, (byte) 0xEA};
        data = encodeInt(20202);
        assertArrayEquals(expected5, data);
        assertEquals(20202, RLPTestUtil.decodeInt(data, 0));

        byte[] expected6 = {(byte) 0x83, 1, 0, 0};
        data = encodeInt(65536);
        assertArrayEquals(expected6, data);
        assertEquals(65536, RLPTestUtil.decodeInt(data, 0));
        ...
        assertEquals(Integer.MIN_VALUE, RLPTestUtil.decodeInt(data, 0));
        ...
        assertEquals(Integer.MAX_VALUE, RLPTestUtil.decodeInt(data, 0));
        ...
        assertEquals(0xFFFFFFFF, RLPTestUtil.decodeInt(data, 0));
...
*/
    ...
    void test12() {
        ...
        ArrayList<RLPElement> rlpList = decodeListElements(payload);
    ...
    @Test
    void testEncodeNull() {
        Assertions.assertThrows(RuntimeException.class, () -> RLPTestUtil.encode(null));
    }
    */
    ...
    void testEncodeEmptyString() {
        String test = "";
        String expected = "80";
        byte[] encoderesult = RLPTestUtil.encode(test);
        assertEquals(expected, ByteUtil.toHexString(encoderesult));

        String decodeResult = ByteUtil.toHexStringOrEmpty(decodeListElements(encoderesult).get(0).getRLPData());
    ...
    void testEncodeShortString() {
        ...
        byte[] decodeResult = decodeListElements(encoderesult).get(0).getRLPData();
    ...
    void testEncodeMediumInteger() {
        ...
        test = 1024;
        expected = "820400";
        encoderesult = RLPTestUtil.encode(test);
        assertEquals(expected, ByteUtil.toHexString(encoderesult));

        decodeResult = decodeListElements(encoderesult).get(0).getRLPData();
    ...
    void TestEncodeEmptyList() {
        ...
        RLPList decodeResult = (RLPList) decodeListElements(encoderesult).get(0);
        assertEquals(0, decodeResult.size());
    }

    @Test
    void testEncodeShortStringList() {
        ...
        assertEquals("dog", bytesToAscii(decodeResult.get(1).getRLPData()));
        ...
        decodeResult = (RLPList) decodeListElements(encoderesult).get(0);
        assertEquals("dog", bytesToAscii(decodeResult.get(0).getRLPData()));
        assertEquals("god", bytesToAscii(decodeResult.get(1).getRLPData()));
        assertEquals("cat", bytesToAscii(decodeResult.get(2).getRLPData()));
    }

    @Test
    void testEncodeLongStringList() {
        String element1 = "cat";
        ...
        assertEquals(element2, bytesToAscii(decodeResult.get(1).getRLPData()));
    }
    ...
    void testEncodeMultiList() {
        ...
        assertEquals("cat", bytesToAscii(((((RLPList)decodeResult.get(1)).get(0).getRLPData()))));
        assertEquals("dog", bytesToAscii(decodeResult.get(2).getRLPData()));
        assertEquals(2, byteArrayToInt((((RLPList) decodeResult.get(3)).get(0).getRLPData())));
        ...
        assertEquals("dog", bytesToAscii((((RLPList) decodeResult.get(0)).get(1).getRLPData())));
        assertEquals(1, byteArrayToInt((((RLPList) decodeResult.get(1)).get(0).getRLPData())));
        assertEquals(2, byteArrayToInt((((RLPList) decodeResult.get(1)).get(1).getRLPData())));
        assertTrue((((RLPList)decodeResult.get(2)).size() == 0));
    }

    @Test
    void testEncodeEmptyListOfList() {
        // list = [ [ [], [] ], [] ],
        ...
        assertEquals(2, ((RLPList) (decodeResult.get(0))).size());
        assertEquals(0, ((RLPList) (decodeResult.get(1))).size());
        assertEquals(0, ((RLPList) ((RLPList) (decodeResult.get(0))).get(0)).size());
        assertEquals(0, ((RLPList) ((RLPList) (decodeResult.get(0))).get(1)).size());
    }

    //The set theoretical representation of two
    @Test
    void testEncodeRepOfTwoListOfList() {
        //list: [ [], [[]], [ [], [[]] ] ]
        ...
        RLPList decodeResult = (RLPList) decodeListElements(encoderesult).get(0);
        assertEquals(3, decodeResult.size());
        assertEquals(0, ((RLPList) (decodeResult.get(0))).size());
        assertEquals(1, ((RLPList) (decodeResult.get(1))).size());
        assertEquals(2, ((RLPList) (decodeResult.get(2))).size());
        assertEquals(0, ((RLPList) ((RLPList) (decodeResult.get(1))).get(0)).size());
        assertEquals(0, ((RLPList) ((RLPList) (decodeResult.get(2))).get(0)).size());
        assertEquals(1, ((RLPList) ((RLPList) (decodeResult.get(2))).get(1)).size());
        assertEquals(0, ((RLPList) ((RLPList) ((RLPList) (decodeResult.get(2))).get(1)).get(0)).size());
    }

    @Test
    void testRlpEncode() {

        assertEquals(result01, ByteUtil.toHexString(RLPTestUtil.encode(test01)));
        assertEquals(result02, ByteUtil.toHexString(RLPTestUtil.encode(test02)));
        assertEquals(result03, ByteUtil.toHexString(RLPTestUtil.encode(test03)));
        assertEquals(result04, ByteUtil.toHexString(RLPTestUtil.encode(test04)));
        assertEquals(result05, ByteUtil.toHexString(RLPTestUtil.encode(test05)));
        assertEquals(result06, ByteUtil.toHexString(RLPTestUtil.encode(test06)));
        assertEquals(result07, ByteUtil.toHexString(RLPTestUtil.encode(test07)));
        assertEquals(result08, ByteUtil.toHexString(RLPTestUtil.encode(test08)));
        assertEquals(result09, ByteUtil.toHexString(RLPTestUtil.encode(test09)));
        assertEquals(result10, ByteUtil.toHexString(RLPTestUtil.encode(test10)));
        assertEquals(result11, ByteUtil.toHexString(RLPTestUtil.encode(test11)));
        assertEquals(result12, ByteUtil.toHexString(RLPTestUtil.encode(test12)));
        assertEquals(result13, ByteUtil.toHexString(RLPTestUtil.encode(test13)));
        assertEquals(result14, ByteUtil.toHexString(RLPTestUtil.encode(test14)));
        assertEquals(result15, ByteUtil.toHexString(RLPTestUtil.encode(test15)));
        assertEquals(result16, ByteUtil.toHexString(RLPTestUtil.encode(test16)));
    }
    ...
    void testRlpDecode() {
        ...
        emptyString = ByteUtil.toHexStringOrEmpty(decodeListElements(Hex.decode(result01)).get(0).getRLPData());
        assertEquals("", emptyString);

        emptyString = ByteUtil.toHexStringOrEmpty(decodeListElements(Hex.decode(result02)).get(0).getRLPData());
        assertEquals(test02, emptyString);

        decodedData = decodeListElements(Hex.decode(result03)).get(0).getRLPData();
        assertEquals(test03, bytesToAscii(decodedData));

        decodedData = decodeListElements(Hex.decode(result04)).get(0).getRLPData();
        assertEquals(test04, bytesToAscii(decodedData));

        decodedData = decodeListElements(Hex.decode(result05)).get(0).getRLPData();
        assertEquals(test05, bytesToAscii(decodedData));

        decodedList = (RLPList) decodeListElements(Hex.decode(result06)).get(0);
        assertEquals(test06[0], bytesToAscii(decodedList.get(0).getRLPData()));
        assertEquals(test06[1], bytesToAscii(decodedList.get(1).getRLPData()));

        decodedList = (RLPList) decodeListElements(Hex.decode(result07)).get(0);
        assertEquals(test07[0], bytesToAscii(decodedList.get(0).getRLPData()));
        assertEquals(test07[1], bytesToAscii(decodedList.get(1).getRLPData()));
        assertEquals(test07[2], bytesToAscii(decodedList.get(2).getRLPData()));

        // 1
        decodedData = decodeListElements(Hex.decode(result08)).get(0).getRLPData();
        assertEquals(test08, byteArrayToInt(decodedData));

        // 10
        decodedData = decodeListElements(Hex.decode(result09)).get(0).getRLPData();
        assertEquals(test09, byteArrayToInt(decodedData));

        // 100
        decodedData = decodeListElements(Hex.decode(result10)).get(0).getRLPData();
        assertEquals(test10, byteArrayToInt(decodedData));

        // 1000
        decodedData = decodeListElements(Hex.decode(result11)).get(0).getRLPData();
        assertEquals(test11, byteArrayToInt(decodedData));

        decodedData = decodeListElements(Hex.decode(result12)).get(0).getRLPData();
        assertEquals(0, test12.compareTo(BigIntegers.fromUnsignedByteArray(decodedData)));

        decodedData = decodeListElements(Hex.decode(result13)).get(0).getRLPData();
        assertEquals(0, test13.compareTo(BigIntegers.fromUnsignedByteArray(decodedData)));

        // Need to test with different expected value, because decoding doesn't recognize types
        RLPList testObject1 = (RLPList) decodeListElements(Hex.decode(result14)).get(0);
        assertArrayEquals((byte[]) expected14[0], testObject1.get(0).getRLPData());
        assertArrayEquals((byte[]) expected14[1], testObject1.get(1).getRLPData());
        assertEquals(0, ((RLPList) testObject1.get(2)).size());
        RLPList testObject2 = (RLPList) decodeListElements(Hex.decode(result15)).get(0);
        assertEquals(2, testObject2.size());
        assertEquals(2, ((RLPList) testObject2.get(0)).size());
        assertEquals(0, ((RLPList) testObject2.get(1)).size());
        assertEquals(0, ((RLPList) ((RLPList) testObject2.get(0)).get(0)).size());
        assertEquals(0, ((RLPList) ((RLPList) testObject2.get(0)).get(1)).size());
        // Need to test with different expected value, because decoding doesn't recognize types
        RLPList testObject3 = (RLPList) decodeListElements(Hex.decode(result16)).get(0);
        assertEquals(3, testObject3.size());
        assertArrayEquals((byte[]) expected16[0], testObject3.get(0).getRLPData());
        assertEquals(1, ((RLPList) testObject3.get(1)).size());
        assertArrayEquals((byte[]) ((Object[]) expected16[1])[0], ((RLPList) testObject3.get(1)).get(0).getRLPData());
        assertArrayEquals((byte[]) expected16[2], testObject3.get(2).getRLPData());
    }
    ...
    @Test
    @Disabled("TODO: Fix this test - when casting double to int, information gets lost since 'int' is max (2^31)-1")
...
*/
    ...
    @Test
    void testEncode_ED(){
        String result =  ByteUtil.toHexString(RLPTestUtil.encode(0xED));
    ...
    void testEncodeHelloMessageCap0(){
    ...
    @Test
    void partialDataParseTest() {
        String hex = "000080c180000000000000000000000042699b1104e93abf0008be55f912c2ff";
        RLPList el = (RLPList) RLP.decodeFirstElement(Hex.decode(hex), 3);
        assertEquals(1, el.size());
    }

    @Test
    void shortStringRightBoundTest() {
        String testString = "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"; //String of length 55
        byte[] rlpEncoded = RLPTestUtil.encode(testString);
        String res = new String(decodeListElements(rlpEncoded).get(0).getRLPData());
