...
public class ContractRunner {
    ...
    private ProgramResult createContract(byte[] bytecode, RepositoryReader repository) {
    ...
    private Transaction contractCreateTx(byte[] bytecode, RepositoryReader repository) {
    ...
    private ProgramResult runContract(byte[] contractAddress, byte[] encodedCall, BigInteger value, boolean localCall, RepositoryReader repository) {
    ...
    private TransactionExecutor executeTransaction(Transaction transaction, RepositoryReader repository) {
