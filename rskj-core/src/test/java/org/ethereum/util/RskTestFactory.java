...
public class RskTestFactory {
    ...
    public Repository getRepository() {
        if (repository == null) {
            ...
            repository = new RepositoryImpl(new TrieImpl(new TrieStoreImpl(stateStore, new TrieSerializer()), true), new HashMapDB(), new TrieStorePoolOnMemory(), config.detailsInMemoryStorageLimit());
        }
