...
public class CompactEncoderTest {
    ...
    public void testCompactEncodeOddCompact() {
        ...
        assertArrayEquals(
                "odd compact encode fail", expectedData, CompactEncoder.packNibbles(test));
    }
    ...
    public void testCompactEncodeEvenCompact() {
        ...
        assertArrayEquals(
                "even compact encode fail", expectedData, CompactEncoder.packNibbles(test));
    }
    ...
    public void testCompactEncodeEvenTerminated() {
        ...
        assertArrayEquals(
                "even terminated compact encode fail",
                expectedData,
                CompactEncoder.packNibbles(test));
    }
    ...
    public void testCompactEncodeOddTerminated() {
        ...
        assertArrayEquals(
                "odd terminated compact encode fail",
                expectedData,
                CompactEncoder.packNibbles(test));
    }
