...
public class ImportLightTest {
    ...
    public static BlockChainImpl createBlockchain(Genesis genesis) {
        ...
        Repository repository = new RepositoryImpl(new TrieImpl(new TrieStoreImpl(new HashMapDB(), new TrieSerializer()), true), new HashMapDB(), pool, config.detailsInMemoryStorageLimit());
