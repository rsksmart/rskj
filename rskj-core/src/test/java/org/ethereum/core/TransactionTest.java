...
public class TransactionTest {
    ...
    public void test1()
        ...
        String txRLPRawData =
                "a9e880872386f26fc1000085e8d4a510008203e89413978aee95f38490e9769c39b2773ed763d9cd5f80";
        // String txRLPRawData =
    ...
    public void test2() throws Exception {
        ...
        Transaction tx =
                new Transaction(null, gasPrice, gas, ecKey.getAddress(), value.toByteArray(), null);
        ...
        System.out.println(
                "r\t\t\t: "
                        + Hex.toHexString(BigIntegers.asUnsignedByteArray(tx.getSignature().r)));
        System.out.println(
                "s\t\t\t: "
                        + Hex.toHexString(BigIntegers.asUnsignedByteArray(tx.getSignature().s)));
    ...
    public void test3() throws Exception {
        ...
        Transaction tx =
                new Transaction(
                        nonce, gasPrice, gasLimit, ecKey.getAddress(), value.toByteArray(), null);
    ...
    public void testTransactionFromSignedRLP() throws Exception {
        ...
        assertEquals(
                Hex.toHexString(testReceiveAddress),
                Hex.toHexString(txSigned.getReceiveAddress().getBytes()));
        ...
        assertEquals(
                "eab47c1a49bf2fe5d40e01d313900e19ca485867d462fe06e139e3a536c6d4f4",
                Hex.toHexString(BigIntegers.asUnsignedByteArray(txSigned.getSignature().r)));
        assertEquals(
                "14a569d327dcda4b29f74f93c0e9729d2f49ad726e703f9cd90dbb0fbf6649f1",
                Hex.toHexString(BigIntegers.asUnsignedByteArray(txSigned.getSignature().s)));
    }
    ...
    public void testTransactionFromUnsignedRLP() throws Exception {
        ...
        assertEquals(
                Hex.toHexString(testReceiveAddress),
                Hex.toHexString(txUnsigned.getReceiveAddress().getBytes()));
        ...
        assertEquals(
                "eab47c1a49bf2fe5d40e01d313900e19ca485867d462fe06e139e3a536c6d4f4",
                Hex.toHexString(BigIntegers.asUnsignedByteArray(txUnsigned.getSignature().r)));
        assertEquals(
                "14a569d327dcda4b29f74f93c0e9729d2f49ad726e703f9cd90dbb0fbf6649f1",
    ...
    public void testTransactionFromNew1() throws MissingPrivateKeyException {
        ...
        assertEquals(
                Hex.toHexString(testReceiveAddress),
                Hex.toHexString(txNew.getReceiveAddress().getBytes()));
        ...
        assertEquals(
                "eab47c1a49bf2fe5d40e01d313900e19ca485867d462fe06e139e3a536c6d4f4",
                Hex.toHexString(BigIntegers.asUnsignedByteArray(txNew.getSignature().r)));
        assertEquals(
                "14a569d327dcda4b29f74f93c0e9729d2f49ad726e703f9cd90dbb0fbf6649f1",
    ...
    public void testTransactionFromNew2() throws MissingPrivateKeyException {
        ...
        String RLP_TX_UNSIGNED =
                "eb8085e8d4a510008227109413978aee95f38490e9769c39b2773ed763d9cd5f872386f26fc1000080808080";
        String RLP_TX_SIGNED =
                "f86b8085e8d4a510008227109413978aee95f38490e9769c39b2773ed763d9cd5f872386f26fc10000801ba0eab47c1a49bf2fe5d40e01d313900e19ca485867d462fe06e139e3a536c6d4f4a014a569d327dcda4b29f74f93c0e9729d2f49ad726e703f9cd90dbb0fbf6649f1";
        Keccak256 HASH_TX_UNSIGNED =
                new Keccak256("328ea6d24659dec48adea1aced9a136e5ebdf40258db30d1b1d97ed2b74be34e");
    ...
    public void encodeReceiptTest() {
        ...
        String data =
                "";
        ...
        assertEquals(data, Hex.toHexString(receipt.getEncoded()));
    }
    ...
    public void constantCallConflictTest() throws Exception {
        ...
        */
        ...
        List<String> res =
                new StateTestRunner(stateTestSuite.getTestCases().get("test1")) {
                    @Override
                    protected ProgramResult executeTransaction(Transaction tx) {
...

                        {
                            ...
                            System.out.println(
                                    "Return value: "
                                            + new CallTransaction.IntType("uint")
                                                    .decode(executor.getResult().getHReturn()));
                        }
    ...
    public void contractCreationTest() throws Exception {
        ...
        */
        ...
        List<String> res =
                new StateTestRunner(stateTestSuite.getTestCases().get("test1")).runImpl();
        if (!res.isEmpty()) throw new RuntimeException("Test failed: " + res);
    }
    ...
    public void multiSuicideTest() throws IOException, InterruptedException {
        ...
        Blockchain blockchain =
                ImportLightTest.createBlockchain(
        ...
        String code =
                "";
        String abi =
                "[{\"constant\":false,\"inputs\":[],\"name\":\"homicide\",\"outputs\":[],\"payable\":false,\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"multipleHomicide\",\"outputs\":[],\"payable\":false,\"type\":\"function\"},{\"payable\":true,\"type\":\"fallback\"}]";
    ...
    public void dontLogWhenReverting() throws IOException, InterruptedException {
        ...
        String code1 =
                "";
        // Second contract code TestEventInvoker
        String code2 =
                "";
        // Second contract ABI
        String abi2 =
                "[{\"constant\":false,\"inputs\":[{\"name\":\"invokedAddress\",\"type\":\"address\"}],\"name\":\"doIt\",\"outputs\":[],\"payable\":false,\"type\":\"function\"},{\"anonymous\":false,\"inputs\":[],\"name\":\"externalEvent\",\"type\":\"event\"}]";
        ...
        byte[] data =
                contract2
                        .getByName("doIt")
                        .encode(Hex.toHexString(tx1.getContractAddress().getBytes()));
    ...
    private Transaction createTx(
            Blockchain blockchain, ECKey sender, byte[] receiveAddress, byte[] data)
            throws InterruptedException {
        return createTx(blockchain, sender, receiveAddress, data, 0);
    }

    private Transaction createTx(
            Blockchain blockchain, ECKey sender, byte[] receiveAddress, byte[] data, long value)
            throws InterruptedException {
