...
class PrecompiledContractTest {
    ...
    @Test
    void sha256Test1() throws VMException {
    ...
    @Test
    void sha256Test2() throws VMException {
    ...
    @Test
    void sha256Test3() throws VMException {
    ...
    @Test
    void Ripempd160Test1() throws VMException {
    ...
    void ecRecoverTest1() throws VMException {
    ...
    @Test
    void modExpTest() throws VMException {
    ...
    @Test
    void blake2fTestVector4() throws VMException {
    ...
    @Test
    void blake2fTestVector5() throws VMException {
        internalBlake2fTestVector(
    ...
    @Test
    void blake2fTestVector6() throws VMException {
        internalBlake2fTestVector(
    ...
    @Test
    void blake2fTestVector7() throws VMException {
        internalBlake2fTestVector(
    ...
    void blake2fTestVector8() throws VMException {
        internalBlake2fTestVector(
    ...
    @Test
    void blake2fTestOnNotActivatedHardFork() {
        ActivationConfig.ForBlock activations = mock(ActivationConfig.ForBlock.class);
