...
import co.rsk.db.PersistentMapDBBlocksIndex;
...
public class IndexedBlockStoreTest {
    ...
    public static Collection<Object[]> params() throws IOException {
        Function<TestSystemProperties, KeyValueDataSource> levelDbDataSourceFn = config -> new PersistentLevelDbDataSource("blocks", config.databaseDir());
        Function<TestSystemProperties, KeyValueDataSource> rocksDbDataSourceFn = config -> new PersistentRocksDbDataSource("blocks", config.databaseDir());
    ...
    public void test4() {
        ...
        IndexedBlockStore indexedBlockStore = new IndexedBlockStore(blockFactory, blocksDB, new PersistentMapDBBlocksIndex(indexDB));
        ...
        indexedBlockStore = new IndexedBlockStore(blockFactory, blocksDB, new PersistentMapDBBlocksIndex(indexDB));
