...
public abstract class TestContext {
    ...
    public static final int EMPTY_BLOCKS_TO_GENERATE = 3990;
    ...
    public static final boolean IDEAL_CACHE_ON = false;
    ...
    public static final int DATASOURCE_COINBASES_TO_GENERATE = 40;
