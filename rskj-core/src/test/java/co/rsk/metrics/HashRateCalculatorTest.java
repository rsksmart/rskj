...
class HashRateCalculatorTest {
    ...
    private final RskAddress FAKE_COINBASE = TestUtils.randomAddress("fakeCoinbase");
    private final RskAddress NOT_MY_COINBASE = TestUtils.randomAddress("notMyCoinbase");
