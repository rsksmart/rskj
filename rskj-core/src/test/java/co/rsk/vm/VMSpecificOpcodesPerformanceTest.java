                ...
                getProgram(
                        compile(
                                " PUSH3 0x100000 "
                                        ...
                                        + // ***
                                        " PUSH1 0x00"
                                        + // Out data size for CALL
                                        " PUSH1 0x00"
                                        + // Out data start for CALL
                                        " PUSH1 0x00"
                                        + // In data size for CALL
                                        " PUSH1 0x00"
                                        + // In data start for CALL
                                        " PUSH1 0x00"
                                        + // Value sent in CALL
                                        " DUP7 "
                                        + // Destination address for CALL
                                        " PUSH2 0x2000"
                                        + // Gas for CALL
                                        " CALL "
                                        + // Self-explanatory
                ...
                getProgram(
                        compile(
                                " PUSH5 0x1000000000 "
                                        ...
                                        + // Destination address for CALL
                                        " PUSH1 0x01"
                                        + // ADD one to the contract address
                                        " ADD "
                                        + // ADD one to it
                                        " SWAP7 "
                                        + // save it back
                                        ...
                                        " DUP7 "
                                        + // Bring back the incremented address
                                        " PUSH2 0x2000"
                                        + // Gas for CALL
                                        " CALL "
                                        + " POP "
