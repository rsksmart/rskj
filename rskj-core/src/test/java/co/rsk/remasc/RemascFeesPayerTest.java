...
public class RemascFeesPayerTest {
    ...
    public void payMiningFees() {
        ...
        RemascFeesPayer feesPayer =
                new RemascFeesPayer(repositoryMock, PrecompiledContracts.REMASC_ADDR);
        ...
        Assert.assertEquals(
                "0000000000000000000000006c386a4b26f73c802f34673f7248bb118f97424a",
                result.getTopics().get(1).toString());
        ...
        verify(repositoryMock, times(1))
                .addBalance(PrecompiledContracts.REMASC_ADDR, value.negate());
