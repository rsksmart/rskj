...
public class RemascProcessMinerFeesTest {
    ...
    public void processMinersFeesWithoutMinimumSyntheticSpan() {
        ...
        assertNull(repository.getAccountState(coinbaseA));
        assertNull(repository.getAccountState(remascConfig.getRemascRewardAddress()));
    ...
    public void processMinersFeesWithNoSiblings() {
        ...
        long rskReward = blockReward/remascConfig.getRemascDivisor();
        assertEquals(Coin.valueOf(rskReward), repository.getAccountState(remascConfig.getRemascRewardAddress()).getBalance());
    ...
    public void siblingThatBreaksSelectionRuleGetsPunished() {
        ...
        long rskCurrentBalance = minerRewardOnHeightFour / remascConfig.getRemascDivisor();
        ...
        long rskReward = blockRewardOnHeightFive / remascConfig.getRemascDivisor();
    ...
    public void noPublisherFeeIsPaidWhenThePublisherHasNoSiblings() {
        ...
        long rskCurrentBalance = blockRewardOnHeightFour / remascConfig.getRemascDivisor();
    ...
    private void processMinersFeesWithOneSiblingBrokenSelectionRule(String reasonForBrokenSelectionRule) {
        ...
        rskReward = blockRewardOnHeightSix / remascConfig.getRemascDivisor();
        ...
        rskCurrentBalance += blockRewardOnHeightSix / remascConfig.getRemascDivisor();
        blockRewardOnHeightSix -= blockRewardOnHeightSix / remascConfig.getRemascDivisor();
...
//        }
    ...
    private void validateAccountsCurrentBalanceIsCorrect(RepositorySnapshot repository, Coin cowBalance,
        ...
        assertEquals(rskExpectedBalance, RemascTestRunner.getAccountBalance(repository, remascConfig.getRemascRewardAddress()));
