...
class EthSubscriptionNotificationTest {
        ...
        void basicRequestBlockHeader() throws IOException {
                ...
                String expected = "{\"jsonrpc\":\"2.0\",\"method\":\"eth_subscription\",\"params\":{\"subscription\":\"0x7392\",\"result\":"
        ...
        void gasLimitWithoutLeadingZeros() throws IOException {
                ...
                String expected = "{\"jsonrpc\":\"2.0\",\"method\":\"eth_subscription\",\"params\":{\"subscription\":\"0x7393\",\"result\":"
                                + TEST_BLOCK_RESULT_JSON_2 + "}}";
                assertThat(serializer.serializeMessage(notification), is(expected));
        }
