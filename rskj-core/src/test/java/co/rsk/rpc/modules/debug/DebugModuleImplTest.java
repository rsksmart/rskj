...
class DebugModuleImplTest {
    ...
    void debug_accountTransactionQuota_whenExistingAddress_returnsItsQuota() {
        ...
        TxQuota txQuotaCreated = TxQuota.createNew(address, TestUtils.randomHash("rawAddress"), initialQuota, timeProvider);
    ...
    void debug_accountTransactionQuota_whenNonExistingAddress_returnsNull() {
        ...
        TxQuota txQuotaCreated = TxQuota.createNew(address, TestUtils.randomHash("txQuota"), 200L, System::currentTimeMillis);
