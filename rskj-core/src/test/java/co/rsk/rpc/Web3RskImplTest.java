...
class Web3RskImplTest {
    ...
    void web3_CallArguments_toString() {
        ...
        assertEquals("CallArguments{from='0x1', to='0x2', gas='21000', gasLimit='21000', gasPrice='100', maxPriorityFeePerGas='200', maxFeePerGas='300', value='1', data='data', nonce='0', chainId='0x00', type='0x00', rskSubtype='null', accessList=null, authorizationList=null}", callArguments.toString());
    }
