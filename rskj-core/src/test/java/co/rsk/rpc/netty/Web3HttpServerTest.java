...
public class Web3HttpServerTest {
    ...
    @Test
    @Ignore("fix okhttp problem with charset/gzip")
    ...
    private void smokeTest(
            String contentType, String host, InetAddress rpcAddress, List<String> rpcHost)
            throws Exception {
    ...
    private Response sendJsonRpcMessage(int port, String contentType, String host)
            throws IOException {
        ...
        RequestBody requestBody =
                RequestBody.create(
                        ...
                        JSON_NODE_FACTORY.objectNode().setAll(jsonRpcRequestProperties).toString());
