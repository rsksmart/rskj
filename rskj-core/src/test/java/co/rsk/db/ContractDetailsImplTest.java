...
public class ContractDetailsImplTest {
    private final int IN_MEMORY_STORAGE_LIMIT = 1000;
    ...
    public void getStorageFromNonEmptyDetails() {
        ...
        Assert.assertEquals(DataWord.ONE, DataWord.valueOf(map.get(DataWord.ZERO)));
        Assert.assertEquals(DataWord.valueOf(42), DataWord.valueOf(map.get(DataWord.ONE)));
    }
    ...
    public void getStorageFromNonEmptyDetailsUsingKeys() {
        ...
        Assert.assertEquals(DataWord.ONE, DataWord.valueOf(map.get(DataWord.ZERO)));
        Assert.assertEquals(DataWord.valueOf(144), DataWord.valueOf(map.get(DataWord.valueOf(3))));
    }
    ...
    public void setStorageUsingMap() {
        ...
        map.put(DataWord.ZERO, DataWord.valueOf(42).getData());
        map.put(DataWord.ONE, DataWord.valueOf(144).getData());

        details.setStorage(map);

        Assert.assertEquals(DataWord.valueOf(42), DataWord.valueOf(details.getBytes(DataWord.ZERO)));
        Assert.assertEquals(DataWord.valueOf(144), DataWord.valueOf(details.getBytes(DataWord.ONE)));
    }
    ...
    public void test_1(){
        ...
        Assert.assertEquals(Hex.toHexString(val_1),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_1)).getNoLeadZeroesData()));

        Assert.assertEquals(Hex.toHexString(val_2),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_2)).getNoLeadZeroesData()));
    }
    ...
    public void test_2(){
        ...
        Assert.assertEquals(Hex.toHexString(val_1),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_1)).getData()));

        Assert.assertEquals(Hex.toHexString(val_2),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_2)).getData()));

        Assert.assertEquals(Hex.toHexString(val_3),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_3)).getData()));

        Assert.assertEquals(Hex.toHexString(val_4),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_4)).getData()));

        Assert.assertEquals(Hex.toHexString(val_5),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_5)).getData()));

        Assert.assertEquals(Hex.toHexString(val_6),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_6)).getData()));

        Assert.assertEquals(Hex.toHexString(val_7),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_7)).getData()));

        Assert.assertEquals(Hex.toHexString(val_8),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_8)).getData()));

        Assert.assertEquals(Hex.toHexString(val_9),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_9)).getData()));

        Assert.assertEquals(Hex.toHexString(val_10),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_10)).getData()));

        Assert.assertEquals(Hex.toHexString(val_11),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_11)).getData()));

        Assert.assertEquals(Hex.toHexString(val_12),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_12)).getData()));

        Assert.assertEquals(Hex.toHexString(val_13),
                Hex.toHexString(contractDetails.get(DataWord.valueOf(key_13)).getData()));
    }
