...
public class TrieStoreImplTest {
    ...
    public void saveAndRetrieveTrieNodeWith32BytesKey() {
        ...
        Trie trie = new TrieImpl(store, false).put(HashUtil.keccak256("foo".getBytes()), "bar".getBytes());
        ...
        Assert.assertNotNull(newTrie.get(HashUtil.keccak256("foo".getBytes())));
    }
    ...
    public void saveAndRetrieveTrieNodeWith33BytesValue() {
        ...
        byte[] key = HashUtil.keccak256("foo".getBytes());
