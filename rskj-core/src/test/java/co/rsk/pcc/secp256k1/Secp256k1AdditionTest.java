...
class Secp256k1AdditionTest {
    ...
    void setUp() {
        ...
        secp256k1Addition = new Secp256k1Addition(activations, secp256k1Service);
    }
    ...
    void whenRSKIP516IsNotActive_thenExecuteThrowsVMException() {
        ...
        Secp256k1Addition secp256k1Addition = new Secp256k1Addition(activations, secp256k1Service);
        byte[] inputData = TestUtils.generateBytes("secp256k1AdditionInput", 128);

        // when & then
        VMException exception = assertThrows(VMException.class, () -> {
            secp256k1Addition.execute(inputData);
        });
