...
/**
 * Simple DSL-based test for Secp256k1Addition precompiled contract.
 * This test deploys a simple contract that calls the Secp256k1Addition
 * precompiled contract and verifies that the function call succeeds
 * and the expected event is emitted.
 */
class Secp256k1AdditionDslTest {

    private static final String DSL_SECP256K1_ADDITION_TXT = "dsl/ec_precompiled_contracts/secp256k1_addition.txt";
    public static final double EC_DEFAULT_ADDITION_GAS_COST = 150;
    ...
    @Test
    void testSecp256k1AdditionWithRSKIP516Enabled() throws FileNotFoundException, DslProcessorException {
        // given
        DslParser parser = DslParser.fromResource(DSL_SECP256K1_ADDITION_TXT);
    ...
    @Test
    void testSecp256k1AdditionWithRSKIP516Disabled() throws FileNotFoundException, DslProcessorException {
        // given
    ...
    void testPrecompiledContractAddress() {
        ...
        assertEquals("0000000000000000000000000000000001000016",
                PrecompiledContracts.SECP256K1_ADDITION_ADDR_STR);
    }
    ...
    private void verifyGasConsumption(String transactionName) {
        ...
        assertTrue(actualGasUsed >= EC_DEFAULT_ADDITION_GAS_COST,
                "Transaction " + transactionName + " should use at least " + EC_DEFAULT_ADDITION_GAS_COST
                        + " gas, but used "
                        + actualGasUsed);
    }
}