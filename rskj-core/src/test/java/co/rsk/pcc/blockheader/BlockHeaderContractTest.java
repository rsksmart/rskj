...
public class BlockHeaderContractTest {
    ...
    public void getCoinbase() {
        ...
        contract.init(rskTx, world.getBlockChain().getBestBlock(), world.getRepository(), world.getBlockStore(), null, new LinkedList<>(), null);
    ...
    private void initContract(BlockHeaderContract contract, Transaction tx, Block block, World world) {
        contract.init(tx, block, world.getRepository(), world.getBlockStore(), null, new LinkedList<>(), null);
    }
