...
public class PerformanceTestHelper {
    ...
    protected long deltaTime; // in nanoseconds
    protected long deltaRealTime; // in milliseconds
    protected long deltaGCTime;
    ...
    public long getDeltaRealTime() {
        return deltaRealTime;
    }
