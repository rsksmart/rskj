...
public class BlockGenerator {
    ...
    public Block createChildBlock(Block parent, long fees, List<BlockHeader> uncles, byte[] difficulty) {
        byte[] unclesListHash = HashUtil.keccak256(BlockBodyCodec.encodeUncles(uncles));
    ...
    public Block createChildBlockUsingCoinbase(
        ...
        short[] edges = activationConfig.areActive(parent.getNumber() + 1, ConsensusRule.RSKIP351, ConsensusRule.RSKIP144)  ? new short[0] : null;
    ...
    public Block createBlock(long number, int ntxs, Long gasLimit){
        ...
        Coin minimumGasPrice = new MinimumGasPriceCalculator(new FixedMinGasPriceProvider(100L)).calculate(previousMGP);
        ...
        BlockHeader newHeader = blockFactory.getBlockHeaderBuilder()
                ...
                .setUmmRoot(ummRoot)
                .setCreateParallelCompliantHeader(activationConfig.areActive(number, ConsensusRule.RSKIP351, ConsensusRule.RSKIP144))
                .build();
