...
public class RepositoryBtcBlockStoreWithCacheTest {
    ...
    private BtcBlockStoreWithCache createBlockStoreWithTrack(
            RepositoryBtcBlockStoreWithCache.Factory factory, Repository track) {
    ...
    public void cacheLivesAcrossInstances_Test() throws BlockStoreException {
        ...
        RepositoryBtcBlockStoreWithCache.Factory factory = createBlockStoreFactory();
        BtcBlockStoreWithCache btcBlockStore =
                createBlockStoreWithTrack(factory, repository.startTracking());
        ...
        BtcBlockStoreWithCache btcBlockStore2 =
                createBlockStoreWithTrack(factory, repository.startTracking());
    ...
    public void getStoredBlockAtMainChainDepth_And_Height_Test() throws BlockStoreException {
        ...
        assertEquals(
                storedBlock3,
                btcBlockStore.getStoredBlockAtMainChainDepth(maxHeight - storedBlock3.getHeight()));
        assertEquals(
                storedBlock2,
                btcBlockStore.getStoredBlockAtMainChainDepth(maxHeight - storedBlock2.getHeight()));
        assertEquals(
                storedBlock1,
                btcBlockStore.getStoredBlockAtMainChainDepth(maxHeight - storedBlock1.getHeight()));
    ...
    public void checkDifferentInstancesWithSameRepoHaveSameContentTest() throws Exception {
        //        This Is how I produced RepositoryBlockStore_data.ser. I had a bitcoind in regtest
        // with 613 blocks + genesis block
        ...
        //        for (int i = 0; i < 614; i++) {
        //            Triple<byte[], BigInteger , Integer> tripleStoredBlock = new
        // ImmutableTriple<>(storedBlock.getHeader().bitcoinSerialize(), storedBlock.getChainWork(),
        ...
        InputStream fileInputStream =
                ClassLoader.getSystemResourceAsStream("peg/RepositoryBlockStore_data.ser");
        ...
        for (int i = 0; i < 614; i++) {
            Triple<byte[], BigInteger, Integer> tripleStoredBlock =
                    (Triple<byte[], BigInteger, Integer>) objectInputStream.readObject();
            BtcBlock header =
                    RegTestParams.get()
                            .getDefaultSerializer()
                            .makeBlock(tripleStoredBlock.getLeft());
            StoredBlock storedBlock =
                    new StoredBlock(
                            header, tripleStoredBlock.getMiddle(), tripleStoredBlock.getRight());
            if (i == 0) {
        ...
        assertEquals(
                store.get(
                        Sha256Hash.wrap(
                                "373941fe83961cf70e181e468abc5f9f7cc440c711c3d06948fa66f3912ed27a")),
                store2.get(
                        Sha256Hash.wrap(
                                "373941fe83961cf70e181e468abc5f9f7cc440c711c3d06948fa66f3912ed27a")));
