...
public class BridgeUtilsTest {
    ...
    private Genesis getGenesisInstance(Repository repository) {
        return new TestGenesisLoader(repository, "frontier.json", constants.getInitialNonce(), false, true, true).load();
    }
}
