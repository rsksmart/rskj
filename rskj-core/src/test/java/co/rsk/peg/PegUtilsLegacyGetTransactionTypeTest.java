...
class PegUtilsLegacyGetTransactionTypeTest {
    ...
    void test_sentFromP2SHErpFed() {
        ...
        FederationArgs retiringFedArgs =
            new FederationArgs(retiringFedMembers, creationTime, 0L, btcMainnetParams);
        ErpFederation p2shRetiringFederation = FederationFactory.buildP2shErpFederation(
            retiringFedArgs, erpPubKeys, activationDelay
        );
        ...
        FederationTestUtils.addSignaturesAndFederationRedeemScript(p2shRetiringFederation, fedKeys, migrationTx);
    ...
    void test_sentFromOldFed(ActivationConfig.ForBlock activations, PegTxType expectedTxType) {
        ...
        FederationTestUtils.addSignaturesAndFederationRedeemScript(retiredFederation, REGTEST_OLD_FEDERATION_PRIVATE_KEYS, migrationTx);
    ...
    void test_sentFromP2SH_pegin() {
        ...
        FederationTestUtils.addSignaturesAndFederationRedeemScript(unknownFed, unknownFedSigners, peginTx);
    ...
    void test_pegin(
        ...
        FederationArgs federationArgs =
            new FederationArgs(activeFedMembers, creationTime, 0L, btcMainnetParams);
        ErpFederation activeFederation = FederationFactory.buildP2shErpFederation(federationArgs, erpFedKeys, 100L);
    ...
    void test_pegout_tx() {
        ...
        FederationTestUtils.addSignaturesAndFederationRedeemScript(activeFederation, fedKeys, pegoutBtcTx);
    ...
    void test_migration_tx() {
        ...
        FederationTestUtils.addSignaturesAndFederationRedeemScript(retiringFederation, retiringFedKeys, migrationTx);
