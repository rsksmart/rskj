...
class FeePerKbConstantsTest {
    ...
    @ParameterizedTest
    @MethodSource("getGenesisFeePerKbTestProvider")
    void getGenesisFeePerKbTest(FeePerKbConstants feePerKbConstants, Coin expectedGenesisFeePerKb) {
    ...
    private static Stream<Arguments> getGenesisFeePerKbTestProvider(){
        return Stream.of(
    ...
    @ParameterizedTest
    @MethodSource("getMaxFeePerKbTestProvider")
    void getMaxFeePerKbTest(FeePerKbConstants feePerKbConstants, Coin expectedMaxFeePerKb) {
        Coin actualMaxFeePerKb = feePerKbConstants.getMaxFeePerKb();
        assertEquals(expectedMaxFeePerKb, actualMaxFeePerKb);
    }

    private static Stream<Arguments> getMaxFeePerKbTestProvider(){
        return Stream.of(
    ...
    @ParameterizedTest
    @MethodSource("getFeePerKbChangeAuthorizerTestProvider")
    void getFeePerKbChangeAuthorizerTest(FeePerKbConstants feePerKbConstants, AddressBasedAuthorizer expectedFeePerKbChangeAuthorizer) {
    ...
    private static Stream<Arguments> getFeePerKbChangeAuthorizerTestProvider(){
        //MainNet
