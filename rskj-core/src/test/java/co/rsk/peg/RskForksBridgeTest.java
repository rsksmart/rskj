...
public class RskForksBridgeTest {
    ...
    public void before() throws IOException, ClassNotFoundException {
        ...
        whitelistManipulationKey =
                ECKey.fromPrivate(
                        Hex.decode(
                                "3890187a3071327cee08467ba1b44ed4c13adb2da0d5ffcc0563c371fa88259c"));
        ...
        blockBase =
                buildBlock(genesis, whitelistAddressTx, receiveHeadersTx, registerBtctransactionTx);
    ...
    private Transaction buildWhitelistTx() {
        ...
        Transaction rskTx =
                CallTransaction.createCallTransaction(
                        ...
                        value,
                        Bridge.ADD_ONE_OFF_LOCK_WHITELIST_ADDRESS,
                        Constants.REGTEST_CHAIN_ID,
                        new Object[] {
                            "mhxk5q8QdGFoaP4SJ3DPtXjrbxAgxjNm3C",
                            BigInteger.valueOf(Coin.COIN.multiply(4).value)
                        });
    ...
    private Transaction buildReceiveHeadersTx() {
        ...
        Transaction rskTx =
                CallTransaction.createCallTransaction(
                        ...
                        Constants.REGTEST_CHAIN_ID,
                        new Object[] {headerArray});
        rskTx.sign(fedECPrivateKey.getPrivKeyBytes());
        return rskTx;
    }

    private Transaction buildRegisterBtcTransactionTx() {
        String txSerializedEncoded =
                "";
        byte[] txSerialized = Hex.decode(txSerializedEncoded);
        int blockHeight = 102;
        String pmtSerializedEncoded =
                "030000000279e7c0da739df8a00f12c0bff55e5438f530aa5859ff9874258cd7bad3fe709746aff897e6a851faa80120d6ae99db30883699ac0428fc7192d6c3fec0ca6409010d";
    ...
    private void assertReleaseTransactionState(ReleaseTransactionState state)
        ...
        if (ReleaseTransactionState.WAITING_FOR_SELECTION.equals(state)) {
            ...
            Assert.assertEquals(
                    0, stateForDebugging.getReleaseTransactionSet().getEntries().size());
            ...
            Assert.assertEquals(0, stateForDebugging.getReleaseRequestQueue().getEntries().size());
            Assert.assertEquals(
                    1, stateForDebugging.getReleaseTransactionSet().getEntries().size());
            Assert.assertEquals(0, stateForDebugging.getRskTxsWaitingForSignatures().size());
    ...
    private BridgeState callGetStateForDebuggingTx() throws IOException, ClassNotFoundException {
        ...
        TransactionExecutorFactory transactionExecutorFactory =
                new TransactionExecutorFactory(
                        ...
                        new PrecompiledContracts(
                                beforeBambooProperties, world.getBtcBlockStoreFactory()));
        ...
        return BridgeState.create(
                beforeBambooProperties.getNetworkConstants().getBridgeConstants(),
                (byte[]) result[0]);
    }
}
