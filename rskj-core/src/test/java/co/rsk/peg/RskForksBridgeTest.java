...
public class RskForksBridgeTest {
    ...
    private Transaction buildWhitelistTx() throws IOException, ClassNotFoundException {
        ...
        // This whitelist tx is considering that RFS-170 is false. If you configure it to be true change "ADD_LOCK_WHITELIST_ADDRESS" to be "ADD_ONE_OFF_LOCK_WHITELIST_ADDRESS"
