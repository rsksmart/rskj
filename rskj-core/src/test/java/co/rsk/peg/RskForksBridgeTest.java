...
public class RskForksBridgeTest {
    ...
    private Block buildBlock(Block parent, long difficulty) {
        ...
        BlockBuilder blockBuilder = new BlockBuilder(world.getBlockChain(), world.getBridgeSupportFactory()).repository(world.getBlockChain().getRepository()).difficulty(difficulty).parent(parent);
    ...
    private Block buildBlock(Block parent, long difficulty, Transaction ... txs) {
        ...
        World world = new World(blockChain, null, null, genesis);
        BlockBuilder blockBuilder = new BlockBuilder(world.getBlockChain(), world.getBridgeSupportFactory()).repository(world.getBlockChain().getRepository()).difficulty(difficulty).parent(parent).transactions(txList).uncles(new ArrayList<>());
        return blockBuilder.build();
    }
