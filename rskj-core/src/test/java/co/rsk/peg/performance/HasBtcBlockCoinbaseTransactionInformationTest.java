...
public class HasBtcBlockCoinbaseTransactionInformationTest extends BridgePerformanceTestCase {
    ...
    @Test
    public void hasBtcBlockCoinbaseTransactionInformation() throws PrecompiledContractException {
    ...
    private void hasBtcBlockCoinbaseTransactionInformation_success(int times, ExecutionStats stats) throws PrecompiledContractException {
    ...
    private void hasBtcBlockCoinbaseTransactionInformation_unsuccess(int times, ExecutionStats stats) throws PrecompiledContractException {
        BridgeStorageProviderInitializer storageInitializer = generateInitializerForTest(
                Sha256Hash.ZERO_HASH
        );
