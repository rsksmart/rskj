...
public abstract class BridgePerformanceTestCase {
    ...
    private ExecutionTracker execute(
        ...
        RepositoryTrackWithBenchmarking benchmarkerTrack = (RepositoryTrackWithBenchmarking) ((RepositoryImpl)repository).startTrackingWithBenchmark();
    ...
    public static RepositoryImpl createRepositoryImpl(RskSystemProperties config) {
        return new RepositoryImpl(new TrieImpl());
    }
}
