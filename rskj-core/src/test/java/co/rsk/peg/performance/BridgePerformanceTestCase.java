...
public abstract class BridgePerformanceTestCase extends PrecompiledContractPerformanceTestCase {
    ...
    protected static class Helper extends PrecompiledContractPerformanceTestCase.Helper {
        ...
        public static final List<ECKey> FEDERATOR_ECKEYS =
                Arrays.stream(new String[] {"federator1", "federator2", "federator3"})
                        .map(
                                generator ->
                                        ECKey.fromPrivate(
                                                HashUtil.keccak256(
        ...
        public static ECKey getRandomFederatorECKey() {
            return Helper.FEDERATOR_ECKEYS.get(
                    Helper.randomInRange(0, Helper.FEDERATOR_ECKEYS.size() - 1));
        }
        ...
        public static BtcBlock generateAndAddBlocks(
                BtcBlockChain btcBlockChain, int blocksToGenerate) {
        ...
        public static BtcBlock generateBtcBlock(
                BtcBlock prevBlock, List<BtcTransaction> txs, Sha256Hash merkleRoot) {
            long nonce = 0;
        ...
        public static BridgeStorageProviderInitializer buildNoopInitializer() {
            return (BridgeStorageProvider provider,
    ...
    protected ExecutionStats executeAndAverage(
                ...
                new EnvironmentBuilder() {
                    ...
                    public Environment build(int executionIndex, TxBuilder txBuilder, int height) {
                        ...
                        storageInitializer.initialize(
                                storageProvider, benchmarkerTrack, executionIndex);
                        try {
                            storageProvider.save();
                        } catch (Exception e) {
                            throw new RuntimeException(
                                    "Error trying to save the storage after initialization", e);
                        }
        ...
        return super.executeAndAverage(
                name,
                times,
                environmentBuilder,
                abiEncoder,
