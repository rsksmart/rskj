...
public final class BridgeSupportTestUtil {
    ...
    public static void assertLegacyScriptSigWithoutSignaturesHasProperFormat(Script scriptSig, Script redeemScript) {
        assertBasicLegacyScriptSigStructure(scriptSig, redeemScript);
    ...
    public static void assertLegacyScriptSigWithSignaturesHasProperFormat(Script scriptSig, Script redeemScript) {
        assertBasicLegacyScriptSigStructure(scriptSig, redeemScript);
    ...
    public static void assertBasicLegacyScriptSigStructure(Script scriptSig, Script redeemScript) {
        List<ScriptChunk> scriptSigChunks = scriptSig.getChunks();
    ...
    public static void assertWitnessScriptWithoutSignaturesHasProperFormat(TransactionWitness witness, Script redeemScript) {
    ...
    public static void assertWitnessScriptWithSignaturesHasProperFormat(TransactionWitness witness, Script redeemScript) {
        assertBasicWitnessScriptStructure(witness, redeemScript);
    ...
    public static void assertBasicWitnessScriptStructure(TransactionWitness witness, Script redeemScript) {
