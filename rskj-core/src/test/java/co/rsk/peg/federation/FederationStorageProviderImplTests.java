...
class FederationStorageProviderImplTests {
    ...
    void getNewFederationBtcUTXOs_calledTwice_returnCachedUtxos() {
        ...
        expectedUtxos.add(PegTestUtils.createUTXO(1, 0, Coin.COIN));
        ...
        List<UTXO> extraUtxos = new ArrayList<>(actualUtxos);
        extraUtxos.add(PegTestUtils.createUTXO(1, 0, Coin.COIN));
        storageAccessor.saveToRepository(newFederationBtcUtxosKey, extraUtxos, BridgeSerializationUtils::serializeUTXOList);

        actualUtxos = federationStorageProvider.getNewFederationBtcUTXOs(null, activations);
