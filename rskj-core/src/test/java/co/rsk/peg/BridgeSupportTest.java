...
class BridgeSupportTest {
    ...
    class ReleaseTransactionInfo {
        ...
        @Test
        void registerBtcTransaction_forRefundableLegacyPeginFromMultisig_withOutputsToLegacyRetiringFedAndSegwitActiveFed_shouldSetRedeemDataInTxWitness() throws Exception {
            // arrange
            setUpWithActivations(allActivations);
            Federation retiringFederation = P2shErpFederationBuilder.builder().build();

            // adding one new key to active fed so redeem scripts are different
            List<BtcECKey> keys = retiringFederation.getBtcPublicKeys();
            keys.add(getBtcEcKeyFromSeed("new key"));
            activeFederation = P2shP2wshErpFederationBuilder.builder()
                .withMembersBtcPublicKeys(keys)
                .build();

            // arrange for both feds being live
            federationStorageProvider.setOldFederation(retiringFederation);
            federationStorageProvider.setNewFederation(activeFederation);
            ...
            BtcTransaction pegin = createLegacyPeginFromMultiSigToActiveFed(amountToSendToActiveFed);
            Coin amountToSendToRetiringFed = amountToSendToActiveFed.div(2);
            pegin.addOutput(amountToSendToRetiringFed, retiringFederation.getAddress());
            setUpForTransactionRegistration(pegin, pegoutTxIndexActivationHeight, allActivations);
    ...
    private static Stream<Arguments> getEstimatedFeesForNextPegOutEventArgsProvider_forSegwit(BridgeConstants bridgeConstants) {
        ...
        FederationConstants federationConstants = bridgeConstants.getFederationConstants();
        String[] seeds = {"fa01", "fa02", "fa03"};
        List<BtcECKey> erpFedPubKeys = getBtcEcKeysFromSeeds(seeds, true);
        ...
        return Stream.of(
            ...
            Arguments.of(
                activations,
                p2shFed,
                Coin.valueOf(bridgeConstants instanceof BridgeMainNetConstants? 9150L: 9140L),
                List.of(),
            ...
            Arguments.of(
                activations,
                p2shFed,
                Coin.valueOf(bridgeConstants instanceof BridgeMainNetConstants? 17260L: 17240L),
            ...
            Arguments.of(
                activations,
                p2shFed,
                Coin.valueOf(bridgeConstants instanceof BridgeMainNetConstants? 18220L: 18200L),
            ...
            Arguments.of(
                activations,
                p2shFed,
                Coin.valueOf(bridgeConstants instanceof BridgeMainNetConstants? 18560L: 18540L),
            ...
            Arguments.of(
                activations,
                p2shP2wshFed,
                Coin.valueOf(5580L), // Savings: 59.75% for mainnet. 58.57% for regtest.
                List.of(),
            ...
            Arguments.of(
                activations,
                p2shP2wshFed,
                Coin.valueOf(bridgeConstants instanceof BridgeMainNetConstants? 9410L: 9400L),
                List.of(pegoutRequest1),
                List.of()
            ),
            // active fed is p2sh p2wsh and there is 1 pegout requests
            Arguments.of(
                activations,
                p2shP2wshFed,
                Coin.valueOf(5920L), // Savings: 61.12% for mainnet. 59.94% for regtest.
                List.of(pegoutRequest1),
                List.of(p2shP2wshFedUtxo1)
            ),
            ...
            Arguments.of(
                activations,
                p2shP2wshFed,
                Coin.valueOf(6260L), // Savings: 62.42% for mainnet. 61.24% for regtest.
                List.of(pegoutRequest1, pegoutRequest2),
                List.of(p2shP2wshFedUtxo1)
            ),
            ...
            Arguments.of(
                activations,
                p2shP2wshFed,
                Coin.valueOf(6600L), // Savings: 63.66% for mainnet. 62.45% for regtest.
                List.of(pegoutRequest1, pegoutRequest2, pegoutRequest3),
                List.of(p2shP2wshFedUtxo1)
            ),
            ...
            Arguments.of(
                activations,
                p2shP2wshFed,
                Coin.valueOf(11090L), // Savings: 59.58% for mainnet. 58.45% for regtest.
                List.of(pegoutRequest1, bigPegoutRequest),
            ...
            Arguments.of(
                activations,
                p2shP2wshFed,
                Coin.valueOf(11430L), // Savings: 60.29% for mainnet. 59.13% for regtest.
                List.of(pegoutRequest1, pegoutRequest2, bigPegoutRequest),
                List.of(p2shP2wshFedUtxo1, p2shP2wshFedBigUtxo)
            ),
            // active fed is p2sh p2wsh and there are 3 pegout requests
            Arguments.of(
                activations,
                p2shP2wshFed,
                Coin.valueOf(11770L), // Savings: 60.97% for mainnet. 59.83% for regtest.
                List.of(pegoutRequest1, pegoutRequest2, pegoutRequest3, bigPegoutRequest),
                List.of(p2shP2wshFedUtxo1, p2shP2wshFedBigUtxo)
            )
