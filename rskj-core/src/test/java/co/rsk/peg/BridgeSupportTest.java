...
public class BridgeSupportTest {
    private static final co.rsk.core.Coin LIMIT_MONETARY_BASE =
            new co.rsk.core.Coin(new BigInteger("21000000000000000000000000"));
    ...
    public void testInitialChainHeadWithBtcCheckpoints() throws Exception {
        ...
        CheckpointManager manager =
                new CheckpointManager(bridgeConstants.getBtcParams(), checkpointsStream);
        ...
        Assert.assertEquals(
                checkpoint.getHeight(), bridgeSupport.getBtcBlockchainBestChainHeight());
    }
    ...
    private List<BtcBlock> createBtcBlocks(
            NetworkParameters _networkParameters, BtcBlock parent, int numberOfBlocksToCreate) {
    ...
    private InputStream getCheckpoints(
            NetworkParameters _networkParameters, List<BtcBlock> checkpoints) {
        try {
            ByteArrayOutputStream baOutputStream = new ByteArrayOutputStream();
            MessageDigest digest = Sha256Hash.newDigest();
            final DigestOutputStream digestOutputStream =
                    new DigestOutputStream(baOutputStream, digest);
            digestOutputStream.on(false);
            final DataOutputStream dataOutputStream = new DataOutputStream(digestOutputStream);
            StoredBlock storedBlock =
                    new StoredBlock(
                            _networkParameters.getGenesisBlock(),
                            _networkParameters.getGenesisBlock().getWork(),
                            0);
            try {
    ...
    public void callUpdateCollectionsGenerateEventLog() throws IOException, BlockStoreException {
        ...
        List<Block> blocks =
                blockGenerator.getSimpleBlockChain(blockGenerator.getGenesisBlock(), 10);
        ...
        Assert.assertArrayEquals(
                key.getAddress(), RLP.decode2(result.getData()).get(0).getRLPData());
    }

    @Test
    public void callUpdateCollectionsFundsEnoughForJustTheSmallerTx()
        ...
        BridgeStorageProvider provider0 =
                new BridgeStorageProvider(
                        track,
                        PrecompiledContracts.BRIDGE_ADDR,
                        bridgeConstants,
        ...
        provider0
                .getReleaseRequestQueue()
                .add(new BtcECKey().toAddress(btcParams), Coin.valueOf(30, 0));
        provider0
                .getReleaseRequestQueue()
                .add(new BtcECKey().toAddress(btcParams), Coin.valueOf(20, 0));
        provider0
                .getReleaseRequestQueue()
                .add(new BtcECKey().toAddress(btcParams), Coin.valueOf(10, 0));
    ...
    @Test
    public void callUpdateCollectionsThrowsCouldNotAdjustDownwards()
            throws IOException, BlockStoreException {
        // Federation is the genesis federation ATM
        Federation federation = bridgeConstants.getGenesisFederation();
        ...
        provider0
                .getReleaseRequestQueue()
                .add(new BtcECKey().toAddress(btcParams), Coin.valueOf(37500));
        provider0.setFeePerKb(Coin.MILLICOIN);
        provider0
                .getNewFederationBtcUTXOs()
                .add(
    ...
    @Test
    public void callUpdateCollectionsThrowsExceededMaxTransactionSize()
            throws IOException, BlockStoreException {
        // Federation is the genesis federation ATM
        Federation federation = bridgeConstants.getGenesisFederation();
        ...
        provider0
                .getReleaseRequestQueue()
                .add(new BtcECKey().toAddress(btcParams), Coin.COIN.multiply(7));
    ...
    public void minimumProcessFundsMigrationValue() throws IOException, BlockStoreException {
        ...
        sufficientUTXOsForMigration2.add(
                createUTXO(Coin.MILLICOIN.divide(2), oldFederation.getAddress()));
        sufficientUTXOsForMigration2.add(
                createUTXO(Coin.MILLICOIN.divide(2), oldFederation.getAddress()));
    ...
    public void callUpdateCollectionsChangeGetsOutOfDust() throws IOException, BlockStoreException {
        ...
        preMineMap.put(
                PrecompiledContracts.BRIDGE_ADDR.getBytes(), LIMIT_MONETARY_BASE.asBigInteger());
        ...
        Assert.assertEquals(0, provider.getRskTxsWaitingForSignatures().size());
        Assert.assertEquals(
                LIMIT_MONETARY_BASE.subtract(co.rsk.core.Coin.fromBitcoin(Coin.valueOf(2600))),
                repository.getBalance(PrecompiledContracts.BRIDGE_ADDR));
        Assert.assertEquals(
                co.rsk.core.Coin.fromBitcoin(Coin.valueOf(2600)),
                repository.getBalance(BridgeSupport.BURN_ADDRESS));
        // Check the wallet has been emptied
        Assert.assertTrue(provider.getNewFederationBtcUTXOs().isEmpty());
    }

    @Test
    public void callUpdateCollectionsWithTransactionsWaitingForConfirmationWithEnoughConfirmations()
            throws IOException, BlockStoreException {
        ...
        PowerMockito.when(
                        BridgeUtils.getFederationSpendWallet(
                                any(Context.class), any(Federation.class), any(List.class)))
                .thenReturn(new SimpleWallet(context));
        ...
        BridgeStorageProvider provider2 =
                new BridgeStorageProvider(
                        repository,
                        PrecompiledContracts.BRIDGE_ADDR,
                        bridgeConstants,
    ...
    public void sendOrphanBlockHeader() throws IOException, BlockStoreException {
        ...
        BridgeSupport bridgeSupport =
                new BridgeSupport(
                        bridgeConstants, provider, null, track, null, mockFactory, btcBlockChain);

        co.rsk.bitcoinj.core.BtcBlock block =
                new co.rsk.bitcoinj.core.BtcBlock(
                        btcParams,
                        1,
                        PegTestUtils.createHash(),
                        PegTestUtils.createHash(),
    ...
    public void addSignatureToMissingTransaction() throws Exception {
        ...
        bridgeSupport.addSignature(
                federation.getBtcPublicKeys().get(0), null, PegTestUtils.createHash().getBytes());
        bridgeSupport.save();
    ...
    public void addSignatureWithInvalidSignature() throws Exception {
        addSignatureFromValidFederator(
                Lists.newArrayList(new BtcECKey()), 1, true, false, "InvalidParameters");
    }

    @Test
    public void addSignatureWithLessSignaturesThanExpected() throws Exception {
        List<BtcECKey> keys =
                Arrays.asList(BridgeRegTestConstants.REGTEST_FEDERATION_PRIVATE_KEYS.get(0));
    ...
    public void addSignatureCreateEventLog() throws Exception {
        ...
        TransactionOutput prevOut =
                new TransactionOutput(btcParams, prevTx, Coin.FIFTY_COINS, federation.getAddress());
        ...
        btcTx.addInput(prevOut)
                .setScriptSig(
                        PegTestUtils.createBaseInputScriptThatSpendsFromTheFederation(federation));
        TransactionOutput output =
                new TransactionOutput(
                        btcParams, btcTx, Coin.COIN, new BtcECKey().toAddress(btcParams));
        ...
        Sha256Hash sigHash =
                btcTx.hashForSignature(0, redeemScript, BtcTransaction.SigHash.ALL, false);
        BtcECKey privateKeyToSignWith =
                BridgeRegTestConstants.REGTEST_FEDERATION_PRIVATE_KEYS.get(0);
        ...
        BtcECKey federatorPubKey =
                findPublicKeySignedBy(federation.getBtcPublicKeys(), privateKeyToSignWith);
    ...
    public void addSignatureTwoSignatures() throws Exception {
        List<BtcECKey> federatorPrivateKeys =
                BridgeRegTestConstants.REGTEST_FEDERATION_PRIVATE_KEYS;
        List<BtcECKey> keys =
                Arrays.asList(federatorPrivateKeys.get(0), federatorPrivateKeys.get(1));
    ...
    public void addSignatureMultipleInputsPartiallyValid() throws Exception {
        ...
        TransactionOutput prevOut1 =
                new TransactionOutput(
                        btcParams, prevTx1, Coin.FIFTY_COINS, federation.getAddress());
        prevTx1.addOutput(prevOut1);
        BtcTransaction prevTx2 = new BtcTransaction(btcParams);
        TransactionOutput prevOut2 =
                new TransactionOutput(
                        btcParams, prevTx1, Coin.FIFTY_COINS, federation.getAddress());
        prevTx2.addOutput(prevOut2);
        BtcTransaction prevTx3 = new BtcTransaction(btcParams);
        TransactionOutput prevOut3 =
                new TransactionOutput(
                        btcParams, prevTx1, Coin.FIFTY_COINS, federation.getAddress());
        ...
        TransactionOutput output =
                new TransactionOutput(btcParams, t, Coin.COIN, new BtcECKey().toAddress(btcParams));
        t.addOutput(output);
        t.addInput(prevOut1)
                .setScriptSig(
                        PegTestUtils.createBaseInputScriptThatSpendsFromTheFederation(federation));
        ...
        BtcECKey privateKeyOfFirstFed =
                BridgeRegTestConstants.REGTEST_FEDERATION_PRIVATE_KEYS.get(0);
        BtcECKey privateKeyOfSecondFed =
                BridgeRegTestConstants.REGTEST_FEDERATION_PRIVATE_KEYS.get(1);
        ...
        for (int i = 0; i < 3; i++) {
            ...
            Script redeemScript = new Script(program);
            Sha256Hash sighash =
                    t.hashForSignature(i, redeemScript, BtcTransaction.SigHash.ALL, false);
        ...
        bridgeSupport.addSignature(
                findPublicKeySignedBy(federation.getBtcPublicKeys(), privateKeyOfFirstFed),
                derEncodedSigsFirstFed,
                keccak256.getBytes());
        bridgeSupport.save();
        track.commit();
        ...
        bridgeSupport.addSignature(
                findPublicKeySignedBy(federation.getBtcPublicKeys(), privateKeyOfSecondFed),
                derEncodedSigsSecondFed,
                keccak256.getBytes());
        bridgeSupport.save();
        track.commit();
        ...
        BtcTransaction releaseTx =
                new BtcTransaction(
                        btcParams,
                        ((RLPList) RLP.decode2(releaseTxEvent.getData()).get(0))
                                .get(1)
                                .getRLPData());
    ...
    /**
     * Helper method to test addSignature() with a valid federatorPublicKey parameter and both
     * valid/invalid signatures
     *
     * @param privateKeysToSignWith keys used to sign the tx. Federator key when we want to produce
     *     a valid signature, a random key when we want to produce an invalid signature
     * @param numberOfInputsToSign There is just 1 input. 1 when testing the happy case, other
     *     values to test attacks/bugs.
     * @param signatureCanonical Signature should be canonical. true when testing the happy case,
     *     false to test attacks/bugs.
     * @param signTwice Sign again with the same key
     * @param expectedResult "InvalidParameters", "PartiallySigned" or "FullySigned"
     */
    private void addSignatureFromValidFederator(
            List<BtcECKey> privateKeysToSignWith,
            int numberOfInputsToSign,
            boolean signatureCanonical,
            boolean signTwice,
        ...
        bridgeSupport.addSignature(
                findPublicKeySignedBy(federation.getBtcPublicKeys(), privateKeysToSignWith.get(0)),
                derEncodedSigs,
                keccak256.getBytes());
        if (signTwice) {
            ...
            ECPrivateKeyParameters privKey =
                    new ECPrivateKeyParameters(privateKeysToSignWith.get(0).getPrivKey(), CURVE);
            signer.init(true, privKey);
            BigInteger[] components = signer.generateSignature(sighash.getBytes());
            BtcECKey.ECDSASignature sig2 =
                    new BtcECKey.ECDSASignature(components[0], components[1]).toCanonicalised();
            bridgeSupport.addSignature(
                    findPublicKeySignedBy(
                            federation.getBtcPublicKeys(), privateKeysToSignWith.get(0)),
                    Lists.newArrayList(sig2.encodeToDER()),
                    keccak256.getBytes());
        }
        if (privateKeysToSignWith.size() > 1) {
            ...
            bridgeSupport.addSignature(
                    findPublicKeySignedBy(
                            federation.getBtcPublicKeys(), privateKeysToSignWith.get(1)),
                    derEncodedSigs2,
                    keccak256.getBytes());
        }
        bridgeSupport.save();
    ...
    @Test
    public void releaseBtcWithDustOutput()
            throws BlockStoreException, AddressFormatException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();

        org.ethereum.core.Transaction tx =
    ...
    @Test
    public void releaseBtcFromContract()
            throws BlockStoreException, AddressFormatException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
        ...
        org.ethereum.core.Transaction tx =
                new InternalTransaction(
                        ...
                        new RskAddress(
                                        org.ethereum.crypto.ECKey.fromPrivate(
                                                        new BtcECKey().getPrivKey())
                                                .getAddress())
                                .getBytes(),
    ...
    @Test
    public void registerBtcTransactionOfAlreadyProcessedTransaction()
            throws BlockStoreException, AddressFormatException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
        ...
        bridgeSupport.registerBtcTransaction(
                mock(Transaction.class), tx.bitcoinSerialize(), 0, null);
        bridgeSupport.save();
    ...
    @Test
    public void registerBtcTransactionOfTransactionNotInMerkleTree()
            throws BlockStoreException, AddressFormatException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
        ...
        bridgeSupport.registerBtcTransaction(
                mock(Transaction.class), tx.bitcoinSerialize(), 0, pmt.bitcoinSerialize());
        bridgeSupport.save();
    ...
    @Test
    public void registerBtcTransactionOfTransactionInMerkleTreeWithNegativeHeight()
            throws BlockStoreException, AddressFormatException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
        ...
        bridgeSupport.registerBtcTransaction(
                mock(Transaction.class), tx.bitcoinSerialize(), -1, pmt.bitcoinSerialize());
        bridgeSupport.save();
    ...
    @Test
    public void registerBtcTransactionOfTransactionInMerkleTreeWithNotEnoughtHeight()
            throws BlockStoreException, AddressFormatException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
    ...
    @Test
    public void registerBtcTransactionTxNotLockNorReleaseTx()
            throws BlockStoreException, AddressFormatException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
        ...
        Address address =
                ScriptBuilder.createP2SHOutputScript(
                                2,
                                Lists.newArrayList(new BtcECKey(), new BtcECKey(), new BtcECKey()))
                        .getToAddress(btcParams);
    ...
    @Test
    public void registerBtcTransactionReleaseTx()
            throws BlockStoreException, AddressFormatException, IOException {
        // Federation is the genesis federation ATM
        Federation federation = bridgeConstants.getGenesisFederation();
        Repository repository = createRepository();
        ...
        Sha256Hash sighash =
                tx.hashForSignature(0, redeemScript, BtcTransaction.SigHash.ALL, false);
        // Sign by federator 0
        BtcECKey.ECDSASignature sig0 =
                BridgeRegTestConstants.REGTEST_FEDERATION_PRIVATE_KEYS.get(0).sign(sighash);
        TransactionSignature txSig0 =
                new TransactionSignature(sig0, BtcTransaction.SigHash.ALL, false);
        int sigIndex0 =
                scriptSig.getSigInsertionIndex(sighash, federation.getBtcPublicKeys().get(0));
        scriptSig =
                ScriptBuilder.updateScriptWithSignature(
                        scriptSig, txSig0.encodeToBitcoin(), sigIndex0, 1, 1);
        // Sign by federator 1
        BtcECKey.ECDSASignature sig1 =
                BridgeRegTestConstants.REGTEST_FEDERATION_PRIVATE_KEYS.get(1).sign(sighash);
        TransactionSignature txSig1 =
                new TransactionSignature(sig1, BtcTransaction.SigHash.ALL, false);
        int sigIndex1 =
                scriptSig.getSigInsertionIndex(sighash, federation.getBtcPublicKeys().get(1));
        scriptSig =
                ScriptBuilder.updateScriptWithSignature(
                        scriptSig, txSig1.encodeToBitcoin(), sigIndex1, 1, 1);
        ...
        BridgeSupport bridgeSupport =
                new BridgeSupport(
                        bridgeConstants, provider, null, track, executionBlock, mockFactory, null);
        ...
        bridgeSupport.registerBtcTransaction(
                mock(Transaction.class), tx.bitcoinSerialize(), height, pmt.bitcoinSerialize());
        bridgeSupport.save();

        track.commit();

        Assert.assertEquals(
                LIMIT_MONETARY_BASE, repository.getBalance(PrecompiledContracts.BRIDGE_ADDR));
    ...
    public void registerBtcTransactionMigrationTx()
        ...
        List<BtcECKey> activeFederationKeys =
                Stream.of(
        ...
        List<BtcECKey> retiringFederationKeys =
                Stream.of(
        ...
        TransactionOutput prevOut =
                new TransactionOutput(
                        btcParams, prevTx, Coin.FIFTY_COINS, retiringFederation.getAddress());
        prevTx.addOutput(prevOut);
        // Create tx input
        tx.addInput(prevOut);
        // Create tx input base script sig
        Script scriptSig =
                PegTestUtils.createBaseInputScriptThatSpendsFromTheFederation(retiringFederation);
        // Create sighash
        Script redeemScript =
                ScriptBuilder.createRedeemScript(
                        retiringFederation.getNumberOfSignaturesRequired(),
                        retiringFederation.getBtcPublicKeys());
        Sha256Hash sighash =
                tx.hashForSignature(0, redeemScript, BtcTransaction.SigHash.ALL, false);
        // Sign by federator 0
        ...
        TransactionSignature txSig0 =
                new TransactionSignature(sig0, BtcTransaction.SigHash.ALL, false);
        int sigIndex0 =
                scriptSig.getSigInsertionIndex(
                        sighash, retiringFederation.getBtcPublicKeys().get(0));
        scriptSig =
                ScriptBuilder.updateScriptWithSignature(
                        scriptSig, txSig0.encodeToBitcoin(), sigIndex0, 1, 1);
        // Sign by federator 1
        ...
        int sigIndex1 =
                scriptSig.getSigInsertionIndex(
                        sighash, retiringFederation.getBtcPublicKeys().get(1));
        scriptSig =
                ScriptBuilder.updateScriptWithSignature(
                        scriptSig, txSig1.encodeToBitcoin(), sigIndex1, 1, 1);
        // Set scipt sign to tx input
        ...
        bridgeSupport.registerBtcTransaction(
                mock(Transaction.class), tx.bitcoinSerialize(), 30, pmt.bitcoinSerialize());
        bridgeSupport.save();

        track.commit();

        List<UTXO> activeFederationBtcUTXOs = provider.getNewFederationBtcUTXOs();
        List<Coin> activeFederationBtcCoins =
                activeFederationBtcUTXOs.stream().map(UTXO::getValue).collect(Collectors.toList());
    ...
    public void registerBtcTransactionWithCrossFederationsChange() throws Exception {
        ...
        Address randomAddress =
                new Address(params, Hex.decode("4a22c3c4cbb31e4d03b15550636762bda0baf85a"));
        ...
        BridgeStorageProvider mockBridgeStorageProvider =
                mock(BridgeStorageProvider.class, Mockito.RETURNS_DEEP_STUBS);
        when(mockBridgeStorageProvider
                        .getBtcTxHashesAlreadyProcessed()
                        .keySet()
                        .contains(any(Sha256Hash.class)))
                .thenReturn(false);
        ...
        doReturn(retiringFederationUtxos)
                .when(mockFederationSupport)
                .getRetiringFederationBtcUTXOs();

        BtcBlockStoreWithCache mockBtcBlockStore =
                mock(BtcBlockStoreWithCache.class, Mockito.RETURNS_DEEP_STUBS);
        ...
        TransactionInput retiringFederationInput =
        ...
        PartialMerkleTree partialMerkleTree =
                PartialMerkleTree.buildFromLeaves(
                        params,
                        new byte[] {(byte) 0xff},
                        Collections.singletonList(releaseWithChangeTx.getHash()));

        BtcBlock mockBtcBlock = mock(BtcBlock.class, Mockito.RETURNS_DEEP_STUBS);
        when(mockBtcBlock.getMerkleRoot())
                .thenReturn(partialMerkleTree.getTxnHashAndMerkleRoot(new LinkedList<>()));

        StoredBlock mockStoredBlock = mock(StoredBlock.class);
        when(mockStoredBlock.getHeader()).thenReturn(mockBtcBlock);

        when(mockBtcBlockStore.getStoredBlockAtMainChainHeight(anyInt()))
                .thenReturn(mockStoredBlock);
        BtcBlockStoreWithCache.Factory mockFactory = mock(BtcBlockStoreWithCache.Factory.class);
        ...
        PowerMockito.doReturn(true)
                .when(BridgeUtils.class, "isReleaseTx", any(BtcTransaction.class), anyList());
        ...
        bridgeSupport.registerBtcTransaction(
                mock(Transaction.class),
                releaseWithChangeTx.bitcoinSerialize(),
                1,
                partialMerkleTree.bitcoinSerialize());
        ...
        ArgumentCaptor<BtcTransaction> releasedBtcTxCaptor =
                ArgumentCaptor.forClass(BtcTransaction.class);
        ArgumentCaptor<List<Federation>> fedListCaptor =
        ...
        assertThat(
                fedListCaptor.getValue(),
                IsIterableContainingInOrder.contains(activeFederation, retiringFederation));
    }

    @Test
    public void registerBtcTransactionLockTxWhitelisted() throws Exception {
        List<BtcECKey> federation1Keys =
                Arrays.asList(
                        new BtcECKey[] {
                            BtcECKey.fromPrivate(Hex.decode("fa01")),
                            BtcECKey.fromPrivate(Hex.decode("fa02")),
        ...
        whitelist.put(
                ...
                new OneOffWhiteListEntry(
                        address3, Coin.COIN.multiply(2).add(Coin.COIN.multiply(3))));
        ...
        bridgeSupport.registerBtcTransaction(
                mock(Transaction.class), tx1.bitcoinSerialize(), height, pmt.bitcoinSerialize());
        bridgeSupport.registerBtcTransaction(
                mock(Transaction.class), tx2.bitcoinSerialize(), height, pmt.bitcoinSerialize());
        bridgeSupport.registerBtcTransaction(
                mock(Transaction.class), tx3.bitcoinSerialize(), height, pmt.bitcoinSerialize());
        bridgeSupport.save();
        ...
        co.rsk.core.Coin amountToHaveBeenCreditedToSrc1 =
                co.rsk.core.Coin.fromBitcoin(Coin.valueOf(5, 0));
        co.rsk.core.Coin amountToHaveBeenCreditedToSrc2 =
                co.rsk.core.Coin.fromBitcoin(Coin.valueOf(10, 0));
        co.rsk.core.Coin amountToHaveBeenCreditedToSrc3 =
                co.rsk.core.Coin.fromBitcoin(Coin.valueOf(5, 0));
        co.rsk.core.Coin totalAmountExpectedToHaveBeenLocked =
                amountToHaveBeenCreditedToSrc1
                        .add(amountToHaveBeenCreditedToSrc2)
                        .add(amountToHaveBeenCreditedToSrc3);
        RskAddress srcKey1RskAddress =
                new RskAddress(
                        org.ethereum.crypto.ECKey.fromPrivate(srcKey1.getPrivKey()).getAddress());
        RskAddress srcKey2RskAddress =
                new RskAddress(
                        org.ethereum.crypto.ECKey.fromPrivate(srcKey2.getPrivKey()).getAddress());
        RskAddress srcKey3RskAddress =
                new RskAddress(
                        org.ethereum.crypto.ECKey.fromPrivate(srcKey3.getPrivKey()).getAddress());

        Assert.assertEquals(
                amountToHaveBeenCreditedToSrc1, repository.getBalance(srcKey1RskAddress));
        Assert.assertEquals(
                amountToHaveBeenCreditedToSrc2, repository.getBalance(srcKey2RskAddress));
        Assert.assertEquals(
                amountToHaveBeenCreditedToSrc3, repository.getBalance(srcKey3RskAddress));
        Assert.assertEquals(
                LIMIT_MONETARY_BASE.subtract(totalAmountExpectedToHaveBeenLocked),
                repository.getBalance(PrecompiledContracts.BRIDGE_ADDR));
        ...
        Assert.assertEquals(
                Coin.COIN.multiply(5), provider2.getNewFederationBtcUTXOs().get(0).getValue());
        Assert.assertEquals(
                Coin.COIN.multiply(2), provider2.getNewFederationBtcUTXOs().get(1).getValue());
        Assert.assertEquals(
                Coin.COIN.multiply(10), provider2.getOldFederationBtcUTXOs().get(0).getValue());
        Assert.assertEquals(
                Coin.COIN.multiply(3), provider2.getOldFederationBtcUTXOs().get(1).getValue());
    ...
    @Test
    public void registerBtcTransactionLockTxNotWhitelisted()
            throws BlockStoreException, AddressFormatException, IOException {
        List<BtcECKey> federation1Keys =
                Arrays.asList(
                        new BtcECKey[] {
        ...
        bridgeSupport.registerBtcTransaction(
                rskTx1, tx1.bitcoinSerialize(), height, pmt.bitcoinSerialize());
        bridgeSupport.registerBtcTransaction(
                rskTx2, tx2.bitcoinSerialize(), height, pmt.bitcoinSerialize());
        bridgeSupport.registerBtcTransaction(
                rskTx3, tx3.bitcoinSerialize(), height, pmt.bitcoinSerialize());
        bridgeSupport.save();
        ...
        List<BtcTransaction> releaseTxs =
                provider2.getReleaseTransactionSet().getEntries().stream()
        ...
        Assert.assertThat(
                Coin.COIN.multiply(5).subtract(releaseTx.getOutput(0).getValue()),
                is(lessThanOrEqualTo(Coin.MILLICOIN)));
        Assert.assertEquals(
                srcKey1.toAddress(btcParams),
                releaseTx.getOutput(0).getAddressFromP2PKHScript(btcParams));
        ...
        Assert.assertEquals(1, releaseTx.getOutputs().size());
        Assert.assertThat(
                Coin.COIN.multiply(7).subtract(releaseTx.getOutput(0).getValue()),
                is(lessThanOrEqualTo(Coin.MILLICOIN)));
        Assert.assertEquals(
                srcKey3.toAddress(btcParams),
                releaseTx.getOutput(0).getAddressFromP2PKHScript(btcParams));
        Assert.assertEquals(2, releaseTx.getInputs().size());
        List<TransactionOutPoint> releaseOutpoints =
                releaseTx.getInputs().stream()
                        .map(i -> i.getOutpoint())
                        .sorted(Comparator.comparing(TransactionOutPoint::getIndex))
                        .collect(Collectors.toList());
        ...
        Assert.assertEquals(1, releaseTx.getOutputs().size());
        Assert.assertThat(
                Coin.COIN.multiply(10).subtract(releaseTx.getOutput(0).getValue()),
                is(lessThanOrEqualTo(Coin.MILLICOIN)));
        Assert.assertEquals(
                srcKey2.toAddress(btcParams),
                releaseTx.getOutput(0).getAddressFromP2PKHScript(btcParams));
        Assert.assertEquals(1, releaseTx.getInputs().size());
    ...
    public void isBtcTxHashAlreadyProcessed() throws IOException, BlockStoreException {
        ...
        for (int i = 0; i < 10; i++) {
            Assert.assertTrue(
                    bridgeSupport.isBtcTxHashAlreadyProcessed(
                            Sha256Hash.of(("hash_" + i).getBytes())));
        }
        Assert.assertFalse(
                bridgeSupport.isBtcTxHashAlreadyProcessed(Sha256Hash.of("anything".getBytes())));
    }
    ...
    public void getBtcTxHashProcessedHeight() throws IOException, BlockStoreException {
        ...
        for (int i = 0; i < 10; i++) {
            Assert.assertEquals(
                    (long) i,
                    bridgeSupport
                            .getBtcTxHashProcessedHeight(Sha256Hash.of(("hash_" + i).getBytes()))
                            .longValue());
        }
        Assert.assertEquals(
                -1L,
                bridgeSupport
                        .getBtcTxHashProcessedHeight(Sha256Hash.of("anything".getBytes()))
                        .longValue());
    }
    ...
    public void getFederationMethods_genesis() throws IOException {
        ...
        Federation genesisFederation =
                new Federation(
                        ...
                        NetworkParameters.fromID(NetworkParameters.ID_REGTEST));
        BridgeSupport bridgeSupport =
                getBridgeSupportWithMocksForFederationTests(
                        true, activeFederation, genesisFederation, null, null, null, null);
        ...
        Assert.assertEquals(
                genesisFederation.getAddress().toString(),
                bridgeSupport.getFederationAddress().toString());
        List<FederationMember> members = FederationTestUtils.getFederationMembers(6);
        for (int i = 0; i < 6; i++) {
            Assert.assertTrue(
                    Arrays.equals(
                            members.get(i).getBtcPublicKey().getPubKey(),
                            bridgeSupport.getFederatorPublicKey(i)));
            Assert.assertTrue(
                    Arrays.equals(
                            members.get(i).getBtcPublicKey().getPubKey(),
                            bridgeSupport.getFederatorPublicKeyOfType(
                                    i, FederationMember.KeyType.BTC)));
            Assert.assertTrue(
                    Arrays.equals(
                            members.get(i).getRskPublicKey().getPubKey(true),
                            bridgeSupport.getFederatorPublicKeyOfType(
                                    i, FederationMember.KeyType.RSK)));
            Assert.assertTrue(
                    Arrays.equals(
                            members.get(i).getMstPublicKey().getPubKey(true),
                            bridgeSupport.getFederatorPublicKeyOfType(
                                    i, FederationMember.KeyType.MST)));
        }
    }
    ...
    public void getFederationMethods_active() throws IOException {
        ...
        BridgeSupport bridgeSupport =
                getBridgeSupportWithMocksForFederationTests(
                        false, activeFederation, genesisFederation, null, null, null, null);
        ...
        Assert.assertEquals(
                activeFederation.getAddress().toString(),
                bridgeSupport.getFederationAddress().toString());
    ...
    public void getFederationMethods_newActivated() throws IOException {
        ...
        BridgeSupport bridgeSupport =
                getBridgeSupportWithMocksForFederationTests(
                        false, newFederation, null, oldFederation, null, null, mockedBlock);

        Assert.assertEquals(3, bridgeSupport.getFederationSize().intValue());
        Assert.assertEquals(2, bridgeSupport.getFederationThreshold().intValue());
        Assert.assertEquals(
                newFederation.getAddress().toString(),
                bridgeSupport.getFederationAddress().toString());
        List<FederationMember> members = FederationTestUtils.getFederationMembers(3);
        for (int i = 0; i < 3; i++) {
            Assert.assertTrue(
    ...
    public void getFederationMethods_newNotActivated() throws IOException {
        ...
        Assert.assertEquals(4, bridgeSupport.getFederationThreshold().intValue());
        Assert.assertEquals(
                oldFederation.getAddress().toString(),
                bridgeSupport.getFederationAddress().toString());
        List<FederationMember> members = FederationTestUtils.getFederationMembers(6);
        for (int i = 0; i < 6; i++) {
            Assert.assertTrue(
    ...
    public void getRetiringFederationMethods_none() throws IOException {
        ...
        Assert.assertNull(
                bridgeSupport.getRetiringFederatorPublicKeyOfType(0, FederationMember.KeyType.BTC));
        Assert.assertNull(
                bridgeSupport.getRetiringFederatorPublicKeyOfType(0, FederationMember.KeyType.RSK));
        Assert.assertNull(
                bridgeSupport.getRetiringFederatorPublicKeyOfType(0, FederationMember.KeyType.MST));
    }
    ...
    public void getRetiringFederationMethods_presentNewActive() throws IOException {
        ...
        Assert.assertEquals(
                mockedOldFederation.getAddress().toString(),
                bridgeSupport.getRetiringFederationAddress().toString());
        List<FederationMember> members = FederationTestUtils.getFederationMembers(4);
        for (int i = 0; i < 4; i++) {
            Assert.assertTrue(
                    Arrays.equals(
                            members.get(i).getBtcPublicKey().getPubKey(),
                            bridgeSupport.getRetiringFederatorPublicKey(i)));
            Assert.assertTrue(
                    Arrays.equals(
                            members.get(i).getBtcPublicKey().getPubKey(),
                            bridgeSupport.getRetiringFederatorPublicKeyOfType(
                                    i, FederationMember.KeyType.BTC)));
            Assert.assertTrue(
                    Arrays.equals(
                            members.get(i).getRskPublicKey().getPubKey(true),
    ...
    public void getPendingFederationMethods_none() throws IOException {
        ...
        Assert.assertNull(
                bridgeSupport.getPendingFederatorPublicKeyOfType(0, FederationMember.KeyType.BTC));
        Assert.assertNull(
                bridgeSupport.getPendingFederatorPublicKeyOfType(0, FederationMember.KeyType.RSK));
        Assert.assertNull(
                bridgeSupport.getPendingFederatorPublicKeyOfType(0, FederationMember.KeyType.MST));
    }

    @Test
    public void getPendingFederationMethods_present() throws IOException {
        PendingFederation mockedPendingFederation =
                new PendingFederation(FederationTestUtils.getFederationMembers(5));
        BridgeSupport bridgeSupport =
                getBridgeSupportWithMocksForFederationTests(
                        false, null, null, null, mockedPendingFederation, null, null);
        ...
        for (int i = 0; i < 5; i++) {
            Assert.assertTrue(
                    Arrays.equals(
                            members.get(i).getBtcPublicKey().getPubKey(),
                            bridgeSupport.getPendingFederatorPublicKey(i)));
            Assert.assertTrue(
                    Arrays.equals(
                            members.get(i).getBtcPublicKey().getPubKey(),
                            bridgeSupport.getPendingFederatorPublicKeyOfType(
                                    i, FederationMember.KeyType.BTC)));
            Assert.assertTrue(
                    Arrays.equals(
                            members.get(i).getRskPublicKey().getPubKey(true),
    ...
    public void voteFederationChange_methodNotAllowed() throws IOException {
        ...
        Assert.assertEquals(
                BridgeSupport.FEDERATION_CHANGE_GENERIC_ERROR_CODE,
    ...
    public void voteFederationChange_notAuthorized() throws IOException {
        ...
        when(mockedTx.getSender())
                .thenReturn(
                        new RskAddress(ECKey.fromPrivate(BigInteger.valueOf(12L)).getAddress()));
        Assert.assertEquals(
                BridgeSupport.FEDERATION_CHANGE_GENERIC_ERROR_CODE,
        ...
        public VotingMocksProvider(String function, byte[][] arguments, boolean mockVoteResult) {
            byte[] voterBytes =
                    ECKey.fromPublicOnly(
                                    Hex.decode(
                                            // Public key hex of an authorized voter in regtest,
                                            // taken from BridgeRegTestConstants
            ...
            if (mockVoteResult) when(election.vote(spec, voter)).thenReturn(true);
    ...
    public void createFederation_ok() throws IOException {
        VotingMocksProvider mocksProvider =
                new VotingMocksProvider("create", new byte[][] {}, true);

        BridgeSupport bridgeSupport =
                getBridgeSupportWithMocksForFederationTests(
                        false, null, null, null, null, mocksProvider.getElection(), null);
    ...
    public void createFederation_pendingExists() throws IOException {
        VotingMocksProvider mocksProvider =
                new VotingMocksProvider("create", new byte[][] {}, false);
        ...
        verify(mocksProvider.getElection(), never()).clearWinners();
        verify(mocksProvider.getElection(), never()).clear();
        verify(mocksProvider.getElection(), never())
                .vote(mocksProvider.getSpec(), mocksProvider.getVoter());
    }
    ...
    public void createFederation_withPendingActivation() throws IOException {
        ...
        BridgeSupport bridgeSupport =
                getBridgeSupportWithMocksForFederationTests(
                        ...
                        mocksProvider.getElection(),
                        mockedBlock);
        ((BridgeStorageProvider) Whitebox.getInternalState(bridgeSupport, "provider"))
                .getOldFederationBtcUTXOs()
                .add(mock(UTXO.class));
    ...
    public void addFederatorPublicKey_okNoKeys() throws IOException {
        VotingMocksProvider mocksProvider =
                new VotingMocksProvider(
                        "add",
                        new byte[][] {
                            Hex.decode(
                                    "031da807c71c2f303b7f409dd2605b297ac494a563be3b9ca5f52d95a43d183cc5")
                        },
                        true);
        ...
        Assert.assertTrue(
                Arrays.equals(
                        Hex.decode(
                                "031da807c71c2f303b7f409dd2605b297ac494a563be3b9ca5f52d95a43d183cc5"),
                        bridgeSupport.getPendingFederatorPublicKey(0)));
        Assert.assertTrue(
                Arrays.equals(
                        Hex.decode(
                                "031da807c71c2f303b7f409dd2605b297ac494a563be3b9ca5f52d95a43d183cc5"),
                        bridgeSupport.getPendingFederatorPublicKeyOfType(
                                0, FederationMember.KeyType.BTC)));
        Assert.assertTrue(
                Arrays.equals(
                        Hex.decode(
                                "031da807c71c2f303b7f409dd2605b297ac494a563be3b9ca5f52d95a43d183cc5"),
                        bridgeSupport.getPendingFederatorPublicKeyOfType(
                                0, FederationMember.KeyType.RSK)));
        Assert.assertTrue(
                Arrays.equals(
                        Hex.decode(
                                "031da807c71c2f303b7f409dd2605b297ac494a563be3b9ca5f52d95a43d183cc5"),
                        bridgeSupport.getPendingFederatorPublicKeyOfType(
                                0, FederationMember.KeyType.MST)));
        verify(mocksProvider.getElection(), times(1)).clearWinners();
        verify(mocksProvider.getElection(), never()).clear();
    }
    ...
    public void addFederatorPublicKey_okKeys() throws IOException {
        VotingMocksProvider mocksProvider =
                new VotingMocksProvider(
                        ...
                        new byte[][] {
                            Hex.decode(
                                    "036bb9eab797eadc8b697f0e82a01d01cabbfaaca37e5bafc06fdc6fdd38af894a")
                        },
                        true);

        PendingFederation pendingFederation =
                new PendingFederation(
        ...
        Assert.assertTrue(
                Arrays.equals(
                        Hex.decode(
                                "036bb9eab797eadc8b697f0e82a01d01cabbfaaca37e5bafc06fdc6fdd38af894a"),
                        bridgeSupport.getPendingFederatorPublicKey(1)));
        Assert.assertTrue(
                Arrays.equals(
                        Hex.decode(
                                "036bb9eab797eadc8b697f0e82a01d01cabbfaaca37e5bafc06fdc6fdd38af894a"),
                        bridgeSupport.getPendingFederatorPublicKeyOfType(
                                1, FederationMember.KeyType.BTC)));
        Assert.assertTrue(
                Arrays.equals(
                        Hex.decode(
                                "036bb9eab797eadc8b697f0e82a01d01cabbfaaca37e5bafc06fdc6fdd38af894a"),
                        bridgeSupport.getPendingFederatorPublicKeyOfType(
                                1, FederationMember.KeyType.RSK)));
        Assert.assertTrue(
                Arrays.equals(
                        Hex.decode(
                                "036bb9eab797eadc8b697f0e82a01d01cabbfaaca37e5bafc06fdc6fdd38af894a"),
                        bridgeSupport.getPendingFederatorPublicKeyOfType(
                                1, FederationMember.KeyType.MST)));
    ...
    public void addFederatorPublicKey_invalidKey() throws IOException {
        VotingMocksProvider mocksProvider =
                new VotingMocksProvider("add", new byte[][] {Hex.decode("aabbccdd")}, false);
        ...
        Assert.assertNull(bridgeSupport.getPendingFederationHash());
        Assert.assertEquals(
                BridgeSupport.FEDERATION_CHANGE_GENERIC_ERROR_CODE.intValue(),
                mocksProvider.execute(bridgeSupport));
        Assert.assertNull(bridgeSupport.getPendingFederationHash());
        verify(mocksProvider.getElection(), never()).clearWinners();
        verify(mocksProvider.getElection(), never()).clear();
        verify(mocksProvider.getElection(), never())
                ...
                new VotingMocksProvider(
                        ...
                        new byte[][] {
                            Hex.decode(
                                    "031da807c71c2f303b7f409dd2605b297ac494a563be3b9ca5f52d95a43d183cc5"),
                            Hex.decode(
                                    "026289413837ab836eb76428406a3b4f200418d31d99c259a0532b8e435f35153b"),
                            Hex.decode(
                                    "03e12efa1146037bc9325574b0f15749ba6dc0eec360b1670b05029eead511a6ff")
                        },
                        true);
                ...
                new VotingMocksProvider(
                        ...
                        new byte[][] {
                            Hex.decode(
                                    "036bb9eab797eadc8b697f0e82a01d01cabbfaaca37e5bafc06fdc6fdd38af894a"),
                            Hex.decode(
                                    "03f64d2c022bca70f3ff0b1e95336be2c1507daa2ad37a484e0b66cbda86cfc6c5"),
                            Hex.decode(
                                    "03eed62698319f754407a31fde9a51da8b2be0ab40e9c4c695bb057757729be37f")
                        },
                        true);
                ...
                new PendingFederation(
                        Arrays.asList(
                                new FederationMember(
                                        BtcECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "02ebd9e8b2caff48b10e661e69fe107d6986d2df1ce7e377f2ef927f3194a61b99")),
                                        ECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "02a23343f50363dc9a4c29f0c0a8386780cc8bf469211f4de51d50f8c0f274e9a7")),
                                        ECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "030dd584c286275ab2ce249096d0d7e6c78853e0902db061b14f2e39df068f95bc")))));
        BridgeSupport bridgeSupport =
                getBridgeSupportWithMocksForFederationTests(
                        false,
                        null,
                ...
                new VotingMocksProvider(
                        ...
                        new byte[][] {
                            Hex.decode(
                                    "036bb9eab797eadc8b697f0e82a01d01cabbfaaca37e5bafc06fdc6fdd38af894a"),
                            Hex.decode(
                                    "0259323a848372c51673622b29298b6e5854b28d45de297fe7cff67915ad900a59"),
                            Hex.decode(
                                    "0304d9178db5e243667824188f86f7507104d0e237838bfb22bb4af592a8bca08a")
                        },
                        false);
                ...
                new VotingMocksProvider(
                        ...
                        new byte[][] {
                            Hex.decode(
                                    "031da807c71c2f303b7f409dd2605b297ac494a563be3b9ca5f52d95a43d183cc5"),
                            Hex.decode(
                                    "02cf0dec68ca34502e4ebd35c40a0e66ff47ba520f0418bcd7388717b12ab4b053"),
                            Hex.decode(
                                    "031da807c71c2f303b7f409dd2605b297ac494a563be3b9ca5f52d95a43d183cc5")
                        },
                        false);
                ...
                new PendingFederation(
                        Arrays.asList(
                                new FederationMember(
                                        ...
                                        ECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "03981d06bd7bc419612aa09f860188f08d3c3010796dcb41cdfc43a6875600efa8")),
                                        ECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "0365e45f68d6347aaa03c76f3d6f47000df6090801e49eef6d49f547f5c19de5dd")))));
        BridgeSupport bridgeSupport =
                getBridgeSupportWithMocksForFederationTests(
                        false,
                        null,
                ...
                new PendingFederation(
                        Arrays.asList(
                                new FederationMember(
                                        BtcECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "0290d68bf50a8389e541a19d47c51447b443f41a13049e0783db6a25c419d612db")),
                                        ECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "02cf0dec68ca34502e4ebd35c40a0e66ff47ba520f0418bcd7388717b12ab4b053")),
                                        ECKey.fromPublicOnly(
                ...
                new PendingFederation(
                        Arrays.asList(
                                new FederationMember(
                                        ...
                                        ECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "033174d2fb7a3d7a0c87d43fa3e9ba43d4962014960b82bcd793706c05f68111c8")),
                                        ECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "031da807c71c2f303b7f409dd2605b297ac494a563be3b9ca5f52d95a43d183cc5")))));
        BridgeSupport bridgeSupport =
        ...
        VotingMocksProvider mocksProvider =
                new VotingMocksProvider(
                        ...
                        new byte[][] {
                            Hex.decode("aabbccdd"),
                            Hex.decode(
                                    "0245db19d3d4b8c3567a47189ae60588e18e1305f3473a7fe99b6ef559bb1d1dc6"),
                            Hex.decode(
                                    "029664581b2e8dc9ba7885696a03134aaebe4be834ce0049d62f80499bbe130206")
                        },
                        false);
    ...
    public void rollbackFederation_ok() throws IOException {
        VotingMocksProvider mocksProvider =
                new VotingMocksProvider("rollback", new byte[][] {}, true);
    ...
    public void commitFederation_ok() throws IOException {
                ...
                new PendingFederation(
                        FederationTestUtils.getFederationMembersWithKeys(
                                Arrays.asList(
                                        ...
                                        BtcECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "025eefeeeed5cdc40822880c7db1d0a88b7b986945ed3fc05a0b45fe166fe85e12")),
                                        BtcECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "03c67ad63527012fd4776ae892b5dc8c56f80f1be002dc65cd520a2efb64e37b49")))));

        VotingMocksProvider mocksProvider =
                new VotingMocksProvider(
                        "commit", new byte[][] {pendingFederation.getHash().getBytes()}, true);
                ...
                new Federation(
                        FederationTestUtils.getFederationMembersWithKeys(
                                Arrays.asList(
                                        BtcECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "0346cb6b905e4dee49a862eeb2288217d06afcd4ace4b5ca77ebedfbc6afc1c19d")),
                                        BtcECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "0269a0dbe7b8f84d1b399103c466fb20531a56b1ad3a7b44fe419e74aad8c46db7")),
                                        BtcECKey.fromPublicOnly(
                                                Hex.decode(
                                                        "026192d8ab41bd402eb0431457f6756a3f3ce15c955c534d2b87f1e0372d8ba338")))),
        ...
        for (int i = 0; i < 5; i++) {
            ...
            Assert.assertEquals(
                    Coin.valueOf((i + 1) * 1000),
                    provider.getOldFederationBtcUTXOs().get(i).getValue());
        }
        verify(mocksProvider.getElection(), times(1)).clearWinners();
        verify(mocksProvider.getElection(), times(1)).clear();

        // Check logs are made
        verify(eventLoggerMock, times(1))
                .logCommitFederation(executionBlock, newFederation, expectedFederation);
    }
    ...
    public void getActiveFederationWallet() throws IOException {
        ...
        BridgeSupport bridgeSupport =
                getBridgeSupportWithMocksForFederationTests(
                        false, expectedFederation, null, null, null, null, null);
        ...
        PowerMockito.mockStatic(BridgeUtils.class);
        PowerMockito.when(BridgeUtils.getFederationSpendWallet(any(), any(), any()))
                .then(
                        (InvocationOnMock m) -> {
    ...
    public void getLockWhitelistMethods() throws IOException {
        ...
        List<LockWhitelistEntry> entries =
                Arrays.stream(new Integer[] {2, 3, 4, 5})
                        .map(
                                i ->
                                        new UnlimitedWhiteListEntry(
                                                new Address(
                                                        parameters,
                                                        BtcECKey.fromPrivate(BigInteger.valueOf(i))
                                                                .getPubKeyHash())))
                        .collect(Collectors.toList());
        ...
        Assert.assertNull(
                bridgeSupport.getLockWhitelistEntryByAddress(
                        new Address(
                                        parameters,
                                        BtcECKey.fromPrivate(BigInteger.valueOf(-1))
                                                .getPubKeyHash())
                                .toBase58()));
        for (int i = 0; i < 4; i++) {
            ...
            Assert.assertEquals(
                    entries.get(i),
                    bridgeSupport.getLockWhitelistEntryByAddress(
                            entries.get(i).address().toBase58()));
        }
    }
    ...
    public void addLockWhitelistAddress_ok() throws IOException {
        ...
        byte[] senderBytes =
                ECKey.fromPublicOnly(
                                Hex.decode(
                                        // Public key hex of the authorized whitelist admin in
                                        // regtest, taken from BridgeRegTestConstants
        ...
        when(mockedWhitelist.put(any(Address.class), any(OneOffWhiteListEntry.class)))
                .then(
                        (InvocationOnMock m) -> {
                            Address address = m.<Address>getArgument(0);
                            Assert.assertEquals(
                                    "mwKcYS3H8FUgrPtyGMv3xWvf4jgeZUkCYN", address.toBase58());
                            return true;
                        });
    ...
    public void addLockWhitelistAddress_notAuthorized() throws IOException {
        ...
        Assert.assertEquals(
                BridgeSupport.LOCK_WHITELIST_GENERIC_ERROR_CODE.intValue(),
                bridgeSupport
                        .addOneOffLockWhitelistAddress(
                                mockedTx,
                                "mwKcYS3H8FUgrPtyGMv3xWvf4jgeZUkCYN",
    ...
    public void addLockWhitelistAddress_invalidAddress() throws IOException {
        ...
        Assert.assertEquals(
                ...
                bridgeSupport
                        .addOneOffLockWhitelistAddress(
                                mockedTx, "i-am-invalid", BigInteger.valueOf(Coin.COIN.getValue()))
                        .intValue());
        verify(mockedWhitelist, never()).put(any(), any());
    }
    ...
    public void setLockWhitelistDisableBlockDelay_ok() throws IOException, BlockStoreException {
        ...
        BridgeSupport bridgeSupport =
                getBridgeSupportWithMocksAndBtcBlockstoreForWhitelistTests(
                        mockedWhitelist, btcBlockStore);
        ...
        Assert.assertEquals(
                ...
                bridgeSupport
                        ...
                        .intValue());
        verify(mockedWhitelist, times(1))
                .setDisableBlockHeight(disableBlockDelayBI.intValue() + bestChainHeight);
    }

    @Test
    public void setLockWhitelistDisableBlockDelay_negativeDisableBlockBI()
            throws IOException, BlockStoreException {
        Transaction mockedTx = mock(Transaction.class);
        byte[] senderBytes =
                ECKey.fromPublicOnly(
    ...
    public void setLockWhitelistDisableBlockDelay_disableBlockDelayBIBiggerThanInt()
            throws IOException, BlockStoreException {
        Transaction mockedTx = mock(Transaction.class);
        byte[] senderBytes =
                ECKey.fromPublicOnly(
    ...
    @Test
    public void setLockWhitelistDisableBlockDelay_overflow()
            throws IOException, BlockStoreException {
        Transaction mockedTx = mock(Transaction.class);
        byte[] senderBytes =
                ECKey.fromPublicOnly(
    ...
    @Test
    public void setLockWhitelistDisableBlockDelay_maxIntValueDisableBlockBI()
            throws IOException, BlockStoreException {
        Transaction mockedTx = mock(Transaction.class);
        byte[] senderBytes =
                ECKey.fromPublicOnly(
    ...
    @Test
    public void setLockWhitelistDisableBlockDelay_disabled()
            throws IOException, BlockStoreException {
        Transaction mockedTx = mock(Transaction.class);
        byte[] senderBytes =
                ECKey.fromPublicOnly(
    ...
    @Test
    public void setLockWhitelistDisableBlockDelay_notAuthorized()
            throws IOException, BlockStoreException {
        Transaction mockedTx = mock(Transaction.class);
        byte[] senderBytes = Hex.decode("0000000000000000000000000000000000aabbcc");
        RskAddress sender = new RskAddress(senderBytes);
    ...
    public void removeLockWhitelistAddress_ok() throws IOException {
        ...
        when(mockedWhitelist.remove(any(Address.class)))
                .then(
                        (InvocationOnMock m) -> {
                            Address address = m.<Address>getArgument(0);
                            Assert.assertEquals(
        ...
        Assert.assertEquals(
                1,
                bridgeSupport
                        .removeLockWhitelistAddress(mockedTx, "mwKcYS3H8FUgrPtyGMv3xWvf4jgeZUkCYN")
                        .intValue());
    }
    ...
    public void removeLockWhitelistAddress_invalidAddress() throws IOException {
        ...
        Assert.assertEquals(
                -2, bridgeSupport.removeLockWhitelistAddress(mockedTx, "i-am-invalid").intValue());
        verify(mockedWhitelist, never()).remove(any());
    }
    ...
    public void voteFeePerKbChange_nullFeeThrows() {
        ...
        BridgeSupport bridgeSupport =
                new BridgeSupport(constants, provider, null, repositoryMock, null, null, null);
    ...
    public void voteFeePerKbChange_unsuccessfulVote() {
        ...
        BridgeSupport bridgeSupport =
                new BridgeSupport(
                        bridgeConstants, provider, null, repositoryMock, null, null, null);
    ...
    public void getBtcTransactionConfirmations_ok() throws BlockStoreException, IOException {
        ...
        int confirmations =
                bridgeSupport.getBtcTransactionConfirmations(
                        btcTransactionHash, blockHash, merkleBranch);

        Assert.assertEquals(132 - 50 + 1, confirmations);
    }

    @Test
    public void getBtcTransactionConfirmations_inexistentBlockHash()
        ...
        int confirmations =
                bridgeSupport.getBtcTransactionConfirmations(btcTransactionHash, blockHash, null);

        Assert.assertEquals(
                BridgeSupport.BTC_TRANSACTION_CONFIRMATION_INEXISTENT_BLOCK_HASH_ERROR_CODE
                        .intValue(),
                confirmations);
    }

    @Test
    public void getBtcTransactionConfirmations_blockNotInBestChain()
            throws BlockStoreException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
        ...
        Assert.assertEquals(
                BridgeSupport.BTC_TRANSACTION_CONFIRMATION_BLOCK_NOT_IN_BEST_CHAIN_ERROR_CODE
                        .intValue(),
                confirmations);
    }

    @Test
    public void getBtcTransactionConfirmations_blockNotInBestChainBlockWithHeightNotFound()
            throws BlockStoreException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
    ...
    @Test
    public void getBtcTransactionConfirmations_blockTooOld()
            throws BlockStoreException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
        ...
        StoredBlock chainHead =
                new StoredBlock(blockHeader, new BigInteger("0"), BLOCK_HEIGHT + 4320 + 1);
        when(btcBlockStore.getChainHead()).thenReturn(chainHead);
        ...
        Assert.assertEquals(
                BridgeSupport.BTC_TRANSACTION_CONFIRMATION_BLOCK_TOO_OLD_ERROR_CODE.intValue(),
                confirmations);
    }

    @Test
    public void getBtcTransactionConfirmations_heightInconsistency()
            throws BlockStoreException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
        ...
        when(btcBlockStore.getStoredBlockAtMainChainHeight(block.getHeight()))
                .thenThrow(new BlockStoreException("blah"));
        ;
        ...
        Assert.assertEquals(
                BridgeSupport.BTC_TRANSACTION_CONFIRMATION_INCONSISTENT_BLOCK_ERROR_CODE.intValue(),
                confirmations);
    }

    @Test
    public void getBtcTransactionConfirmations_merkleBranchDoesNotProve()
            throws BlockStoreException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
        ...
        Assert.assertEquals(
                BridgeSupport.BTC_TRANSACTION_CONFIRMATION_INVALID_MERKLE_BRANCH_ERROR_CODE
                        .intValue(),
                confirmations);
    }
    ...
    @Test
    public void getBtcTransactionConfirmationsGetCost_blockDoesNotExist()
            throws BlockStoreException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
    ...
    @Test
    public void getBtcTransactionConfirmationsGetCost_getBestChainHeightError()
            throws BlockStoreException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
    ...
    @Test
    public void getBtcTransactionConfirmationsGetCost_blockTooDeep()
            throws BlockStoreException, IOException {
        Repository repository = createRepository();
        Repository track = repository.startTracking();
    ...
    public void getBtcBlockchainBlockHashAtDepth() throws Exception {
        ...
        BtcBlockStoreWithCache.Factory btcBlockStoreFactory =
                new RepositoryBtcBlockStoreWithCache.Factory(bridgeConstants.getBtcParams());
        BtcBlockStoreWithCache btcBlockStore = btcBlockStoreFactory.newInstance(track);
        BtcBlockStoreWithCache.Factory mockFactory =
                mock(RepositoryBtcBlockStoreWithCache.Factory.class);
        when(mockFactory.newInstance(track)).thenReturn(btcBlockStore);
        ...
        Assert.assertEquals(
                btcParams.getGenesisBlock().getHash(),
                bridgeSupport.getBtcBlockchainBlockHashAtDepth(0));
        try {
        ...
        Assert.assertEquals(
                btcParams.getGenesisBlock().getHash(),
                bridgeSupport.getBtcBlockchainBlockHashAtDepth(10));
        try {
            bridgeSupport.getBtcBlockchainBlockHashAtDepth(-1);
            Assert.fail();
        } catch (IndexOutOfBoundsException e) {
        ...
        for (int i = 0; i < 10; i++) {
            Assert.assertEquals(
                    blocks.get(i).getHash(), bridgeSupport.getBtcBlockchainBlockHashAtDepth(9 - i));
        }
    }

    private BridgeStorageProvider getBridgeStorageProviderMockWithProcessedHashes()
            throws IOException {
    ...
    private BridgeSupport getBridgeSupportWithMocksForFederationTests(
        ...
        when(constantsMock.getBtcParams())
                .thenReturn(NetworkParameters.fromID(NetworkParameters.ID_REGTEST));
        when(constantsMock.getFederationChangeAuthorizer())
                .thenReturn(BridgeRegTestConstants.getInstance().getFederationChangeAuthorizer());
        when(constantsMock.getFederationActivationAge())
                .thenReturn(BridgeRegTestConstants.getInstance().getFederationActivationAge());
        ...
        when(providerMock.getOldFederationBtcUTXOs())
                .then((InvocationOnMock m) -> holder.retiringUTXOs);
        when(providerMock.getNewFederationBtcUTXOs())
                .then((InvocationOnMock m) -> holder.activeUTXOs);

        holder.setActiveFederation(genesis ? null : mockedNewFederation);
        holder.setRetiringFederation(mockedOldFederation);
        when(providerMock.getNewFederation())
                .then((InvocationOnMock m) -> holder.getActiveFederation());
        when(providerMock.getOldFederation())
                .then((InvocationOnMock m) -> holder.getRetiringFederation());
        when(providerMock.getPendingFederation())
                .then((InvocationOnMock m) -> holder.getPendingFederation());
        when(providerMock.getFederationElection(any()))
                .then(
                        (InvocationOnMock m) -> {
                            ...
                            if (holder.getFederationElection() == null) {
                                AddressBasedAuthorizer auth =
                                        m.<AddressBasedAuthorizer>getArgument(0);
        ...
        Mockito.doAnswer(
                ...
                .when(providerMock)
                .setPendingFederation(any());

        return new BridgeSupport(
                constantsMock, providerMock, eventLogger, null, executionBlock, null, null);
    }

    private BridgeSupport getBridgeSupportWithMocksAndBtcBlockstoreForWhitelistTests(
            LockWhitelist mockedWhitelist, BtcBlockStoreWithCache btcBlockStore)
            throws IOException {
        BridgeConstants constantsMock = mock(BridgeConstants.class);
        when(constantsMock.getBtcParams())
                .thenReturn(NetworkParameters.fromID(NetworkParameters.ID_REGTEST));
        when(constantsMock.getLockWhitelistChangeAuthorizer())
                .thenReturn(
                        BridgeRegTestConstants.getInstance().getLockWhitelistChangeAuthorizer());
    ...
    private void mockChainOfStoredBlocks(
            BtcBlockStoreWithCache btcBlockStore,
            BtcBlock targetHeader,
            int headHeight,
            int targetHeight)
        ...
        when(btcBlockStore.getStoredBlockAtMainChainHeight(targetHeight))
                .thenReturn(new StoredBlock(targetHeader, BigInteger.ONE, targetHeight));
