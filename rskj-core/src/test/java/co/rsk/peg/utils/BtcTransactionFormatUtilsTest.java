...
public class BtcTransactionFormatUtilsTest {
    ...
    public void calculateBtcTxHash() {
        BtcTransaction btcTransaction =
                new BtcTransaction(NetworkParameters.fromID(NetworkParameters.ID_REGTEST));
        Assert.assertThat(
                BtcTransactionFormatUtils.calculateBtcTxHash(btcTransaction.bitcoinSerialize()),
                is(btcTransaction.getHash()));

        byte[] rawBtcTransaction =
                Hex.decode(
                        "020000000418bc858998739dbb7e7676435178dba5e71157b1537d415518d5c1fce6349018000000006a47304402204317903e40f8736858f87758e6"
                                ...
                                + "1288acdfdc0700");
        Assert.assertThat(
                BtcTransactionFormatUtils.calculateBtcTxHash(rawBtcTransaction),
                is(
                        Sha256Hash.wrap(
                                "4d63ac307e0daba3597a0d8075facb4e6cba3908a60920259b7447e28a151576")));
    }
    ...
    public void getInputsCount() {
        BtcTransaction btcTransaction =
                new BtcTransaction(NetworkParameters.fromID(NetworkParameters.ID_REGTEST));
        Assert.assertThat(
                BtcTransactionFormatUtils.getInputsCount(btcTransaction.bitcoinSerialize()),
                is(0L));
