...
public class BridgeEventLoggerImplTest {
    ...
    public void logCommitFederation() {
        ...
        List<BtcECKey> oldFederationKeys =
                Arrays.asList(
        ...
        List<FederationMember> oldFederationMembers =
                FederationTestUtils.getFederationMembersWithBtcKeys(oldFederationKeys);
        ...
        List<BtcECKey> newFederationKeys =
                Arrays.asList(
                        BtcECKey.fromPublicOnly(
                                Hex.decode(
        ...
        Assert.assertArrayEquals(
                oldFederation.getAddress().getHash160(), oldFedData.get(0).getRLPData());
        ...
        Assert.assertArrayEquals(
                newFederation.getAddress().getHash160(), newFedData.get(0).getRLPData());
        ...
        Assert.assertEquals(
                15L + BridgeRegTestConstants.getInstance().getFederationActivationAge(),
                Long.valueOf(new String(dataList.get(2).getRLPData(), StandardCharsets.UTF_8))
                        .longValue());
    }
}
