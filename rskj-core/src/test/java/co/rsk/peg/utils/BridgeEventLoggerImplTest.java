...
class BridgeEventLoggerImplTest {
    ...
    private static Stream<Arguments> logUnionRbtcReleasedArgProvider() {
        ...
        co.rsk.core.Coin oneEther = new co.rsk.core.Coin(weiPerEther);
        co.rsk.core.Coin twoEther = new co.rsk.core.Coin(weiPerEther.multiply(BigInteger.valueOf(2L)));
        co.rsk.core.Coin threeEther = new co.rsk.core.Coin(weiPerEther.multiply(BigInteger.valueOf(3L)));
    ...
    private static Stream<Arguments> logUnionRbtcReleasedInvalidArgProvider() {
        ...
        return Stream.of(
            ...
            Arguments.of(null, new co.rsk.core.Coin(weiPerEther)),
