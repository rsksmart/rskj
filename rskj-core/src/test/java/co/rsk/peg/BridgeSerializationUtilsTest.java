...
public class BridgeSerializationUtilsTest {
    ...
    @Test
    public void deserializeKeccak256() {
    ...
    @Test
    public void deserializeKeccak256_nullValue() {
        test_deserializeKeccak256(null, null, false);
    }

    @Test
    public void deserializeKeccak256_zeroHash() {
    ...
    private void test_serializeKeccak256(Keccak256 keccakHash, byte[] expectedSerializedKeccak256Hash) {
        ...
        Assert.assertArrayEquals(expectedSerializedKeccak256Hash, result);
    }
    ...
    @Test
    public void serializeKeccak256_zeroHash() {
    ...
    @Test
    public void serializeKeccak256_nullValue() {
    ...
    @Test
    public void serializeSha256Hash_zeroHash() {
        test_serializeSha256Hash(
