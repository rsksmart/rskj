...
class PegUtilsLegacyTest {
    ...
    private FederationConstants federationConstantsRegtest;
    ...
    void setupConfig() {
        ...
        federationConstantsRegtest = bridgeConstantsRegtest.getFederationConstants();
    ...
    void testIsValidPegInTx() {
        ...
        tx2.addInput(txIn);
        signWithNecessaryKeys(genesisFederation, REGTEST_FEDERATION_PRIVATE_KEYS, txIn, tx2);
    ...
    void testIsValidPegInTx_spending_from_federation_is_pegout_after_iris() {
        ...
        tx.addInput(txIn);
        signWithNecessaryKeys(genesisFederation, REGTEST_FEDERATION_PRIVATE_KEYS, txIn, tx);
    ...
    void testIsValidPegInTx_hasChangeUtxoFromFlyoverErpFederation_afterRskip201_notPegin() {
        ...
        ErpFederation activeErpFederation = FederationTestUtils.getErpFederation(mainnetBtcParams);
        ...
        Script nonStandardErpRedeemScript = nonStandardErpRedeemScriptBuilder.createRedeemScriptFromKeys(
            activeErpFederation.getBtcPublicKeys(),
            activeErpFederation.getNumberOfSignaturesRequired(),
            activeErpFederation.getErpPubKeys(),
            activeErpFederation.getNumberOfEmergencySignaturesRequired(),
            activeErpFederation.getActivationDelay()
        );
        ...
        tx.addOutput(Coin.COIN, activeErpFederation.getAddress());

        Script flyoverInputScriptSig = ScriptBuilder.createP2SHMultiSigInputScript(null, flyoverErpRedeemScript);
        tx.addInput(Sha256Hash.ZERO_HASH, 0, flyoverInputScriptSig);

        Wallet federationWallet = new BridgeBtcWallet(btcContext, Collections.singletonList(activeErpFederation));
    ...
    void testIsValidPegInTx_hasChangeUtxoFromErpFederation_beforeRskip201_isPegin() {
        ...
        Assertions.assertTrue(isValidPegInTx(tx, activeErpFederation, federationWallet,
            bridgeConstantsMainnet, activations));
    }
    ...
    void testIsValidPegInTx_hasChangeUtxoFromErpFederation_afterRskip201_notPegin() {
        ...
        Assertions.assertFalse(isValidPegInTx(tx, activeErpFederation, federationWallet,
            bridgeConstantsMainnet, activations));
    }
    ...
    void testIsMigrationTx_sending_funds_from_retired_standard_fed_to_active_p2sh_fed() {
        ...
        Federation activeFederation =
            FederationFactory.buildP2shErpFederation(activeFedArgs, federationConstantsMainnet.getErpFedPubKeysList(), federationConstantsMainnet.getErpFedActivationDelay());
