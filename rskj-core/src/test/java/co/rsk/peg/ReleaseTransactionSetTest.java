...
public class ReleaseTransactionSetTest {
    ...
    public void entryEquals() {
        ...
        Assert.assertEquals(e5, e6);
        Assert.assertNotEquals(e5, e7);
        Assert.assertEquals(e7, e8);
    }
    ...
    public void entryComparators() {
        ...
        Assert.assertEquals(0, ReleaseTransactionSet.Entry.BTC_TX_COMPARATOR.compare(e1, e2));
        Assert.assertEquals(0, ReleaseTransactionSet.Entry.BTC_TX_COMPARATOR.compare(e1, e3));
    ...
    public void entriesCopy() {
        ...
        Assert.assertEquals(resultCallWithoutHash, entryWithoutHash);

        Set<ReleaseTransactionSet.Entry> resultCallWithHash = transactionSetWithoutHash.getEntriesWithHash();
        Assert.assertEquals(0, resultCallWithHash.size());
        ...
        Assert.assertEquals(resultCallWithHash2, entryWithHash);
    }
