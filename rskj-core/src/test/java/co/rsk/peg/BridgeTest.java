...
class BridgeTest {
    ...
    class UnionBridgeTest {
        ...
        // The new union locking cap should be less than the max increment value allowed
        private static final Coin newLockingCap = initialLockingCap.multiply(unionBridgeMainNetConstants.getLockingCapIncrementsMultiplier()).minus(Coin.SATOSHI);
        ...
        void increaseUnionBridgeLockingCap_afterRSKIP502_invalidNewLockingCap_shouldReturnInvalidLockingCapCode()
            ...
            Coin lockingCapAboveMaxIncrementAllowed = initialLockingCap.multiply(
                unionBridgeMainNetConstants.getLockingCapIncrementsMultiplier());
        ...
        @Test
        void requestUnionBridgeRbtc_afterRSKIP502_shouldTransferredRbtc() throws VMException {
            // Arrange
            int expectedResponseCode = UnionResponseCode.SUCCESS.getCode();
            ...
            when(unionBridgeSupport.getUnionBridgeContractAddress()).thenReturn(
                Optional.of(unionBridgeContractAddress));
            ...
            co.rsk.core.Coin amountToRequest = new co.rsk.core.Coin(weiPerEther);
        ...
        @Test
        void requestUnionBridgeRbtc_afterRSKIP502_notAuthorized_shouldReturnUnauthorizedCode()
            throws VMException {
            // Arrange
            int expectedResponseCode = UnionResponseCode.UNAUTHORIZED_CALLER.getCode();
            RskAddress unionBridgeContractAddress = mainNetConstants.getBridgeConstants()
        ...
        @Test
        void requestUnionBridgeRbtc_afterRSKIP502_emptyArgument_shouldReturnInvalidValue() throws VMException {
            // Arrange
            int expectedResponseCode = UnionResponseCode.INVALID_VALUE.getCode();
