...
public class BridgeSupportTestPowerMock {
    ...
    public void sendOrphanBlockHeader() throws IOException, BlockStoreException {
        ...
        BtcBlockStoreWithCache.Factory btcBlockStoreFactory = new RepositoryBtcBlockStoreWithCache.Factory(bridgeConstants.getBtcParams());
        BtcBlockStoreWithCache btcBlockStore = btcBlockStoreFactory.newInstance(track, provider, activations);
        BtcBlockStoreWithCache.Factory mockFactory = mock(BtcBlockStoreWithCache.Factory.class);
        when(mockFactory.newInstance(track, provider, activations)).thenReturn(btcBlockStore);
    ...
    public void registerBtcTransactionWithCrossFederationsChange() throws Exception {
        ...
        BtcBlockStoreWithCache.Factory mockFactory = mock(BtcBlockStoreWithCache.Factory.class);
        when(mockFactory.newInstance(any(), any(), any())).thenReturn(mockBtcBlockStore);
    ...
    public void eventLoggerBeforeRskip146Fork() throws Exception {
        ...
        BtcBlockStoreWithCache btcBlockStore = mock(BtcBlockStoreWithCache.class);
        when(btcBlockStoreFactory.newInstance(any(Repository.class), any(), any())).thenReturn(btcBlockStore);
