...
public class BridgeSupportTestPowerMock {
    ...
    public void sendOrphanBlockHeader() throws IOException, BlockStoreException {
        ...
        BtcBlockStoreWithCache.Factory btcBlockStoreFactory = new RepositoryBtcBlockStoreWithCache.Factory(bridgeConstants.getBtcParams());
        BtcBlockStoreWithCache btcBlockStore = btcBlockStoreFactory.newInstance(track, activations);
        BtcBlockStoreWithCache.Factory mockFactory = mock(BtcBlockStoreWithCache.Factory.class);
        when(mockFactory.newInstance(track, activations)).thenReturn(btcBlockStore);
    ...
    public void registerBtcTransactionWithoutInputs() throws IOException, BlockStoreException, BridgeIllegalArgumentException {
        ...
        BtcBlockStoreWithCache.Factory mockFactory = mock(BtcBlockStoreWithCache.Factory.class);
        when(mockFactory.newInstance(any(), any())).thenReturn(btcBlockStore);
    ...
    public void registerBtcTransactionWithCrossFederationsChange() throws Exception {
        ...
        BtcBlockStoreWithCache.Factory mockFactory = mock(BtcBlockStoreWithCache.Factory.class);
        when(mockFactory.newInstance(any(), any())).thenReturn(mockBtcBlockStore);
    ...
    public void eventLoggerBeforeRskip146Fork() throws Exception {
        ...
        BtcBlockStoreWithCache btcBlockStore = mock(BtcBlockStoreWithCache.class);
        when(btcBlockStoreFactory.newInstance(any(Repository.class), any())).thenReturn(btcBlockStore);
    ...
    private BtcLockSenderProvider getBtcLockSenderProvider(
