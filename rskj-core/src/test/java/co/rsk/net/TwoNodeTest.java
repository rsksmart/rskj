...
public class TwoNodeTest {
    private static SimpleNode createNode(int size) {
        ...
        NodeMessageHandler handler = new NodeMessageHandler(new TestSystemProperties(), mock(org.ethereum.db.BlockStore.class), processor, null, null, null, null, new DummyBlockValidationRule(), mock(SyncMessager.class));
