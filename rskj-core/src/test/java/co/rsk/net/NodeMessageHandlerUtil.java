...
public class NodeMessageHandlerUtil {
    ...
    public static NodeMessageHandler createHandlerWithSyncProcessor(
        ...
        return createHandlerWithSyncProcessor(
                syncConfiguration, new ChannelManagerImpl(config, mock(SyncPool.class)));
    }
    ...
    public static NodeMessageHandler createHandlerWithSyncProcessor(
            SyncConfiguration syncConfiguration, ChannelManager channelManager) {
        final World world = new World();
        final Blockchain blockchain = world.getBlockChain();
    ...
    public static NodeMessageHandler createHandlerWithSyncProcessor(
        ...
        SyncProcessor syncProcessor =
                new SyncProcessor(
                        ...
                        DIFFICULTY_CALCULATOR);
        return new NodeMessageHandler(
                config, processor, syncProcessor, channelManager, null, null, blockValidationRule);
    }
}
