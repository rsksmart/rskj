...
public class NodeMessageHandlerUtil {
    ...
    public static NodeMessageHandler createHandler(BlockValidationRule validationRule) {
        ...
        SyncProcessor syncProcessor = new SyncProcessor(blockchain, blockSyncService, RskMockFactory.getPeerScoringManager(), RskMockFactory.getChannelManager(), syncConfiguration, new DummyBlockValidationRule(),
    ...
    public static NodeMessageHandler createHandlerWithSyncProcessor(
        ...
        SyncProcessor syncProcessor = new SyncProcessor(blockchain, blockSyncService, peerScoringManager, channelManager, syncConfiguration, blockValidationRule,
                                                        new BlockCompositeRule(new BlockUnclesHashValidationRule(), new BlockRootValidationRule(config)),
                                                        DIFFICULTY_CALCULATOR);
