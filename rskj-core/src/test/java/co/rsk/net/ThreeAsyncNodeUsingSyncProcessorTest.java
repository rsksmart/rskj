...
public class ThreeAsyncNodeUsingSyncProcessorTest {
    ...
    public void synchronizeNewNodesInAChain() throws InterruptedException {
        ...
        Assert.assertArrayEquals(node2.getBestBlock().getHash().getBytes(), node3.getBestBlock().getHash().getBytes());
    ...
    public void synchronizeNewNodeWithBestChain() throws InterruptedException {
        ...
        Assert.assertArrayEquals(node1.getBestBlock().getHash().getBytes(), node3.getBestBlock().getHash().getBytes());
    ...
    public void synchronizeNewNodeWithThreePeers400Different() {
        ...
        Assert.assertArrayEquals(node4.getBestBlock().getHash().getBytes(), node3.getBestBlock().getHash().getBytes());
