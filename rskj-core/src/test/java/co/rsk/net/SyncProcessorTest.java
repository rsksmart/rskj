...
public class SyncProcessorTest {
    ...
    public void noPeers() {
        ...
        SyncProcessorImpl processor = new SyncProcessorImpl(blockchain, blockSyncService, getPeerScoringManager(), getChannelManager(),
    ...
    public void processStatusWithAdvancedPeers() {
        ...
        SyncProcessorImpl processor = new SyncProcessorImpl(blockchain, blockSyncService, RskMockFactory.getPeerScoringManager(), channelManager,
                SyncConfiguration.IMMEDIATE_FOR_TESTING, new ProofOfWorkRule(config).setFallbackMiningEnabled(false), DIFFICULTY_CALCULATOR);
    ...
    public void dontSyncWithoutAdvancedPeerAfterTimeoutWaitingPeers() {
        ...
        SyncProcessorImpl processor = new SyncProcessorImpl(blockchain, blockSyncService, RskMockFactory.getPeerScoringManager(), getChannelManager(),
    ...
    public void sendSkeletonRequest() {
        ...
        SyncProcessorImpl processor = new SyncProcessorImpl(blockchain, null, RskMockFactory.getPeerScoringManager(), channelManager,
                SyncConfiguration.IMMEDIATE_FOR_TESTING, new ProofOfWorkRule(config).setFallbackMiningEnabled(false), DIFFICULTY_CALCULATOR);
    ...
    public void processBlockHashResponseWithUnknownHash() {
        ...
        SyncProcessorImpl processor = new SyncProcessorImpl(blockchain, null, RskMockFactory.getPeerScoringManager(), getChannelManager(),
                SyncConfiguration.IMMEDIATE_FOR_TESTING, new ProofOfWorkRule(config).setFallbackMiningEnabled(false), DIFFICULTY_CALCULATOR);
