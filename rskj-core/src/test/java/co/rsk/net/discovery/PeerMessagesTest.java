...
class PeerMessagesTest {
    ...
    private static byte[] dataWithNetworkId = new byte[]{-11,-118,86,54,14,-30,58,118,14,-123,57,84,-92,54,53,98,52,54,57,99,54,45,98,97,54,57,45,52,50,51,56,45,98,102,53,97,45,97,52,56,53,99,48,50,52,101,51,99,101,-124, 00, 00, 00, 01};
    ...
    void testParsePongPeerMessageWithNetworkId() {
        ...
        Assertions.assertEquals(1,pongPeerMessage.getNetworkId().getAsInt());
    ...
    void testParsePingPeerMessageWithNetworkId() {
        ...
        Assertions.assertEquals(1,pingPeerMessage.getNetworkId().getAsInt());
    ...
    void testParseFindNodePeerMessage() {
        ...
        Assertions.assertEquals(1,findNodePeerMessageExpected.getNetworkId().getAsInt());
