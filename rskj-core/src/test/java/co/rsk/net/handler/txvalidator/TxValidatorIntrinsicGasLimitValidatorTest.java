...
public class TxValidatorIntrinsicGasLimitValidatorTest {
    ...
    public void validIntrinsicGasPrice() {
        ...
        Assert.assertTrue(tvigpv.validate(tx1, new AccountState(BigInteger.ZERO, BigInteger.ZERO), null, null, Long.MAX_VALUE, 1));
        Assert.assertTrue(tvigpv.validate(tx2, new AccountState(BigInteger.ZERO, BigInteger.ZERO), null, null, Long.MAX_VALUE, 1));
        Assert.assertTrue(tvigpv.validate(tx3, new AccountState(BigInteger.ZERO, BigInteger.ZERO), null, null, Long.MAX_VALUE, 1));
        Assert.assertTrue(tvigpv.validate(tx4, new AccountState(BigInteger.ZERO, BigInteger.ZERO), null, null, Long.MAX_VALUE, 1));
    }
    ...
    public void invalidIntrinsicGasPrice() {
        ...
        Assert.assertFalse(tvigpv.validate(tx1, new AccountState(BigInteger.ZERO, BigInteger.ZERO), null, null, Long.MAX_VALUE, 1));
        Assert.assertFalse(tvigpv.validate(tx2, new AccountState(BigInteger.ZERO, BigInteger.ZERO), null, null, Long.MAX_VALUE, 1));
        Assert.assertFalse(tvigpv.validate(tx3, new AccountState(BigInteger.ZERO, BigInteger.ZERO), null, null, Long.MAX_VALUE, 1));
        Assert.assertFalse(tvigpv.validate(tx4, new AccountState(BigInteger.ZERO, BigInteger.ZERO), null, null, Long.MAX_VALUE, 1));
    }
}
