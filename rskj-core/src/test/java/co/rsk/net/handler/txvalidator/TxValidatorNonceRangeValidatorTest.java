...
public class TxValidatorNonceRangeValidatorTest {
    ...
    public void nonceInRange() {
        ...
        Assert.assertTrue(tvnrv.validate(tx1, as, null, null, Long.MAX_VALUE, 1));
        Assert.assertTrue(tvnrv.validate(tx2, as, null, null, Long.MAX_VALUE, 1));
    }
    ...
    public void nonceOutOfRange() {
        ...
        TxValidatorNonceRangeValidator tvnrv = new TxValidatorNonceRangeValidator();
        Assert.assertFalse(tvnrv.validate(tx1, as, null, null, Long.MAX_VALUE, 1));
        Assert.assertFalse(tvnrv.validate(tx2, as, null, null, Long.MAX_VALUE, 1));
    }
}
