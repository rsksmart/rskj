...
class MessageTest {
    ...
    @Test
    void encodeDecodeBlockHeadersResponseMessageWithoutRSKIP351AndRSKIP481() {
        ActivationConfig activationConfig = ActivationConfigsForTest.allBut(ConsensusRule.RSKIP351, ConsensusRule.RSKIP481);
