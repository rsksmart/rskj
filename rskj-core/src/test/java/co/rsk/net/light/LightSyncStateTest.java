...
public class LightSyncStateTest {
    ...
    public void peerInStartRoundReceivesMoreThanMaxAmountOfBlockHeadersAndShouldNotProcessIt() {
        final BlockHeader startBlockHeader = getBlockHeader(1L, Keccak256.ZERO_HASH);
    ...
    public void peerInStartRoundReceivesABadSkippedListOfHeadersAndShouldNotProcessIt() {
        ...
        blockHeaders.add(getBlockHeader(14L, new Keccak256(randomHash())));
    ...
    public void peerInStartRoundReceivesAHeaderWithIncorrectParentHashAndShouldNotProcessIt() {
        ...
        final BlockHeader startBlockHeader = getBlockHeader(1L, startBlockHash);
    ...
    public void anEntireProcessSinceLightSyncProcessorStartsUntilItFindsACommonBlock() {
        ...
        final BlockHeader bestKnownHeader = getBlockHeader(bestBlockNumber, bestBlockHash);
        ...
        final BlockHeader newStartBlockHeader = getBlockHeader(newStartBlockNumber, newStartBlockHash);
        ...
        final BlockHeader commonAncestor = getBlockHeader(newStartBlockNumber, commonAncestorHash);
    ...
    private List<BlockHeader> getBlockHeaders(long initialNumber, int numberOfHeaders, int skip, boolean reverse) {
        ...
        for (int i = 0; i < numberOfHeaders; i++) {
            ...
            BlockHeader header = getBlockHeader(blockNumber, new Keccak256(randomHash()));
