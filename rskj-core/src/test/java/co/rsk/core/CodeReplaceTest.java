...
public class CodeReplaceTest {
    ...
    public void replaceCodeTest1() throws InterruptedException {
        ...
        byte[] installedCode = blockchain.getRepository().getContractDetails_deprecated(createdContract).getCode();
        ...
        byte[] installedCode2 = blockchain.getRepository().getContractDetails_deprecated(createdContract).getCode();
