...
public class SnapshotManagerTest {
    ...
    public void revertToSnapshot() {
        ...
        Assert.assertArrayEquals(status.getBestBlock().getHash().getBytes(), newStatus.getBestBlock().getHash().getBytes());
    ...
    public void resetSnapshotClearingPendingState() {
        ...
        Assert.assertArrayEquals(genesis.getHash().getBytes(), newStatus.getBestBlock().getHash().getBytes());
