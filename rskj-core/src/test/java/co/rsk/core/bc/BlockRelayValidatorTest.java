...
class BlockRelayValidatorTest {
    ...
    void genesisCheck() {
        ...
        verify(blockParentValidator, never()).isValid(any(), (Block) any());
    }
    ...
    void blockParentValidatorCheck() {
        ...
        when(blockParentValidator.isValid(any(), (Block) any())).thenReturn(false);
        ...
        verify(block).isGenesis();
        verify(blockValidator).isValid(any());
        verify(blockParentValidator).isValid(any(), (Block) any());
    }
    ...
    void allValidatorsCheck() {
        ...
        when(blockStore.getBlockByHash(any())).thenReturn(parentBlock);
        when(blockValidator.isValid(any())).thenReturn(true);
        when(blockParentValidator.isValid(any(), (Block) any())).thenReturn(true);
