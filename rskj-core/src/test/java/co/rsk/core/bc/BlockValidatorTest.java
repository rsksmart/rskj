...
public class BlockValidatorTest {
  ...
  public void getBlockOneAncestorSet() {
    ...
    BlockGenerator blockGenerator = new BlockGenerator();
    Block genesis = blockGenerator.getGenesisBlock();
    blockStore.saveBlock(genesis, TEST_DIFFICULTY, true);
    Block block = new BlockGenerator().createChildBlock(genesis);

    Set<Keccak256> ancestors = FamilyUtils.getAncestors(blockStore, block, 6);
  ...
  public void getThreeAncestorSet() {
    ...
    Block block1 = blockGenerator.createChildBlock(genesis);
    blockStore.saveBlock(block1, TEST_DIFFICULTY, true);
    Block block2 = blockGenerator.createChildBlock(block1);
    blockStore.saveBlock(block2, TEST_DIFFICULTY, true);
    Block block3 = blockGenerator.createChildBlock(block2);
    blockStore.saveBlock(block3, TEST_DIFFICULTY, true);
    Block block4 = blockGenerator.createChildBlock(block3);
    blockStore.saveBlock(block4, TEST_DIFFICULTY, true);
    Block block5 = blockGenerator.createChildBlock(block4);
    blockStore.saveBlock(block5, TEST_DIFFICULTY, true);

    Set<Keccak256> ancestors = FamilyUtils.getAncestors(blockStore, block5, 3);
    Assert.assertFalse(ancestors.isEmpty());
  ...
  public void getUsedUncles() {
    ...
    blockStore.saveBlock(genesis, TEST_DIFFICULTY, true);
    blockStore.saveBlock(uncle1a, TEST_DIFFICULTY, false);
    blockStore.saveBlock(uncle1b, TEST_DIFFICULTY, false);
    blockStore.saveBlock(block1, TEST_DIFFICULTY, true);
    blockStore.saveBlock(uncle2a, TEST_DIFFICULTY, false);
    blockStore.saveBlock(uncle2b, TEST_DIFFICULTY, false);
    blockStore.saveBlock(block2, TEST_DIFFICULTY, true);

    Set<Keccak256> used = FamilyUtils.getUsedUncles(blockStore, block3, 6);
  ...
  public void processBlockWithInvalidPrevMGP() {
    ...
    Block block = new BlockBuilder(null, null).minGasPrice(BigInteger.TEN).parent(parent).build();
  ...
  public void noRemascTx() {
    ...
    block = new BlockBuilder(null, null).parent(genesis).transactions(null).build();
    Assert.assertFalse(validator.isValid(block));

    block = new BlockBuilder(null, null).parent(genesis).transactions(new ArrayList<>()).build();
    Assert.assertFalse(validator.isValid(block));
  }
