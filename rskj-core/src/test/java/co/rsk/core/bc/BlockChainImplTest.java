...
public class BlockChainImplTest {
    ...
    public void setup() {
        objects = new RskTestFactory() {
            ...
            public Genesis buildGenesis() {
                return GenesisLoader.loadGenesis("rsk-unittests.json", BigInteger.ZERO, true);
            }
    ...
    private Block getBlockWithOneTransaction() {
        ...
        Transaction tx = new Transaction(config, toAddress, BigInteger.TEN, nonce, BigInteger.ONE, BigInteger.valueOf(21000));
