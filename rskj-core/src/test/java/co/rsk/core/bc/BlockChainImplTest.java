...
public class BlockChainImplTest {
    ...
    public void createWithoutArgumentsAndUnusedMethods() {
        BlockChainImpl blockChain = new BlockChainImpl(null, null, null, null, null, new DummyBlockValidator(), false, 1, new BlockExecutor(config, null, null, null, null));
    ...
    private static BlockChainImpl createBlockChain(Repository repository, IndexedBlockStore blockStore, BlockValidatorImpl blockValidator) {
        ...
        return new BlockChainImpl(repository, blockStore, receiptStore, transactionPool, listener, blockValidator, false, 1, new BlockExecutor(config, repository, receiptStore, blockStore, listener));
    }
