...
public class BlockExecutorTest {
    ...
    public void executeBlockWithoutTransaction() {
        ...
        BlockExecutor executor = new BlockExecutor(repository, getStateRootTranslator(), new TrieConverter(), (tx1, txindex1, coinbase, track1, block1, totalGasUsed1) -> new TransactionExecutor(
                tx1,
                txindex1,
                block1.getCoinbase(),
                track1,
    ...
    public void executeBlockWithOneTransaction() {
        ...
        BlockExecutor executor = new BlockExecutor(
                ...
                getStateRootTranslator(), new TrieConverter(), (tx1, txindex1, coinbase, track1, block1, totalGasUsed1) -> new TransactionExecutor(
                        tx1,
                        txindex1,
                        block1.getCoinbase(),
                        track1,
