...
class PeginInstructionsBaseTest {

    @Test
    void extractProtocolVersion() throws PeginInstructionsParseException {
    ...
    @Test
    void extractProtocolVersion_version_bigger_than_9() throws PeginInstructionsParseException {
        int protocolVersion = PeginInstructionsBase.extractProtocolVersion(
