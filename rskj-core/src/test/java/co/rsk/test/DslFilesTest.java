...
public class DslFilesTest {
    ...
    public void runCreate01Resource() throws FileNotFoundException, DslProcessorException {
        ...
        TransactionInfo txinfo =
                world.getBlockChain().getTransactionInfo(transaction.getHash().getBytes());
    ...
    public void runCreate02Resource() throws FileNotFoundException, DslProcessorException {
        // byte[] code2
        // =Hex.decode("");
        ...
        Assert.assertNotNull(
                world.getBlockChain()
                        .getBlockByHash(world.getBlockByName("g00").getHash().getBytes()));
        Assert.assertNotNull(
                world.getBlockChain()
                        .getBlockByHash(world.getBlockByName("b01").getHash().getBytes()));
        Assert.assertNotNull(
                world.getBlockChain()
                        .getBlockByHash(world.getBlockByName("b01b").getHash().getBytes()));
        Assert.assertNotNull(
                world.getBlockChain()
                        .getBlockByHash(world.getBlockByName("b02b").getHash().getBytes()));
    ...
    public void runLogs01Resource() throws FileNotFoundException, DslProcessorException {
        ...
        byte[] contractAddress =
                txinfo.getReceipt().getTransaction().getContractAddress().getBytes();

        Assert.assertFalse(
                Arrays.equals(
                        contractAddress, txinfo.getReceipt().getLogInfoList().get(0).getAddress()));
        Assert.assertFalse(
                Arrays.equals(
                        contractAddress, txinfo.getReceipt().getLogInfoList().get(1).getAddress()));
        Assert.assertTrue(
                Arrays.equals(
                        contractAddress, txinfo.getReceipt().getLogInfoList().get(2).getAddress()));
    }
    ...
    public void runCreateAfterSuicide() throws FileNotFoundException, DslProcessorException {
        ...
        Assert.assertNotNull(txinfo);
        long gasUsed =
                BigIntegers.fromUnsignedByteArray(txinfo.getReceipt().getGasUsed()).longValue();

        Assert.assertEquals(200000, gasUsed);
        Assert.assertFalse(
                "Address should not exist",
                world.getRepository()
                        .isExist(new RskAddress("0xa943B74640c466Fc700AF929Cabacb1aC6CC8895")));
    }
