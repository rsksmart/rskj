...
import co.rsk.pcc.bto.ExtractPublicKeyFromExtendedPublicKey;
...
class ExtractPublicKeyFromExtendedPublicKeyFuzzTest {
    ...
    @Tag("ExtractPublicKeyFromExtendedPublicKeyFuzzExecuteRandom")
    @FuzzTest
    void testRandomFuzz(FuzzedDataProvider data) throws NativeContractIllegalArgumentException {
        String arg1 = data.consumeString(1200000);
        try {
