...
public class BridgeRegTestConstants extends BridgeConstants {
    ...
    public static final List<BtcECKey> REGTEST_FEDERATION_PRIVATE_KEYS =
            Arrays.asList(
    ...
    public static final List<BtcECKey> REGTEST_FEDERATION_PUBLIC_KEYS =
            REGTEST_FEDERATION_PRIVATE_KEYS.stream()
    ...
    public BridgeRegTestConstants(List<BtcECKey> federationPublicKeys) {
        ...
        genesisFederation = new Federation(federationMembers, genesisFederationCreatedAt, 1L, getBtcParams());
