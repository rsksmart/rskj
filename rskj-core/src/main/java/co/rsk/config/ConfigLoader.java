...
/**
 * Loads configurations from different sources with the following precedence: 1. Command line arguments 2. Environment
 * variables 3. System properties 4. User configuration file 5. Installer configuration file 6. Default settings per
 * network in resources/[network].conf 7. Default settings for all networks in resources/reference.conf
 */
public class ConfigLoader {
    ...
    private Config getInstallerConfig() {
        ...
        Config installerConfig =
                installerFile.exists() ? ConfigFactory.parseFile(installerFile) : ConfigFactory.empty();
        logger.info(
