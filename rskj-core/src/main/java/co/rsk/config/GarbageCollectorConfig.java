...
public class GarbageCollectorConfig {
    ...
    public GarbageCollectorConfig(boolean enabled, int blocksPerEpoch, int blocksPerFlush) {
    ...
    public int blocksPerFlush() {
        return blocksPerFlush;
    }

    /**
     * Reads configuration in the form of { enabled: boolean, blocksPerEpoch: int, blocksPerFlush: int }
     */
