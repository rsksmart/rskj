...
/**
 * Used to generate a btc keypair from a string
 * Useful to generate reproducible keys for e.g., test federate nodes
...
public class GenAddress {
    public static void main(String[] args) {
        ...
        BtcECKey key = BtcECKey.fromPrivate(HashUtil.sha3(generator.getBytes(StandardCharsets.UTF_8)));
