 ...
 */
@Deprecated
public final class BridgeUtilsLegacy {
    ...
    @Deprecated
    static Address deserializeBtcAddressWithVersionLegacy(
     ...
     */
    @Deprecated
    static Coin getAmountSentToAddress(
        ActivationConfig.ForBlock activations,
        NetworkParameters networkParameters,
     ...
     */
    @Deprecated
    static List<UTXO> getUTXOsSentToAddress(
        ActivationConfig.ForBlock activations,
        NetworkParameters networkParameters,
        BtcTransaction btcTx,
        Address btcAddress
