...
/**
 * Immutable representation of a function call spec to any given contract. For simplicity, each of
 * the arguments is assumed to be a byte array. Encoding is up to the user.
 *
            ...
            new Comparator<ABICallSpec>() {
                ...
                public int compare(ABICallSpec specA, ABICallSpec specB) {
                    return SignedBytes.lexicographicalComparator()
                            .compare(specA.getEncoded(), specB.getEncoded());
                }
            };
