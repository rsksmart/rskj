...
public class ReleaseRequestQueue {
    ...
    /**
     * This methods iterates the requests in the queue and calls the processor for each. If the
     * processor returns true, then the item is removed (i.e., processing was successful). Otherwise
     * it is sent to the back of the queue for future processing.
     */
