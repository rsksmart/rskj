...
public class BridgeSerializationUtils {
    ...
    public static Federation deserializeFederation(byte[] data, NetworkParameters btcParams) {
        RLPList rlpList = (RLPList)RLP.decode2(data).get(0);
        ...
        return new Federation(pubKeys, creationTime, creationBlockNumber, btcParams);
    }
