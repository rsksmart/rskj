...
/**
 * Representation of a given state of the election of an ABI function call by a series of known and
 * authorized electors.
 *
...
public class ABICallElection {
    ...
    public ABICallElection(
            AddressBasedAuthorizer authorizer, Map<ABICallSpec, List<RskAddress>> votes) {
    ...
    /**
     * Returns the election winner abi call spec, or null if there's none The vote authorizer
     * determines the number of participants, whereas this class determines the number of votes that
     * conforms a win
     *
