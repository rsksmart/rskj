 ...
 */
public class BridgeBtcWalletDeprecated extends Wallet {
    private final List<Federation> federations;
    private final Context btcContext;

    public BridgeBtcWalletDeprecated(Context btcContext, List<Federation> federations) {
        super(btcContext);
    ...
    public RedeemData findRedeemDataFromScriptHash(byte[] payToScriptHash) {
        ...
        return destinationFederation.map(federation -> RedeemData.of(
            DeprecatedConverter.toDeprecatedKeys(federation.getBtcPublicKeys()),
            DeprecatedConverter.toDeprecated(federation.getRedeemScript())
        )).orElse(null);
    }
}
