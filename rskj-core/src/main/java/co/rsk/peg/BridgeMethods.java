...
public enum BridgeMethods {
    ADD_FEDERATOR_PUBLIC_KEY(CallTransaction.Function.fromSignature(
                    "addFederatorPublicKey", new String[] {"bytes"}, new String[] {"int256"}),
            fixedCost(13000L),
            (BridgeMethodExecutorTyped) Bridge::addFederatorPublicKey,
            activations -> !activations.isActive(RSKIP123),
            false),
    ADD_FEDERATOR_PUBLIC_KEY_MULTIKEY(CallTransaction.Function.fromSignature(
                    "addFederatorPublicKeyMultikey", new String[] {"bytes", "bytes", "bytes"}, new String[] {"int256"}),
            fixedCost(13000L),
            (BridgeMethodExecutorTyped) Bridge::addFederatorPublicKeyMultikey,
            activations -> activations.isActive(RSKIP123),
            false),
    ADD_LOCK_WHITELIST_ADDRESS(CallTransaction.Function.fromSignature(
                    "addLockWhitelistAddress", new String[] {"string", "int256"}, new String[] {"int256"}),
            fixedCost(25000L),
            (BridgeMethodExecutorTyped) Bridge::addOneOffLockWhitelistAddress,
            activations -> !activations.isActive(RSKIP87),
            false),
    ADD_ONE_OFF_LOCK_WHITELIST_ADDRESS(CallTransaction.Function.fromSignature(
                    "addOneOffLockWhitelistAddress", new String[] {"string", "int256"}, new String[] {"int256"}),
            fixedCost(25000L), // using same gas estimation as ADD_LOCK_WHITELIST_ADDRESS
            (BridgeMethodExecutorTyped) Bridge::addOneOffLockWhitelistAddress,
            activations -> activations.isActive(RSKIP87),
            false),
    ADD_UNLIMITED_LOCK_WHITELIST_ADDRESS(CallTransaction.Function.fromSignature(
                    "addUnlimitedLockWhitelistAddress", new String[] {"string"}, new String[] {"int256"}),
            fixedCost(25000L), // using same gas estimation as ADD_LOCK_WHITELIST_ADDRESS
    ...
    ADD_SIGNATURE(
            CallTransaction.Function.fromSignature(
                    "addSignature", new String[] {"bytes", "bytes[]", "bytes"}, new String[] {}),
            fixedCost(70000L),
            Bridge.activeAndRetiringFederationOnly((BridgeMethodExecutorVoid) Bridge::addSignature, "addSignature"),
            false),
    COMMIT_FEDERATION(
            CallTransaction.Function.fromSignature("commitFederation", new String[] {"bytes"}, new String[] {"int256"}),
            fixedCost(38000L),
            (BridgeMethodExecutorTyped) Bridge::commitFederation,
            false),
    CREATE_FEDERATION(
            CallTransaction.Function.fromSignature("createFederation", new String[] {}, new String[] {"int256"}),
            fixedCost(11000L),
            (BridgeMethodExecutorTyped) Bridge::createFederation,
            false),
    GET_BTC_BLOCKCHAIN_BEST_CHAIN_HEIGHT(
            CallTransaction.Function.fromSignature(
                    "getBtcBlockchainBestChainHeight", new String[] {}, new String[] {"int"}),
            fixedCost(19000L),
            (BridgeMethodExecutorTyped) Bridge::getBtcBlockchainBestChainHeight,
            true),
    GET_BTC_BLOCKCHAIN_INITIAL_BLOCK_HEIGHT(CallTransaction.Function.fromSignature(
                    "getBtcBlockchainInitialBlockHeight", new String[] {}, new String[] {"int"}),
            fixedCost(20000L),
            (BridgeMethodExecutorTyped) Bridge::getBtcBlockchainInitialBlockHeight,
            activations -> activations.isActive(RSKIP89),
            true),
    GET_BTC_BLOCKCHAIN_BLOCK_LOCATOR(CallTransaction.Function.fromSignature(
                    "getBtcBlockchainBlockLocator", new String[] {}, new String[] {"string[]"}),
            fixedCost(76000L),
            (BridgeMethodExecutorTyped) Bridge::getBtcBlockchainBlockLocator,
            activations -> !activations.isActive(RSKIP89),
            true),
    GET_BTC_BLOCKCHAIN_BLOCK_HASH_AT_DEPTH(CallTransaction.Function.fromSignature(
                    "getBtcBlockchainBlockHashAtDepth", new String[] {"int256"}, new String[] {"bytes"}),
            fixedCost(20000L),
            (BridgeMethodExecutorTyped) Bridge::getBtcBlockchainBlockHashAtDepth,
            activations -> activations.isActive(RSKIP89),
            true),
    GET_BTC_TRANSACTION_CONFIRMATIONS(CallTransaction.Function.fromSignature(
    ...
    GET_FEDERATION_ADDRESS(
            CallTransaction.Function.fromSignature("getFederationAddress", new String[] {}, new String[] {"string"}),
            fixedCost(11000L),
            (BridgeMethodExecutorTyped) Bridge::getFederationAddress,
            true),
    GET_FEDERATION_CREATION_BLOCK_NUMBER(
            CallTransaction.Function.fromSignature(
                    "getFederationCreationBlockNumber", new String[] {}, new String[] {"int256"}),
            fixedCost(10000L),
            (BridgeMethodExecutorTyped) Bridge::getFederationCreationBlockNumber,
            true),
    GET_FEDERATION_CREATION_TIME(
            CallTransaction.Function.fromSignature(
                    "getFederationCreationTime", new String[] {}, new String[] {"int256"}),
            fixedCost(10000L),
            (BridgeMethodExecutorTyped) Bridge::getFederationCreationTime,
            true),
    GET_FEDERATION_SIZE(
            CallTransaction.Function.fromSignature("getFederationSize", new String[] {}, new String[] {"int256"}),
            fixedCost(10000L),
            (BridgeMethodExecutorTyped) Bridge::getFederationSize,
            true),
    GET_FEDERATION_THRESHOLD(
            CallTransaction.Function.fromSignature("getFederationThreshold", new String[] {}, new String[] {"int256"}),
            fixedCost(11000L),
            (BridgeMethodExecutorTyped) Bridge::getFederationThreshold,
            true),
    GET_FEDERATOR_PUBLIC_KEY(CallTransaction.Function.fromSignature(
                    "getFederatorPublicKey", new String[] {"int256"}, new String[] {"bytes"}),
            fixedCost(10000L),
            (BridgeMethodExecutorTyped) Bridge::getFederatorPublicKey,
            activations -> !activations.isActive(RSKIP123),
            true),
    GET_FEDERATOR_PUBLIC_KEY_OF_TYPE(CallTransaction.Function.fromSignature(
                    "getFederatorPublicKeyOfType", new String[] {"int256", "string"}, new String[] {"bytes"}),
            fixedCost(10000L),
            (BridgeMethodExecutorTyped) Bridge::getFederatorPublicKeyOfType,
            activations -> activations.isActive(RSKIP123),
            true),
    GET_FEE_PER_KB(
            CallTransaction.Function.fromSignature("getFeePerKb", new String[] {}, new String[] {"int256"}),
            fixedCost(2000L),
            (BridgeMethodExecutorTyped) Bridge::getFeePerKb,
            true),
    GET_LOCK_WHITELIST_ADDRESS(
            CallTransaction.Function.fromSignature(
                    "getLockWhitelistAddress", new String[] {"int256"}, new String[] {"string"}),
            fixedCost(16000L),
            (BridgeMethodExecutorTyped) Bridge::getLockWhitelistAddress,
            true),
    GET_LOCK_WHITELIST_ENTRY_BY_ADDRESS(CallTransaction.Function.fromSignature(
                    "getLockWhitelistEntryByAddress", new String[] {"string"}, new String[] {"int256"}),
            fixedCost(16000L),
            (BridgeMethodExecutorTyped) Bridge::getLockWhitelistEntryByAddress,
            activations -> activations.isActive(RSKIP87),
            true),
    GET_LOCK_WHITELIST_SIZE(
            CallTransaction.Function.fromSignature("getLockWhitelistSize", new String[] {}, new String[] {"int256"}),
            fixedCost(16000L),
            (BridgeMethodExecutorTyped) Bridge::getLockWhitelistSize,
            true),
    GET_MINIMUM_LOCK_TX_VALUE(
            CallTransaction.Function.fromSignature("getMinimumLockTxValue", new String[] {}, new String[] {"int"}),
            fixedCost(2000L),
            (BridgeMethodExecutorTyped) Bridge::getMinimumLockTxValue,
            true),
    GET_PENDING_FEDERATION_HASH(
            CallTransaction.Function.fromSignature("getPendingFederationHash", new String[] {}, new String[] {"bytes"}),
            fixedCost(3000L),
            (BridgeMethodExecutorTyped) Bridge::getPendingFederationHash,
            true),
    GET_PENDING_FEDERATION_SIZE(
            CallTransaction.Function.fromSignature(
                    "getPendingFederationSize", new String[] {}, new String[] {"int256"}),
            fixedCost(3000L),
            (BridgeMethodExecutorTyped) Bridge::getPendingFederationSize,
            true),
    GET_PENDING_FEDERATOR_PUBLIC_KEY(CallTransaction.Function.fromSignature(
                    "getPendingFederatorPublicKey", new String[] {"int256"}, new String[] {"bytes"}),
            fixedCost(3000L),
            (BridgeMethodExecutorTyped) Bridge::getPendingFederatorPublicKey,
            activations -> !activations.isActive(RSKIP123),
            true),
    GET_PENDING_FEDERATOR_PUBLIC_KEY_OF_TYPE(CallTransaction.Function.fromSignature(
                    "getPendingFederatorPublicKeyOfType", new String[] {"int256", "string"}, new String[] {"bytes"}),
            fixedCost(3000L),
    ...
    GET_RETIRING_FEDERATION_ADDRESS(
            CallTransaction.Function.fromSignature(
                    "getRetiringFederationAddress", new String[] {}, new String[] {"string"}),
            fixedCost(3000L),
            (BridgeMethodExecutorTyped) Bridge::getRetiringFederationAddress,
            true),
    GET_RETIRING_FEDERATION_CREATION_BLOCK_NUMBER(
            CallTransaction.Function.fromSignature(
                    "getRetiringFederationCreationBlockNumber", new String[] {}, new String[] {"int256"}),
            fixedCost(3000L),
            (BridgeMethodExecutorTyped) Bridge::getRetiringFederationCreationBlockNumber,
            true),
    GET_RETIRING_FEDERATION_CREATION_TIME(
            CallTransaction.Function.fromSignature(
                    "getRetiringFederationCreationTime", new String[] {}, new String[] {"int256"}),
            fixedCost(3000L),
            (BridgeMethodExecutorTyped) Bridge::getRetiringFederationCreationTime,
            true),
    GET_RETIRING_FEDERATION_SIZE(
            CallTransaction.Function.fromSignature(
                    "getRetiringFederationSize", new String[] {}, new String[] {"int256"}),
            fixedCost(3000L),
            (BridgeMethodExecutorTyped) Bridge::getRetiringFederationSize,
            true),
    GET_RETIRING_FEDERATION_THRESHOLD(
            CallTransaction.Function.fromSignature(
                    "getRetiringFederationThreshold", new String[] {}, new String[] {"int256"}),
            fixedCost(3000L),
            (BridgeMethodExecutorTyped) Bridge::getRetiringFederationThreshold,
            true),
    GET_RETIRING_FEDERATOR_PUBLIC_KEY(CallTransaction.Function.fromSignature(
                    "getRetiringFederatorPublicKey", new String[] {"int256"}, new String[] {"bytes"}),
            fixedCost(3000L),
            (BridgeMethodExecutorTyped) Bridge::getRetiringFederatorPublicKey,
            activations -> !activations.isActive(RSKIP123),
            true),
    GET_RETIRING_FEDERATOR_PUBLIC_KEY_OF_TYPE(CallTransaction.Function.fromSignature(
                    "getRetiringFederatorPublicKeyOfType", new String[] {"int256", "string"}, new String[] {"bytes"}),
            fixedCost(3000L),
    ...
    GET_STATE_FOR_BTC_RELEASE_CLIENT(
            CallTransaction.Function.fromSignature(
                    "getStateForBtcReleaseClient", new String[] {}, new String[] {"bytes"}),
            fixedCost(4000L),
    ...
    IS_BTC_TX_HASH_ALREADY_PROCESSED(
            CallTransaction.Function.fromSignature(
                    "isBtcTxHashAlreadyProcessed", new String[] {"string"}, new String[] {"bool"}),
            fixedCost(23000L),
            (BridgeMethodExecutorTyped) Bridge::isBtcTxHashAlreadyProcessed,
            true),
    RECEIVE_HEADERS(
            CallTransaction.Function.fromSignature("receiveHeaders", new String[] {"bytes[]"}, new String[] {}),
            ...
            Bridge.executeIfElse(
                    ...
                    Bridge.activeAndRetiringFederationOnly(
                            (BridgeMethodExecutorVoid) Bridge::receiveHeaders, "receiveHeaders")),
            false),
    REGISTER_BTC_TRANSACTION(
            CallTransaction.Function.fromSignature(
                    "registerBtcTransaction", new String[] {"bytes", "int", "bytes"}, new String[] {}),
            fixedCost(22000L),
            Bridge.activeAndRetiringFederationOnly(
                    (BridgeMethodExecutorVoid) Bridge::registerBtcTransaction, "registerBtcTransaction"),
            false),
    RELEASE_BTC(
            CallTransaction.Function.fromSignature("releaseBtc", new String[] {}, new String[] {}),
            fixedCost(23000L),
            (BridgeMethodExecutorVoid) Bridge::releaseBtc,
            false),
    REMOVE_LOCK_WHITELIST_ADDRESS(
            CallTransaction.Function.fromSignature(
                    "removeLockWhitelistAddress", new String[] {"string"}, new String[] {"int256"}),
            fixedCost(24000L),
            (BridgeMethodExecutorTyped) Bridge::removeLockWhitelistAddress,
            false),
    ROLLBACK_FEDERATION(
            CallTransaction.Function.fromSignature("rollbackFederation", new String[] {}, new String[] {"int256"}),
            fixedCost(12000L),
            (BridgeMethodExecutorTyped) Bridge::rollbackFederation,
            false),
    SET_LOCK_WHITELIST_DISABLE_BLOCK_DELAY(
            CallTransaction.Function.fromSignature(
                    "setLockWhitelistDisableBlockDelay", new String[] {"int256"}, new String[] {"int256"}),
            fixedCost(24000L),
            (BridgeMethodExecutorTyped) Bridge::setLockWhitelistDisableBlockDelay,
            false),
    UPDATE_COLLECTIONS(
            CallTransaction.Function.fromSignature("updateCollections", new String[] {}, new String[] {}),
            fixedCost(48000L),
            Bridge.activeAndRetiringFederationOnly(
                    (BridgeMethodExecutorVoid) Bridge::updateCollections, "updateCollections"),
            false),
    VOTE_FEE_PER_KB(
            CallTransaction.Function.fromSignature(
                    "voteFeePerKbChange", new String[] {"int256"}, new String[] {"int256"}),
            fixedCost(10000L),
    ...
    private static CostProvider fromMethod(BridgeCostProvider bridgeCostProvider) {
        return (Bridge bridge, ActivationConfig.ForBlock config, Object[] args) ->
                bridgeCostProvider.getCost(bridge, args);
    }

    private static final Map<ByteArrayWrapper, BridgeMethods> SIGNATURES =
            Stream.of(BridgeMethods.values())
                    .collect(
                            Collectors.toMap(
                                    m -> new ByteArrayWrapper(m.getFunction().encodeSignature()), Function.identity()));
}
