...
/**
 * Representation of a queue of BTC release transactions waiting for confirmations on the rsk network.
 *
...
public class ReleaseTransactionSet {
                ...
                new Comparator<Entry>() {
                    ...
                    public int compare(Entry e1, Entry e2) {
                        return comparator.compare(
                                e1.getTransaction().bitcoinSerialize(), e2.getTransaction().bitcoinSerialize());
                    }
                };
    ...
    /**
     * Given a block number and a minimum number of confirmations, returns a subset of transactions within the set that
     * have at least that number of confirmations. Optionally supply a maximum slice size to limit the output size.
    ...
    public Set<BtcTransaction> sliceWithConfirmations(
            Long currentBlockNumber, Integer minimumConfirmations, Optional<Integer> maximumSliceSize) {
