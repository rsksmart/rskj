   ...
   // and will look like.
    ...
    private void generateRejectionRelease(
        ...
        if (buildReturnResult.isPresent()) {
            ...
            logger.info("Rejecting lock: return tx build successful to {}. Tx {}. Value {}.", refundingBtcAddress,
                rskTxHash, totalAmount);
        } else {
            logger.warn("Rejecting lock: return tx build for btc tx {} error. Return was to {}. Tx {}. Value {}", btcTx.getHash(), refundingBtcAddress,
                rskTxHash, totalAmount);
        }
    }
