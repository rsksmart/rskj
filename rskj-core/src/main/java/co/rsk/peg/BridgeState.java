...
public class BridgeState {
    ...
    public BridgeState(int btcBlockchainBestChainHeight, BridgeStorageProvider provider)
            throws IOException {
        this(
    ...
    public Map<String, Object> stateToMap() {
        ...
        result.put(
                "rskTxsWaitingForSignatures",
                this.toStringList(rskTxsWaitingForSignatures.keySet()));
    ...
    public byte[] getEncoded() throws IOException {
        ...
        byte[] rlpActiveFederationBtcUTXOs =
                RLP.encodeElement(
                        BridgeSerializationUtils.serializeUTXOList(activeFederationBtcUTXOs));
        byte[] rlpRskTxsWaitingForSignatures =
                RLP.encodeElement(
                        BridgeSerializationUtils.serializeMap(rskTxsWaitingForSignatures));
    ...
    public static BridgeState create(BridgeConstants bridgeConstants, byte[] data)
            throws IOException {
        ...
        Map<Sha256Hash, Long> btcTxHashesAlreadyProcessed =
                BridgeSerializationUtils.deserializeMapOfHashesToLong(
                        btcTxHashesAlreadyProcessedBytes);
