...
import co.rsk.bitcoinj.deprecated.wallet.SendRequest;
 ...
 */
public class ReleaseTransactionBuilderDeprecated {
    ...
    private static final Logger logger = LoggerFactory.getLogger("ReleaseTransactionBuilderDeprecated");
    ...
    public ReleaseTransactionBuilderDeprecated(
