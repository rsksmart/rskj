...
/**
 * Custom Coin selector : All outputs are selectable (like AllowUnconfirmedCoinSelector). We don't know how many
 * confirmations an output has, but we just add them to the wallet once they have a lot of confirmations Sorts outputs
 * just by hash number (ignores output value and number of confirmation) which produces a pseudo random order. Created
 * by mario on 05/10/2016.
 */
public class RskAllowUnconfirmedCoinSelector implements CoinSelector {
    ...
    public CoinSelection select(Coin target, List<TransactionOutput> candidates) {
        ...
        // a boolean parameter for "give me everything"
