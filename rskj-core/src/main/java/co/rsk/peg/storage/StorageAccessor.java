...
public interface StorageAccessor {
    ...
    <T> void safeSaveToRepository(DataWord addressKey, T object, RepositorySerializer<T> serializer) throws IOException;
    void safeSaveToRepository(DataWord addressKey, byte[] data) throws IOException;
