...
public class MerkleTreeUtils {
    ...
    /**
     * Combines two hashes (representing nodes in a merkle tree) to produce a single hash that would
     * be the parent of these two nodes.
     *
    ...
    public static Sha256Hash combineLeftRight(Sha256Hash left, Sha256Hash right) {
        ...
        return Sha256Hash.wrapReversed(
                Sha256Hash.hashTwice(
                        reverseBytes(leftBytes), 0, 32, reverseBytes(rightBytes), 0, 32));
    }
