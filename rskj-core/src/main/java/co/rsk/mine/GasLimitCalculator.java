...
public class GasLimitCalculator {
    ...
    // At the end of this algorithm it will increase the gas limit if and only if the previous block
    // gas used
    // is above 2/3 of the block gas limit, and decrease otherwise, by small amounts
    // The idea is to increase the gas limit when there are more transactions on the network while
    // reduce it when
