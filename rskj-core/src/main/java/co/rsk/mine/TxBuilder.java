...
/** This component creates random txs and stores them to the memory pool. It is used only for testing purposes. */
public class TxBuilder {
    ...
    public Transaction createNewTransaction(BigInteger gasPrice, BigInteger gasLimit, BigInteger txNonce) {
        ...
        Transaction tx =
                new Transaction(
                        toAddress, BigInteger.valueOf(1000), txNonce, gasPrice, gasLimit, constants.getChainId());
