...
public class BlockToMineBuilder {
    ...
    public BlockToMineBuilder(
        ...
        this.executor = new BlockExecutor(repository, stateRootTranslator, trieConverter, (tx1, txindex1, coinbase, track1, block1, totalGasUsed1) -> new TransactionExecutor(
                tx1,
                txindex1,
                block1.getCoinbase(),
                track1,
    ...
    private BlockHeader createHeader(
        ...
        newHeader.setTransactionsRoot(BlockHashesHelper.getTxTrieRoot(txs,
                blockchainConfig.getConfigForBlock(newHeader.getNumber()).isRskipUnitrie()));
        return newHeader;
    }
}
