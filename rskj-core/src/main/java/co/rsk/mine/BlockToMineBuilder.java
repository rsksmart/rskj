...
public class BlockToMineBuilder {
    ...
    private Block createBlock(
        ...
        final Block newBlock = blockFactory.newBlock(newHeader, txs, uncles);
        return validationRules.isValid(newBlock) ? newBlock : blockFactory.newBlock(newHeader, txs, Collections.emptyList());
    }
