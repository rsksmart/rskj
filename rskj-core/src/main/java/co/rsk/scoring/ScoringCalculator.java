 ...
 *
 * <p>Created by ajlopez on 30/06/2017.
 */
public class ScoringCalculator {
    /**
     * Calculates the reputation of a peer scoring
     *
     * <p>Current implementation assigns not good reputation to peers having any invalid transaction
     * or invalid block recorded events
     *
    ...
    public boolean hasGoodReputation(PeerScoring scoring) {
        // TODO(lsebrie): implement empty messages as responses so timeout can be handled as it
        // should
