...
/**
 * InetAddressUtils has static methods to perform operations on InetAddress and InetAddressBlock given an String
 * representation
 *
...
public final class InetAddressUtils {
    ...
    /**
     * Convert a text representation to an InetAddressBlock (@see InetAddressBlock) It supports IPV4 and IPV6 formats ie
     * "192.168.51.1/16" is a valid text
     *
