...
/**
 * PunishmentCalculator calculates the punishment duration given the punishment parameters (@see
...
public class PunishmentCalculator {
    ...
    /**
     * Calculate the punishment duration (in milliseconds) given the count of previous punishment
     * and current peer score.
     *
     * <p>The duration is incremented according the number of previous punishment using an initial
     * duration and a percentage increment
     *
     * <p>The duration cannot be greater than the maximum duration specified in parameters (0 = no
     * maximum duration)
     *
