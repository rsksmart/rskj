...
public class SiblingPaymentCalculator {
    ...
    public SiblingPaymentCalculator(
        ...
        Coin publishersReward =
                fullBlockReward.divide(BigInteger.valueOf(remascConstants.getPublishersDivisor()));
        Coin minersReward = fullBlockReward.subtract(publishersReward);
        Coin[] integerDivisionResult =
                publishersReward.divideAndRemainder(BigInteger.valueOf(siblingsNumber));
