...
/**
 * Siblings are part of the remasc contract state Sibling information is added to contract state as blocks are processed
...
public class Sibling {
    ...
    public byte[] getEncoded() {
        ...
        return RLP.encodeList(
                rlpHash, rlpCoinbase, rlpIncludedBlockCoinbase, rlpPaidFees, rlpIncludedHeight, rlpUncleCount);
    }
    ...
    public static Sibling create(byte[] data) {
        ...
        long includedHeight =
                bytesIncludedHeight == null ? 0 : BigIntegers.fromUnsignedByteArray(bytesIncludedHeight).longValue();
