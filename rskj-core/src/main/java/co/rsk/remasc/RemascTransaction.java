...
public class RemascTransaction extends Transaction {
    ...
    /**
     * The Remasc transaction is not signed so it has no sender. Due to a bug in the implementation before mainnet
     * release, this address has a special encoding. Instead of the empty array, it is encoded as the array with just
     * one zero. This instance should not be used for any other reason.
     */
