...
public class NodeReference {
    ...
    /**
     * If the node is not present, this is either an empty reference, or the hash points to a node
     * already in storage.
     */
    public void save() {
        if (lazyNode != null) {
    ...
    /**
     * The node or empty if this is an empty reference. If the node is not present but its hash is
     * known, it will be retrieved from the store.
     */
    ...
    /**
     * The hash or empty if this is an empty reference. If the hash is not present but its node is
                                ...
                                .orElseThrow(
                                        () ->
                                                new IllegalStateException(
                                                        "The hash should always exists at this point"));
                buffer.put(hash);
            }
        }
    }
     ...
     *     <p>This method will EXPAND internal encoding caches without removing them afterwards. Do
     *     not use.
     */
