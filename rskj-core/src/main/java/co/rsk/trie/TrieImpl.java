...
*/
    ...
    private TrieImpl split(int nshared) {
        ...
        TrieImpl newChildTrie = new TrieImpl(null, 0, this.value, newChildNodes, newChildHashes, this.store, this.valueLength, this.valueHash, this.isSecure);
    ...
    private static class ExpandedKey {
        ...
        private static ExpandedKey expandKey(byte[] bytes) {
            return new ExpandedKey(TrieImpl.bytesToKey(bytes));
        }
    }
