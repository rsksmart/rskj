...
/**
 * A KeyCrypter can be used to encrypt and decrypt a message. The sequence of events to encrypt and
 * then decrypt a message are as follows:
 *
 * <p>(1) Encrypt the message using encrypt(), providing the message bytes and the KeyParameter
 * from. This returns an EncryptedData which contains the encryptedPrivateKey bytes and an
