...
/**
 * A Keccak256 just wraps a byte[] so that equals and hashcode work correctly, allowing it to be used as keys in a map.
...
public class Keccak256 implements Serializable, Comparable<Keccak256> {
     ...
     * blocks, where the goal is to try and get the first bytes to be zeros (i.e. the value as a big integer lower than
     * the target value).
     */
    @Override
    public int hashCode() {
