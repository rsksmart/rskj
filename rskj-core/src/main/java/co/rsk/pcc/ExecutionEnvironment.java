...
/**
 * Represents the execution environment of a particular native contract's method execution. Things
 * as block-dependent configuration, execution block and repository are kept here.
 *
