...
public class ToBase58Check extends NativeMethod {
    /**
     * This is here since the bitcoinj Address class performs version validation depending on the actual network passed
     * in, and the given constructor within VersionedChecksummedBytes is protected.
     */
