...
/**
 * Precompiled contract that provides access to Block Header fields (coinbase, minimum gas price,
 * block hash, merged mining tags, bitcoin header, gas limit, gas used, RSK difficulty and coinbase
 * for uncles).
 *
 * @author Diego Masini
 */
