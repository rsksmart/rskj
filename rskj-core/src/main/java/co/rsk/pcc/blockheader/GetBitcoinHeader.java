...
/**
 * This implements the "getBitcoinHeader" method that belongs to the BlockHeaderContract native contract.
 *
 * @author Diego Masini
 */
public class GetBitcoinHeader extends BlockHeaderContractMethod {
    ...
    private final CallTransaction.Function function =
            CallTransaction.Function.fromSignature("getBitcoinHeader", new String[] {"int256"}, new String[] {"bytes"});
