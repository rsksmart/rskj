...
/**
 * This implements the "getUncleCoinbaseAddress" method that belongs to the BlockHeaderContract native contract.
 *
 * @author Diego Masini
 */
public class GetUncleCoinbaseAddress extends BlockHeaderContractMethod {
    private final CallTransaction.Function function =
            CallTransaction.Function.fromSignature(
                    "getUncleCoinbaseAddress", new String[] {"int256", "int256"}, new String[] {"bytes"});
    ...
    protected Object internalExecute(Block block, Object[] arguments) {
        ...
        if (uncleIndex < 0) {
            throw new NativeContractIllegalArgumentException(
                    String.format("Invalid uncle index '%d' (should be a non-negative value)", uncleIndex));
        }
