...
/**
 * Computes point addition on Secp256k1 curve.
...
public class Secp256k1Addition extends Secp256k1PrecompiledContract {
    ...
    public Secp256k1Addition(ActivationConfig.ForBlock activations, AbstractSecp256k1 secp) {
        super(activations, secp);
    }
    ...
    protected int concreteExecute(byte[] data) {
        return Secp256k1Lib.add(data, data.length);
    }
}
