...
public abstract class Secp256k1PrecompiledContract extends PrecompiledContracts.PrecompiledContract {
    ...
    protected final AbstractSecp256k1 Secp256k1Lib;

    public Secp256k1PrecompiledContract(ActivationConfig.ForBlock activations, AbstractSecp256k1 secp) {
        this.activations = activations;
        this.Secp256k1Lib = secp;
    }
