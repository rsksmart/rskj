...
public class PersonalModuleWalletEnabled implements PersonalModule {
    ...
    private String sendTransaction(Web3.CallArguments args, Account senderAccount) throws Exception {
    	...
    	TransactionArguments txArgs = TransactionArgumentsUtil.processArguments(args, transactionPool, senderAccount);

        Transaction tx = Transaction
        		.builder()
                .from(txArgs, config.getNetworkConstants().getChainId())
                .build();
