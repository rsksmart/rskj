...
public class EthModule
    ...
    public ProofResultDTO getProof(RskAddress address, List<DataWord> storageKeys, String blockId,
        ...
        try {
            RepositorySnapshot repository = getRepository(blockId);
            if (repository == null) {
            ...
            return ProofResultDTO.builder()
                    ...
                    .codeHash(codeHash.toJsonString())
    ...
    private RepositorySnapshot getRepository(String blockId) {
