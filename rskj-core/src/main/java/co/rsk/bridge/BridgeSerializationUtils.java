...
public class BridgeSerializationUtils {
     ...
     * @param data data MUST be composed of a list of {@link co.rsk.bridge.whitelist.OneOffWhiteListEntry} and the value of disableBlockHeight obtained from {@link co.rsk.bridge.whitelist.LockWhitelist}
    ...
    /**
     * Serializes the provided list of {@link co.rsk.bridge.whitelist.UnlimitedWhiteListEntry}
     * @param entries
     * @return the serialized data
     */
