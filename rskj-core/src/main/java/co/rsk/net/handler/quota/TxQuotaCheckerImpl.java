 ...
 */
public class TxQuotaCheckerImpl implements TxQuotaChecker {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TxQuotaCheckerImpl.class);
    ...
    public TxQuotaCheckerImpl(TimeProvider timeProvider, SignatureCache signatureCache) {
