...
/**
 * Checks that the transaction gas limit is lower than the `block` gas limit though there's no check that the actual
 * block gas limit is used Also Checks that the transaction gas limit is not higher than the max allowed value
 */
