...
public class MessageVisitor {
    ...
    public void apply(TransactionsMessage message) {
        ...
        List<Transaction> addedTransactions = transactionGateway.getTransactionPool().addTransactions(txs);

        if (!addedTransactions.isEmpty()) {
            this.channelManager.broadcastTransactions(addedTransactions, Collections.singleton(this.sender.getPeerNodeID()));
        }
