...
public class TransactionPoolImpl implements TransactionPool {
    ...
    private PendingState getPendingState(RepositoryReader currentRepository) {
    ...
    private RepositoryReader getCurrentRepository() {
    ...
    public synchronized TransactionPoolAddResult addTransaction(final Transaction tx) {
        RepositoryReader currentRepository = getCurrentRepository();
    ...
    private TransactionValidationResult shouldAcceptTx(Transaction tx, RepositoryReader currentRepository) {
    ...
    private boolean senderCanPayPendingTransactionsAndNewTx(
            Transaction newTx,
            RepositoryReader currentRepository) {
