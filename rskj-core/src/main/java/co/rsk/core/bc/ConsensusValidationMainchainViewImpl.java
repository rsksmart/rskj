...
public class ConsensusValidationMainchainViewImpl implements ConsensusValidationMainchainView {
    ...
    /**
     * Design decision note. headers for blocks not yet added to the blockchain are not in the
     * BlockStore. These headers are in a collection used by the SyncProcessor and friends. Sync
     * process creates a new version of this collection periodically and that is why a setter is
     * needed.
     */
    ...
    @Override
    public synchronized List<BlockHeader> get(
            Keccak256 startingHashToGetMainchainFrom, int height) {
