...
public class BlockFork {
    ...
    /**
     * getOldBlocks returns the blocks from the old chain, not including the common ancestor. if oldBlock is the common
     * ancestor, it won't be included in oldBlocks.
     *
    ...
    /**
     * getNewBlocks returns the blocks from the new chain, not including the common ancestor. if newBlock is the common
     * ancestor, it won't be included in newBlocks.
     *
