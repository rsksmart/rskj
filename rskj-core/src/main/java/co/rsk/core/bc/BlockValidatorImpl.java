...
public class BlockValidatorImpl implements BlockValidator {
    ...
    /**
     * Validate a block. The validation includes - Validate the header data relative to parent block - Validate the
     * transaction root hash to transaction list - Validate uncles - Validate transactions
     *
