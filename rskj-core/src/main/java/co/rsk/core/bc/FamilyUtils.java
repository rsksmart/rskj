...
public class FamilyUtils {
    ...
    public record FindSuperParentAndAncestorsResponse (Block superParent, SuperBridgeEvent superBridgeEvent) {}
    ...
    public static FindSuperParentAndAncestorsResponse findSuperParentAndUnclesAndBridgeEvent(
        ...
        if (superParent == null) {
            return new FindSuperParentAndAncestorsResponse(null,  null);
        }
        ...
        return new FindSuperParentAndAncestorsResponse(superParent, bridgeEvent);
    }
