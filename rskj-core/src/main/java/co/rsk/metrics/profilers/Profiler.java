...
public interface Profiler {
    ...
    /**
     * List of possible measurement categories (or types). Depending on what is actually being
     * profiled, new categories can be added or categories not needed can be removed
     */
    enum PROFILING_TYPE {
        // BLOCK_CONNECTION - BLOCK_EXECUTE = Time consumed fetching the block and, after block
        // execution, saving the data
        // that means some DB_READ and DB_WRITE will be included here (and contained in the DB_READ
        // and DB_WRITE categories again)
        BLOCK_CONNECTION,
        BLOCK_EXECUTE,
        ...
        AFTER_BLOCK_EXEC,
        BUILD_TRIE_FROM_MSG,
        // Currently inactive, to measure, add the hooks in Trie:#toMessage and Trie#toMessageOrchid
        TRIE_TO_MESSAGE,
