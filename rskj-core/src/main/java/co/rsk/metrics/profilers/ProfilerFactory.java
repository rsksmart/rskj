...
/**
 * ProfilerFactory is used to get the configured Profiler instance. Only one profiler can be
 * defined, once a profiler is set, it cannot be changed. If a profiler isn't configured, the
 * DummyProfiler will be set upon the first request for the instance.
 */
