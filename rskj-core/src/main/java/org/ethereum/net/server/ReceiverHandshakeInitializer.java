...
import org.ethereum.net.rlpx.ReceiverHandshakeInitPacketHandler;
...
public class ReceiverHandshakeInitializer extends ChannelInitializer<NioSocketChannel> {
    ...
    public void initChannel(NioSocketChannel ch) {
        try {
            ...
            ReceiverHandshakeInitPacketHandler handshakeHandler = new ReceiverHandshakeInitPacketHandler(config, peerScoringManager, p2pHandler, messageCodec, configCapabilities, channel);
