...
/**
 * This class establishes a listener for incoming connections. See <a
 * href="http://netty.io">http://netty.io</a>.
 */
public class PeerServerImpl implements PeerServer {
                            ...
                            runnable -> {
                                ...
                                thread.setUncaughtExceptionHandler(
                                        (exceptionThread, exception) ->
                                                logger.error(
                                                        "Unable to start peer server", exception));
                                return thread;
                            });
    ...
    private void start(InetAddress host, int port) {
        ...
        EthereumChannelInitializer ethereumChannelInitializer =
                ethereumChannelInitializerFactory.newInstance("");
