...
public interface ChannelManager {
    ...
    /**
     * broadcastBlock Propagates a block message across active peers with exclusion of the peers
     * with an id belonging to the skip set.
     *
     ...
     */
    @Nonnull
    Set<NodeID> broadcastTransaction(
            @Nonnull final Transaction transaction, @Nullable final Set<NodeID> skip);
