...
/**
 * The instance of this class responsible for discovery messages exchange with the specified Node It also manages itself
 * regarding inclusion/eviction from Kademlia table
 *
