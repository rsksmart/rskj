...
public class ReadonlyLevelDbDataSource extends LevelDbDataSource implements ReadonlyDbDataSource {

    // TODO:I test

    public ReadonlyLevelDbDataSource(String name, String databaseDir) {
