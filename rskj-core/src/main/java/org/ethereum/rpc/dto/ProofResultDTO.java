...
public class ProofResultDTO {
    ...
    private final String[] accountProof;    // Array of trie nodes for account proof (encoding depends on endpoint/configuration)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(address, that.address) &&
                ...
                Objects.equals(storageHash, that.storageHash) &&
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(codeHash);
        result = 31 * result + Objects.hashCode(nonce);
        result = 31 * result + Objects.hashCode(storageHash);
