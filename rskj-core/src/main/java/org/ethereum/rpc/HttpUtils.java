...
public class HttpUtils {
    ...
    /**
     * This function is strongly based on the function from netty 4.1, since we have an older version from it and do not
     * need the overhead of checking the rest of the implementation for security reasons.
     *
