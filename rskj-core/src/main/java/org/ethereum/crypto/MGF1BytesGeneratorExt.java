...
/**
 * This class is borrowed from spongycastle project The only change made is addition of
 * 'counterStart' parameter to conform to Crypto++ capabilities
 */
    ...
    public int generateBytes(byte[] out, int outOff, int len)
        ...
        if (out.length - len < outOff) {
            ...
            if (counter * this.hLen < len) {
                ...
                this.digest.doFinal(hashBuf, 0);
                System.arraycopy(
                        hashBuf, 0, out, outOff + counter * this.hLen, len - counter * this.hLen);
            }
