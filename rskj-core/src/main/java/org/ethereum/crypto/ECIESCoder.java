...
public class ECIESCoder {
     ...
     *
     * <p>DL_KeyAgreementAlgorithm: DL_KeyAgreementAlgorithm_DH<struct ECPPoint,struct
     * EnumToType<enum CofactorMultiplicationOption,0> > DL_KeyDerivationAlgorithm:
     * DL_KeyDerivationAlgorithm_P1363<struct ECPPoint,0,class P1363_KDF2<class SHA1> >
     * DL_SymmetricEncryptionAlgorithm: DL_EncryptionAlgorithm_Xor<class HMAC<class SHA1>,0>
     * DL_PrivateKey: DL_Key<ECPPoint> DL_PrivateKey_EC<class ECP>
     *
