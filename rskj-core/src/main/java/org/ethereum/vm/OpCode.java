...
public enum OpCode {
    ...
    /**
     * (0x3d and 0x3e) A mechanism to allow returning arbitrary-length data. After a call, return
     * data is kept inside a virtual buffer from which the caller can copy it (or parts thereof)
     * into memory. At the next call, the buffer is overwritten.
     */
     ...
     * original call. also the Value parameter is omitted for this code
     */
    ...
    /**
     * (0xfc) Halt execution as an invalid opcode setting version==256 assures it's never considered
     * valid. (because scriptVersion range is 0..255)
     */
