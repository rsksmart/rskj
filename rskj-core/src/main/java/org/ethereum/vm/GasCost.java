...
/**
 * The fundamental network cost unit. Paid for exclusively by SBTC, which is converted freely to and
 * from Gas as required. Gas does not exist outside of the internal RSK computation engine; its
 * price is set by the Transaction and miners are free to ignore Transactions whose Gas price is too
 * low.
 */
public class GasCost {
    ...
    public static final int STIPEND_CALL =
            2300; // For transferring coins in CALL, this is always passed to child
    ...
    public static final int MEMORY =
            3; // TODO: Memory in V0 is more expensive than V1: This MUST be modified before release
