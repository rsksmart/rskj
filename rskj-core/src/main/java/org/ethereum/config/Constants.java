...
public class Constants {
    ...
    private static final BigInteger SUPER_BLOCK_DIFFICULTY_CORRECTION_FACTOR = BigInteger.valueOf(128);
    ...
    private final BigInteger superBlockDifficultyCorrectionFactor;
    ...
    public Constants(
        ...
        this.superBlockDifficultyCorrectionFactor = superBlockDifficultyCorrectionFactor;
    ...
    public Constants(
        ...
        this(chainId,
                ...
                superBlockDifficultyCorrectionFactor,
    ...
    public BigInteger getSuperBlockDifficultyCorrectionFactor() {
        return superBlockDifficultyCorrectionFactor;
    }
    ...
    public static Constants mainnet() {
        return new Constants(
                ...
                SUPER_BLOCK_DIFFICULTY_CORRECTION_FACTOR,
