...
public interface Repository extends RepositorySnapshot, TransientRepository {
    ...
    /**
     * Complete root transaction repository bookkeeping.
     *
     * RSKIP555 includes EIP-2200 SSTORE net gas metering, which requires original
     * storage slot values to be preserved for the whole root transaction across
     * nested call-frame tracking repositories. Therefore this method must be called
     * only when the root transaction has been committed or rolled back.
     */
    void rootTxCompleted();
