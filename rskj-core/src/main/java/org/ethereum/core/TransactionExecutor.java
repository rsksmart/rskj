...
//            https://github.com/ethereum/cpp-ethereum/blob/develop/libethereum/Executive.cpp#L241
    ...
    public void extractTrace(ProgramTraceProcessor programTraceProcessor) {
        if (program != null) {
            ...
            TransferInvoke invoke = new TransferInvoke(DataWord.valueOf(sender.getBytes()), DataWord.valueOf(tx.getReceiveAddress().getBytes()), 0L, DataWord.valueOf(tx.getValue().getBytes()));
