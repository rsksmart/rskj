...
/**
 * The transaction receipt is a tuple of three items comprising the transaction, together with the
 * post-transaction state, and the cumulative gas used in the block containing the transaction
 * receipt as of immediately after the transaction has happened,
 */
public class TransactionReceipt {
    ...
    public TransactionReceipt(byte[] rlp) {
        ...
        cumulativeGas =
                cumulativeGasRLP.getRLPData() == null
                        ? EMPTY_BYTE_ARRAY
                        : cumulativeGasRLP.getRLPData();
