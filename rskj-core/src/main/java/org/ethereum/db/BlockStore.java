...
public interface BlockStore extends RemascCache {
    ...
    /**
     * Gets the block hash by its index. When more than one block with the specified index exists
     * (forks) the select the block which is ancestor of the branchBlockHash
     */
